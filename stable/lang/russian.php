...
'home_lnk' => 'Домой',
  ...
  'faq_title' => 'Часто задаваемые вопросы о галереи &quot;Coppermine&quot;',
  'faq_lnk' => 'FAQ',
);
...
if (defined('ADMIN_PHP')) $lang_admin_php = array(
  ...
  'notice2' => '(**) Когда изменяете эти настройки, то будут затронуты файлы, добавленные после данного изменения, поэтому не рекомендуется изменять эти настройки, если у Вас уже есть файлы в галереи. Несмотря на это Вы можете применить изменения к существующим файлам с помощью &quot;<a href="util.php">Инструмент администратора</a>&quot;.', //cpg1.4 - (relocated)
...
if (defined('ADMIN_PHP')) $lang_admin_data = array(
  ...
  array('Уведомлять админа об ожидании пользователем подтверждения загрузки', 1, 'f=index.htm&amp;as=admin_approval_notify&amp;ae=admin_approval_notify_end'), //cpg1.4
...
if (defined('DB_INPUT_PHP')) $lang_db_input_php = array(
  ...
  'email_comment_body' => 'Кто-то разместил комментарий в Вашей галереи. Просмотрите его.',
...
if (defined('REPORT_FILE_PHP') || defined('DISPLAYREPORT_PHP')) $lang_report_php =array(
  ...
  'report_subject' => 'Жалоба от %s на %s в галереи', //cpg1.4
...
if (defined('KEYWORDMGR_PHP')) $lang_keywordmgr_php = array(
  ...
  'confirm_delete' => 'Вы уверены, что хотите удалить ключевое слово %s во всей галереи?', //cpg1.4  // js-alert
...
В Вашей галереи была создана новая учётная запись "{USER_NAME}".
...
if (defined('UPLOAD_PHP')) $lang_upload_php = array(
  ...
  'place_instr_1' => 'Пожалуйста, расположите файлы по альбомам. Вы так же можете заполнить соответствующую информацию для каждого файла.',
...
$lang_util_php = array(
  ...
  'delete_orphans_explanation' => 'Позволит найти и удалить комментарии к файлам, которых уже нет в галереи.<br />Ищет во всех альбомах.', //cpg1.4
  ...
  'phpinfo' => 'Отобразить phpinfo',
  'phpinfo_explanation' => 'Содержит техническую информацию о Вашем сервере.<br /> - Вас могут попросить предоставить эту информацию, если Вы будите просить оказать помощь по галереи.', //cpg1.4
