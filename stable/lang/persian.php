<?php
//This version is modifide by Bmossavari@gmail.com and it's full version     //
// ------------------------------------------------------------------------- //
...
if (defined('FAQ_PHP')) $lang_faq_data = array(
  ...
  array('اگر رمز ورود را گم كرده ام چه كار كنم؟', 'اگر سايت به شما لينك "رمز فراموش شده"، را داده از آن استفاده كنيد در غير اينصورت با مديريت تماس بگيريد.', 'offline', 0), //cpg1.3.0
