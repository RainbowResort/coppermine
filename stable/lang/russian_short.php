...
$lang_month = array('Янв', 'Февр', 'Март', 'Апр', 'Май', 'Июнь', 'Июль', 'Авг', 'Сент', 'Окт', 'Ноя', 'Дек');
...
$lang_user_admin_menu = array(
        'albmgr_lnk' => 'Управление Моими Альбомами',
        'modifyalb_lnk' => 'Править мои альбомы',
        'my_prof_lnk' => 'Профиль',
);
