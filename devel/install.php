...
?>
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="maintable">
       ...
       <tr>
        <td class="tableb" colspan="2"> Coppermine is now properly configured and ready to roll.<br /><br />Login using the information you provided for your admin account.<?php echo $notes ?>
        </td>
       </tr>
       <tr>
        <td colspan="2" align="center" class="tableh2"><br />
