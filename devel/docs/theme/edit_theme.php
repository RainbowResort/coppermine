...
EOT;
    ...
    <li>
			Replace $template_display_picture with $template_display_media
    ...
    <li>
			Replace tableb with display_media in $template_display_media block	
			  <h6>Find:</h6>
    ...
    <li>
			Replace tableh2 with catrow_noalb in the catrow_noalb block
			  <h6>Find:</h6>
    ...
    <li>
			Replace tableb with catrow in the catrow block
			<h6>Find:</h6>
