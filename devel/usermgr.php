...
function list_users()
{
	...
	$sql =  "SELECT user_id, user_name, user_email, UNIX_TIMESTAMP(user_regdate) as user_regdate, group_name, user_active, ".
...
function update_user($user_id)
{
	...
	$sql = "SELECT user_id ".
		   ...
		   "WHERE user_name = '".addslashes($user_name)."' AND user_id != $user_id";
	$result = db_query($sql);
