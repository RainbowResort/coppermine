...
$lang_errors = array(
	'access_denied' => 'Teil puudub õigus ligip&auml;&auml;suks sellele lehele',
	...
	'quota_exceeded' => 'Ketta kvoot &uuml;letatud<br /><br />Teie ruumi kvoot on [quota]KB, teie pildid hetkel kasutavad [space]KB, selle pildi lisamine võib &uuml;letada teie kvoodi.',
	'gd_file_type_err' => 'Kasutades GD pilditeeki on lubatud t&uuml;&uuml;bid ainult JPEG ja PNG.',
	'invalid_image' => 'Teie poolt &uuml;leslaaditav pilt on vigane või seda ei saa k&auml;itleda GD teegi poolt',
...
if (defined('SMILIES_PHP')) $lang_smilies_inc_php = array(
	...
	'Crying or Very sad' => 'Nuttev või V&auml;ga kurb',
	'Evil or Very Mad' => 'Õel või T&auml;itsa hull',
...
if (defined('ALBMGR_PHP')) $lang_albmgr_php = array(
	...
	'confirm_delete2' => '\nKõik siin sisalduvad pildid ja kommentaarid l&auml;hevad kaduma !',
...
if (defined('CONFIG_PHP')) $lang_config_data = array(
	...
	array('Maksimaalne number t&auml;hti sõnas', 'max_com_wlength', 0),
...
$lang_picinfo = array(
	...
	'Keywords' => 'M&auml;rksõnad',
	'File Size' => 'Faili suurus',
	'Dimensions' => 'Dimensioonid',
	'Displayed' => 'Kuvatud',
	'Camera' => 'Kaamera',
	'Date taken' => '&Uuml;lesvõtte kuup&auml;ev',
	'Aperture' => 'Ava',
...
if (defined('MODIFYALB_PHP')) $lang_modifyalb_php = array(
	...
	'can_upload' => 'K&uuml;lastajad võivad salvestada pilte',
	'can_post_comments' => 'K&uuml;lastajad võivad kommenteerida',
	'can_rate' => 'K&uuml;lastajad võivad hinnata pilte',
...
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array(
	...
	'rate_ok' => 'Sinu h&auml;&auml;l vastu võetud',
);
...
Kuigi saidi {SITE_NAME} administraatorid p&uuml;&uuml;avad eemaldada või muuta mistahes &uuml;ldiselt pahaks-pandavad materjalid niipea kui võimalik, pole võimalik nendegi poolt kohe n&auml;ha iga postitust. Seetõttu pead tunnistama, et kõik postitused, mis siia kiirv&auml;ljaandesse tehakse (pildid, kommentaarid, arvamused) teiste autorite poolt, nende eest administraatorid ja webmasterid ei saa vastutada (v&auml;ljaarvatud nende endi postitused).<br />
<br />
Sa nõustud mitte postitama sõimu, roppusi, rõvedusi, laimu, solvanguid, &auml;hvardusi, soolisi- ega muid m&auml;rkusi ja kommentaare ning materjale, mis oleksid vastuolus kehtivate seadustega. Sa nõustud et webmaster, administraator ja saidi {SITE_NAME} vahekohtunikud omavad õigust kustutada või parandada mistahes sisu kuidas ja millal neile sobib. Kasutajana sa nõustud, et kogu sinu &uuml;lal sisestatud info salvestatakse andmebaasi. Kuigi seda infot ei avaldata kolmandatele isikutele ilma sinu nõusolekuta, ei saa webmaster ja administraator võtta endale vastutust  h&auml;kkimiskatsete eest, mis võivad andmed ohtu seada.<br />
<br />
See sait kasutab pr&auml;&auml;nikuid slavestamaks infot sinu lokaalses arvutis. Need pr&auml;&auml;nikud on mõeldud ainult tõstmaks sinu vaatamise rõõmu. Eposti aadressi kasutatakse ainult kinnitamaks sinu registreerumise detaile ja parooli.<br />
<br />
...
$lang_register_php = array(
	...
	'acct_created' => 'Sinu konto on loodud ja n&uuml;&uuml;d sa võid sisse logida oma kasutajanime ja parooliga',
	'acct_active' => 'Sinu konto on n&uuml;&uuml;d aktiveeritud ja sa võid sisse logida oma kasutajanime ja parooliga',
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array(
	...
	'warning' => 'Hoiatus',
	'change_perm' => 'see skript ei saa kirjutada sellesse kataloogi, sa pead muutma selle õigusi (mood 755 või 777) enne kui &uuml;ritad uuesti lisada pilte !',
	...
	'notes' =>  '<ul>'.
				...
				'<li><b>PB</b> : t&auml;hendab, et pilti ei saa lisada, kontrolli oma seadeid ja kataloogi õigusi kus su pildid asuvad'.
...
if (defined('UPLOAD_PHP')) $lang_upload_php = array(
	...
	'keywords' => 'M&auml;rksõnad (eralda t&uuml;hikutega)',
