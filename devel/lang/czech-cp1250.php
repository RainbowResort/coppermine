...
$lang_meta_album_names = array(
    ...
    'lastup' => 'Nejnovìj_í obrázky',
    'lastcom' => 'Poslední komentáøe',
    'topn' => 'Nejprohlí_enìj_í',
    'toprated' => 'Nejlépe hodnocené',
    'lasthits' => 'Naposledy prohlí_ené',
...
$lang_errors = array(
    ...
    'quota_exceeded' => 'Vyèerpal(a) jste místo na disku.<br /><br />Va_e kvóta je[quota]K, Va_e obrázky zbírají [space]K, pøidáním tohoto obrázku by jste svoji kvótu pøekroèil',
    'gd_file_type_err' => 'Pokud pou_íváte GD knihovnu jsou podporovány jen obrázky JPG a PNG',
    'invalid_image' => 'Tento obrázek je po_kozen/poru_en GD knihovna s ním nemù_e pracovat.',
    'resize_failed' => 'Nelze vytvoøit náhled èi zmen_ený obrázek',
...
$lang_main_menu = array(
    ...
    'usr_mode_title' => 'Do U_ivatelského módu',
    'usr_mode_lnk' => 'U_ivatelský mód',
    ...
    'login_lnk' => 'Pøihlásit',
    'logout_lnk' => 'Odhlásit',
    'lastup_lnk' => 'Nejnovìj_í obrázky',
    'lastcom_lnk' => 'Poslední komentáøe',
    'topn_lnk' => 'Nejprohlí_enìj_í',
...
$lang_thumb_view = array(
    ...
    'user_on_page' => '%d u_ivatelù na %d stránkách'
);
...
$lang_img_nav_bar = array(
    ...
    'next_title' => 'Dal_í obrázek',
    'pic_pos' => 'OBRÁZEK %s/%s',
);

$lang_rate_pic = array(
    'rate_this_pic' => 'Hodnotit tento obrázek ',
    'no_votes' => '(_ádné hodnocení)',
...
if (defined('ALBMGR_PHP')) $lang_albmgr_php = array(
    ...
    'no_change' => 'Neudìlal(a) jste _ádné zmìny !',
    'new_album' => 'Nová galerie',
    'confirm_delete1' => 'Jste si jist(a), _e chcete smazat tuto galerii ?',
    'confirm_delete2' => '\nV_echny obrázky a komentáøe budou smazány !',
...
if (defined('CATMGR_PHP')) $lang_catmgr_php = array(
    ...
    'usergal_cat_ro' => 'Nelze smazat u_ivatelské galerie !',
...
if (defined('CONFIG_PHP')) $lang_config_data = array(
    ...
    array('Cílová adresa pro odkaz \'Zobrazit dal_í obrázky\' v odkazu pohlednice', 'ecards_more_pic_target', 0),
    array('Jazyk', 'lang', 5),
    array('Témátko', 'theme', 6),

    'Nastavení zobrazení',
    array('_íøka hlavní tabulky v (pixelech nebo %)', 'main_table_width', 0),
    ...
    array('Maximální mno_ství zálo_ek', 'max_tabs', 0),
    ...
    array('_íøka tabulky pro zobrazení obrázku (v pixelech nebo %)', 'picture_table_width', 0),
    array('V_dy zobrazit podrobné info', 'display_pic_info', 1),
    ...
    array('Maximální mno_ství øádkù v komentáøi', 'max_com_lines', 0),
    array('Maximální délka komentáøe', 'max_com_size', 0),

    'Obrázky a nastavení náhledù',
    array('Kvalita souborù JPEG', 'jpeg_qual', 0),
    array('Maximální _íøka nebo vý_ka náhledu<b>*</b>', 'thumb_width', 0),
    array('Vytvoøit støední obrázek','make_intermediate',1),
    array('Maximální _íøka nebo vý_ka støeního obrázku <b>*</b>', 'picture_width', 0),
    ...
    'Nastavení u_ivatelù',
    array('Povolit registraci nových u_ivatelù', 'allow_user_registration', 1),
    array('Pro registraci vy_adovat potvrzení admina', 'reg_requires_valid_email', 1),
    array('Povolit pro dva u_ivatele stejný email', 'allow_duplicate_emails_addr', 1),
    array('Mají mít u_ivatelé vlastní galerii?', 'allow_private_albums', 1),

    'Custom fields for image description (Nechte prázné a nezobrazí se)',
    array('Jméno polo_ky 1', 'user_field1_name', 0),
    array('Jméno polo_ky 2', 'user_field2_name', 0),
    array('Jméno polo_ky 3', 'user_field3_name', 0),
    array('Jméno polo_ky 4', 'user_field4_name', 0),

    'Obrázky a náhledy roz_íøené nastavení',
    ...
    array('Adresáø pro galerie u_ivatelù <b>*</b>', 'userpics', 0),
    ...
    array('Jméno cookies u_ívané programem (expertní volba)', 'cookie_name', 0),
    array('Cesta pro cookies u_ívaná programem (expertní volba)', 'cookie_path', 0),
    array('Kódová stránka', 'charset', 4),

    'Dal_í nastavení',
    array('Zapnour debug mód (jen pro testování)', 'debug_mode', 1),

    '<br /><div align="center">(*) Polo_ky oznaèené * se NESMÍ zmìnit pokud ji_ máte ve va_í Galerii nahrané obrázky</div><br />'
);
...
if (defined('DB_INPUT_PHP')) $lang_db_input_php = array(
    'empty_name_or_com' => 'Vlo_te jméno a Vá_ komentáø',
    'com_added' => 'Vá_ komentáø byl pøidán',
    ...
    'dest_dir_ro' => 'Do cílového adresáøe %s nemù_e skript zapisovat (zkontrolujte práva) !',
    'err_move' => 'Nelze pøesunout %s do %s !',
    'err_fsize_too_large' => 'Rozmìry obrázku, který se sna_íte uploadovat, jsou pøíli_ velké (max. velikost je %s x %s) !',
    'err_imgsize_too_large' => 'Velikost souboru, který se sna_íte uploadovat, je pøíli_ velká (max. velikost je %s KB) !',
    'err_invalid_img' => 'Soubor který jste nahrál(a) na server není validním obrázkem !',
    'allowed_img_types' => 'Mù_ete uploadovat pouze obrázky %s .',
    'err_insert_pic' => 'Obrázek \'%s\' nelze vlo_it do galerie ',
    'upload_success' => 'Vá_ obrázek byl nahrán na server bez problémù<br /><br />Bude viditelný po schválení adminem.',
    'info' => 'Informace',
    'com_added' => 'Komentáøu pøidáno',
    'alb_updated' => 'Galerie aktualizována',
    'err_comment_empty' => 'Vá_ komentáø je prázdný !',
    'err_invalid_fext' => 'Pouze soubory s následujícími koncovkami jsou podporované : <br /><br />%s.',
    'no_flood' => 'Jste autor posledního komentáøe k tomuto obrázku<br /><br />Pokud ho chcete zmìnit pou_ijte volbu upravit ',
    'redirect_msg' => 'Právì jste pøesmìrováván(a).<br /><br /><br />Kliknìte na \'POKRAÈOVAT\' pokud se stránka nepøesmìruje sama',
    'upl_success' => 'Vá_ obrázek byl v poøádku pøidán',
);
...
if (defined('DELETE_PHP')) $lang_delete_php = array(
    ...
    'err_invalid_data' => 'Obdr_ena chybná data \'%s\'',
    ...
    'del_user' => 'Smazat u_ivatele',
    'err_unknown_user' => 'Vybraný u_ivatel neexistuje !',
...
$lang_display_image_php = array(
    'confirm_del' => 'Jste si jist, _e chcete smazat tento obrázek ? \\nPøilo_ené komentáøe budou straceny.',
...
$lang_display_comments = array(
    ...
    'confirm_delete' => 'Jste si jist(a), _e chcete smazat tento komentáø ?',
    'add_your_comment' => 'Pøidat komentáø',
    'your_name' => 'Va_e jméno',
);
...
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php =array(
    ...
    'view_more_pics' => 'Klikni pro dal_í obrázky !',
    'send_success' => 'Va_e pohlednice byla odeslána',
    'send_failed' => 'Omlouváme se, ale server nebyl schopen odeslat Va_í pohlednici zkuste
     to znovu za chvíli...',
    'from' => 'Od',
    'your_name' => 'Va_e jméno',
    'your_email' => 'Vá_ email',
    'to' => 'Komu',
...
if (defined('EDITPICS_PHP')) $lang_editpics_php = array(
    ...
    'postpone_app' => 'Odlo_it schválení',
    'del_pic' => 'Smazat obrázek',
    ...
    'see_next' => 'Zobrazit dal_í obrázky',
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array(
    ...
    'confirm_del' => 'Pokud sma_ete tuto skupinu v_ichni u_ivatelé, patøící do této skupiny budou pøesunuti do skupiny \'Registered\' !\n\nPøejete si pokraèovat ?',
    'title' => 'Spravovat u_ivatelské skupiny',
    'approval_1' => 'Potvrzení veøejného. Upl. (1)',
    'approval_2' => 'Potvrzení soukromého. Upl. (2)',
    'note1' => '<b>(1)</b> Upload do veøejných galerií vy_aduje potvrzení adminem',
    'note2' => '<b>(2)</b> Upload do galerie patøící u_ivateli vy_aduje potvrzení adminem',
    'notes' => 'Poznámky'
);
...
$lang_album_admin_menu = array(
    'confirm_delete' => 'Jste si jist(a), _e chcete smazat tuto galerii? \\nV_echny obrázky a komentáøe pùjdou do pekla taky. Pøejete si pokraèovat.',
    'delete' => 'SMAZAT',
    'modify' => 'VLASTNOSTI',
...
$lang_list_users = array(
    'user_list' => 'Seznam u_ivatelù',
    'no_user_gal' => 'Nejsou _ádné u_ivatelské alerie',
    'n_albums' => '%s galerií',
    'n_pics' => '%s obrázkù'
);
...
if (defined('LOGIN_PHP')) $lang_login_php = array(
    'login' => 'Pøihlá_ení',
    'enter_login_pswd' => 'Zadejte Va_e jméno a heslo pro pøihlá_ení',
    'username' => 'Jméno',
    'password' => 'Heslo',
    'remember_me' => 'Pamatuj si mì',
    'welcome' => 'Vítej u nás %s ...',
    'err_login' => '*** Chyba pøi pøihlá_ení skuste to znova ***',
    'err_already_logged_in' => 'Ji_ jste pøihlá_en !',
);
...
if (defined('LOGOUT_PHP')) $lang_logout_php = array(
    'logout' => 'Odhlásit',
    'bye' => 'Tak si to u_ij zase jinde %s ...',
    'err_not_loged_in' => 'Nejste pøihlá_en !',
);
...
if (defined('MODIFYALB_PHP')) $lang_modifyalb_php = array(
    ...
    'can_view' => 'Album mù_ou prohlí_et',
    'can_upload' => 'Náv_tìvníci smìjí pøidávat obrázky',
    'can_post_comments' => 'Povolit komentáøe',
    'can_rate' => 'Náv_tìvníci mohou hlasovat',
    'user_gal' => 'User Gallery',
    'no_cat' => '* Není kategorie *',
    'alb_empty' => 'Galerie je prázdná',
    'last_uploaded' => 'Nejnovìj_í obrázek',
...
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array(
    'already_rated' => 'Tento obázek jste ji_ hodnotil(a)',
...
Administrátoøi serveru {SITE_NAME}, pota_mo této galerie si vyhrazují právo zásahu do obsahu galerie napø. komentáøe, mazání obrázkù pøípadnì úprava (pokud poru_ují pravidla galerie nebo dobré mravy).
Pokud budou obrázky nahrané u_ivetelem poru_ovat zákon(y) budou ihned po zji_tìní jejich umístìní na serveru smazány. Administrátoøi/provozovatelé této galerie si distancují od
pøípadného závadného obsahu nahraného na server u_ivateli. Vlastníkem dat v galerii jsou jejich autoøi. Administrátoøi pøedpokládají, _e na server jsou umís_ovaná u_ivateli pouze obrázky k ním_ vlastní u_ivatel autorská práva.
<br />
Pokud souhlasíte, _e nebudete posílat jakýkoliv závadný materiál jako vulgární a obscéní obrázky/komentáøe, jakýkoliv materiál vzbuzující nenávist, rasismus, nebo jiný materiál poru_ující zákony. Souhlasíte, _e administrátoøi, provozovatelé a moderátoøi  {SITE_NAME}   mají právo smazat pøípadnì upravit jakýkoliv materiál kdykoliv to uznají za vhodné. Vlo_ené informace budou ulo_ené na serveru a v databázi a nebudou poskytnuty _ádné tøetí stranì bez va_eho souhlasu. Administátoøi/povozovatelé serveru  v_ak nejsou ani nebudou ruèit za data na serveru ulo_ená pokud dojde k jakémukoliv útoku na sever.
<br />
<br />
Tyto stránky vyu_ívají k ulo_ení u_ivatelských dat cookies. Cookies slou_í pouze pro zvý_ení konfortu pøi pou_ívání této aplikace. Emailová adresa slou_í jen pro potvrzení va_ich údajù a poslání hesla.<br />
<br />
Kliknutím na 'Souhlasím' souhlasíte z vý_e uvedenými pravidly..
EOT;

$lang_register_php = array(
    'page_title' => 'Registrace nového u_ivatele',
    'term_cond' => 'Podmínky a pravidla',
    'i_agree' => 'Souhlasím',
    'submit' => 'Poslat registraci',
    'err_user_exists' => 'Zadané u_ivatelské jméno ji_ existuje vyberte si prosím jiné',
    'err_password_mismatch' => 'Hesla se musí schodovat pokuste je obì zadat znovu',
    'err_uname_short' => 'Minimální délka u_ivatelského jména je 2 znaky',
    ...
    'err_duplicate_email' => 'Jiný u_ivatel se zaregistroval se zadaným emailem. Email musí být jedineèný',
    'enter_info' => 'Zadané registraèní informace',
    'required_info' => 'Vy_adované informace',
    ...
    'thank_you' => 'Dìkujeme za registraci.<br /><br />Na adresu zadanou pøi registraci Vám budou doruèeny informace o aktivaci va_eho úètu',
    'acct_created' => 'Vá_ u_ivatelský úèet byl bezchybnì vytvoøen. Nyní se pøihla_te pomocí va_eho jména a hesla',
    'acct_active' => 'Vá_ úèet je nyní aktivní pøihla_te se pomocí va_eho jména a hesla.',
    'acct_already_act' => 'Vá_ úèet je ji_ aktivní !',
    'acct_act_failed' => 'Tento úèet nmù_e být aktivován !',
    'err_unk_user' => 'Vybraný u_ivatel neexistuje !',
    'x_s_profile' => '%s\' profil',
    'group' => 'Skupina',
    'reg_date' => 'Pøipojen',
    'disk_usage' => 'Vyu_ití disku',
    ...
    'change_pass' => 'Zmìnit heslo',
    'update_success' => 'Vá_ profil byl aktualizován',
    'pass_chg_success' => 'Vy_e heslo bylo zmìnìno',
    'pass_chg_error' => 'Va_e heslo nebylo zmìnìno',
);

$lang_register_confirm_email = <<<EOT
Dìkujeme za registraci na {SITE_NAME}

Va_e jméno je : "{USER_NAME}"
Va_e heslo je: "{PASSWORD}"

Pro aktivaci va_eho úètu je pøeba kliknout na odkaz ní_e nebo ho zkopírovat
do adresního øádku va_eho browseru a pøejít na tuto stránku
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array(
    ...
    'select_dir_msg' => 'Tato funkce vám umo_ní dávkovì zpracovat obrázky nahrané pøes FTP.<br /><br />Vyberte adresáø kde se nacházejí obrázky k spracování',
    'no_pic_to_add' => 'Nejsou zde _ádné obrázky k pøidání',
    'need_one_album' => 'Poøebujete mít vytvoøenu alespoò jednu galerii',
    'warning' => 'Varování',
    'change_perm' => 'Skript nemù_e zapisovat do tohoto adresáøe, musíte ho nastavit na CHMOD 755 nebo 777 pøed pøidáním obrázkù !',
    'target_album' => '<b>Vlo_it obrázky z &quot;</b>%s<b>&quot; do </b>%s',
    'folder' => 'Slo_ka',
    'image' => 'Obrázek',
    'album' => 'Galerie',
    'result' => 'Výsledek',
    ...
    'insert_selected' => 'Vlo_it vybrané obrázky',
    ...
    'notes' =>  '<ul>'.
                ...
                '<li>Kdy_ se neuká_e \'oznaèení\' OK, DP, PB klepnìte na obrázek a uvidíte chybovou hlá_ku generovanou PHP, která Vám pomù_e zjistit pøíèinu problému'.
...
if (defined('USERMGR_PHP')) $lang_usermgr_php = array(
    ...
    'disku_a' => 'Vyu_ití disku vzestup.',
    'disku_d' => 'Vyu_ití disku sestup.',
    'sort_by' => 'Øadit u_øivatele podle',
    'err_no_users' => 'Tabulka u_ivatelù je prázdná!',
    'err_edit_self' => 'Zde nelze editovat vlastní profil pou_ijte pøíslu_nou volbu pracující s va_ím profilem',
    'edit' => 'UPRAVIT',
    'delete' => 'SMAZAT',
    'name' => 'U_iv. jméno',
    'group' => 'Skupina U_iv.',
    ...
    'operations' => 'Operace',
    'pictures' => 'Obrázky',
    'disk_space' => 'Místo vyu_ité / kvóta',
    'registered_on' => 'Registrován',
    'u_user_on_p_pages' => '%d u_ivatelù na %d stránkách',
    'confirm_del' => 'Jste si jist(a), _e chcete smazat tohoto u_ivatele ? \\nV_echny jeho obrázky, galerie a komentáøe budou smazány.',
    'mail' => 'MAIL',
    'err_unknown_user' => 'Vybraný u_iv. neexistuje !',
    'modify_user' => 'Zmìnit u_iv.',
    'notes' => 'Poznámky',
    'note_list' => '<li>Pokud nechcete zmìnit heslo ponechte políèko pro heslo prázdné',
    'password' => 'Heslo',
    'user_active' => 'U_iv. je aktivní',
    'user_group' => 'U_iv. Skupina',
    'user_email' => 'U_iv. emaill',
    'user_web_site' => 'U_iv. domácí stránka',
    'create_new_user' => 'Vytvoøit nového u_ivatle.',
    'user_location' => 'Místo U_iv. (napø. Praha apod.)',
    'user_interests' => 'U_iv. zájmy',
    'user_occupation' => 'U_iv. povolání',
);
?>
