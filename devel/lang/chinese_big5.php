...
$lang_errors = array(
  ...
  'quota_exceeded' => '超過磁碟配額<br /><br />你的配額有 [quota]K, 已使用的有 [space]K, 加入此圖片會超過配額.', //cpg1.3.0
  ...
  'directory_ro' => '目錄 \'%s\' 無法寫入, 導致圖片無法刪除', //cpg1.3.0
  'non_exist_comment' => '所選擇的留言並不存在.',
  'pic_in_invalid_album' => '此圖片存於 不存在的相簿 (%s)!?', //cpg1.3.0
  'banned' => '你目前被禁止使用本站.',
...
$lang_img_nav_bar = array(
  ...
  'prev_title' => '觀看前一張圖片', //cpg1.3.0
  'next_title' => '觀看下一張圖片', //cpg1.3.0
...
if (defined('CONFIG_PHP')) $lang_config_data = array(
  ...
  array('在電子卡片內顯示\'觀看更多圖片\'的網址', 'ecards_more_pic_target', 0),
  ...
  array('顯示圖片說明於縮圖下方 (附加的標題)', 'caption_in_thumbview', 1), //cpg1.3.0
  ...
  array('圖片的原始排序次序', 'default_sort_order', 3), //cpg1.3.0
  array('\'熱門投票\'需要最少投票數', 'min_votes_for_rating', 0), //cpg1.3.0

  '圖片顯示 &amp; 留言設定',
  array('圖片顯示的表格寬度 (像素或 %)', 'picture_table_width', 0), //cpg1.3.0
  array('圖片資訊預設顯示', 'display_pic_info', 1), //cpg1.3.0
  ...
  <a name="notice2"></a>(**) 改變這個設定只影響已經加入的檔案, 如果那些檔案已經在相簿內了,這個設定不必改變. 無論如何,你可以從 管理員功能選單裡 調整既有的檔案,從 &quot;<a href="util.php">管理員工具箱</a> (調整圖片尺寸)&quot; </div><br />', //cpg1.3.0
);
