...
$lang_translation_info = array(
  ...
  'trans_name'=> 'Goran Jurić',
  'trans_email' => '',
  'trans_website' => 'http://info-mob.com/',
  'trans_date' => '2004-10-27',
);
...
$lang_errors = array(
  ...
  'quota_exceeded' => 'Premašena kvota diska<br /><br />Vaša kvota prostora je [quota]K, vaše slike trenutno zauzimaju [space]K, ako dodate ovu sliku premašit ćete kvotu.', //cpg1.3.0
  'gd_file_type_err' => 'Kada koristite GD image library dozvoljeni tipovi slika su samo JPEG and PNG.',
  'invalid_image' => 'Uploadana slika ima grešku ili ne može biti obrađena od strane GD library',
  ...
  'not_with_udb' => 'Ova funkcija je onemogućena u Coppermine-u jer je integrirana sa skriptom za forum. Ili ono što pokušavate napraviti nije podržano u ovoj konfiguraciji, ili funkciju treba izvršiti skripta za forum.',
...
$lang_main_menu = array(
  ...
  'memberlist_title' => 'Pokaži popis članova', //cpg1.3.0
...
$lang_cpg_debug_output = array(
  ...
  'copy_and_paste_instructions' => 'Ako želite zatražiti pomoć na forumu, copy-and-paste ovaj debug kod u vaš post. Provjerite da li ste zamijenili sve zaporke u postu sa *** prije objavljivanja posta.', //cpg1.3.0
...
if (defined('CONFIG_PHP')) $lang_config_data = array(
  ...
  array('Filtriraj ružne riječi u komentarima', 'filter_bad_words', 1),
  ...
  //array('Dopušteni tipovi slika (važeći samo za ImageMagick)', 'allowed_img_types',0), //cpg1.3.0
...
if (defined('DB_ECARD_PHP')) $lang_db_ecard_php = array(
  ...
  'ecards_delete_confirm' => 'Jeste li sigurni da želite izbrisati podatke? Označite checkbox!', //cpg1.3.0
...
if (defined('DB_INPUT_PHP')) $lang_db_input_php = array(
  ...
  'err_fsize_too_large' => 'Veličina dokumenta kojeg ste uploadali je prevelika (maksimalna dopuštena je %s x %s) !', //cpg1.3.0
  'err_imgsize_too_large' => 'Veličina dokumenta kojeg ste uploadali je prevelika (maksimalna došuštena je %s KB) !',
  'err_invalid_img' => 'Dokument kojeg ste uploadali nije važeća slika !',
  'allowed_img_types' => 'Možete uploadati samo %s slike.',
  'err_insert_pic' => 'Dokument \'%s\' se ne može dodati u album ', //cpg1.3.0
  'upload_success' => 'Vaš dokument je uploadan uspješno<br /><br />Bit će vidljiv nakon odobrenja administratora.', //cpg1.3.0
  ...
  'no_flood' => 'Žao mi je, ali Vi ste već autor posljednjeg komentara za ovu sliku<br /><br />Uredite komentar kojeg ste napisali, ako ga želite izmijeniti', //cpg1.3.0
...
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php =array(
  ...
  'invalid_email' => '<b>Upozorenje</b> : nevažeća e-mail adresa !',
  'ecard_title' => 'E-razglednica od %s za Vas',
  'error_not_image' => 'Samo se slike mogu poslati kao e-razglednice.', //cpg1.3.0
  'view_ecard' => 'Ako se e-razglednica ne prikaže točno, kliknite na ovaj link',
...
if (defined('FAQ_PHP')) $lang_faq_data = array(
  ...
  array('Zašto se trebam registrirati?', 'Administrator može, ali ne mora zahtijevati registraciju.Registracija članu omogućuje dodatne mogućnosti, kao uploadanje, posjedovanje liste favorita, mogućnost ocjenjivanja slika, pisanja komentara, itd.', 'omogući registraciju korisnika', '0'), //cpg1.3.0
  array('Kako se registrirati?', 'Odite na &quot;Registracija&quot; i ispunite potrebna polja (i opcionalna ako to želite).<br />Ako administrator ima e-mail aktivaciju , tada ćete nakon slanja Vaših podataka primiti e-mail na adresu koju ste naveli prilikom registracije, u kojem su naputci o tome kako aktivirati Vaše članstvo. Morate aktivirati članstvo kako biste se mogli logirati.', 'allow_user_registration', '1'), //cpg1.3.0
  array('Kako se logirati?', 'Odite na &quot;Login&quot;, unesite Vaše korisničko ime i zaporku i kliknite na &quot;Upamti me&quot; tako ćete biti logirani ia ako napustite stranice.<br /><b>VAŽNO:Cookies moraju biti uključeni i cookie s ovih stranica se ne smije izbrisati kako bi se mogla koristiti opcija &quot;Upamti me&quot;.</b>', 'offline', 0), //cpg1.3.0
  array('Zašto se ne mogu logirati?', 'Jeste li se registrirali i odgovorili na link koji Vam je poslan u e-mail poruci?. Ovaj link aktivira Vaše članstvo. Za druge probleme u vezi logiranja kontaktirajte administratora.', 'offline', 0), //cpg1.3.0
  array('Što ako sam zaboravio/la zaporku?', 'Ako ove stranice imaju &quot;Zaboravljena zaporka&quot; link onda ga upotrijebite. U drugim slučajevima kontaktirajte administratora za novu zaporku.', 'offline', 0), //cpg1.3.0
  ...
  array('Kako ću sačuvati sliku u  &quot;Moji favoriti&quot;?', 'Kliknite na sliku i kliknite na &quot;info o slici&quot; link (<img src="images/info.gif" width="16" height="16" border="0" alt="Picture information" />); odite na informacije o slici i kliknite &quot;Dodaj u favorite&quot;.<br />Administrator može imati  &quot;informacije o slici&quot; po defaultu.<br />VAŽNO:Cookies moraju biti uključeni za ovu stranicu i ne smiju se izbrisati.', 'offline', 0), //cpg1.3.0
  array('Kako ću ocijeniti sliku?', 'Kliknite na thumbnail slike i odite na dno, te odaberite ocjenu.', 'offline', 0), //cpg1.3.0
  array('Kako ću napisati komentar za sliku?', 'Kliknite na thumbnail slike i odite na dno, te napišite komentar.', 'offline', 0), //cpg1.3.0
  array('Kako ću uploadati sliku?', 'Odite na  &quot;Uploadaj sliku&quot;te odaberite album u kojeg želite uploadati,kliknite &quot;Browse&quot; i odaberite sliku za upload, kliknite &quot;open&quot; (dodajte naslov i opis ako želite) i kliknite &quot;Submit&quot;', 'allow_private_albums', 0), //cpg1.3.0
  array('Gdje ću uploadati sliku?', 'Moći ćete uploadati sliku u jedan od Vaših albuma u &quot;Moja galerija&quot;. Administrator Vam može dopustiti da uploadate jednu ili više slika u albume u glavnoj galeriji.', 'allow_private_albums', 0), //cpg1.3.0
  ...
  array('Kako ću kreirati, promijeniti naziv ili izbrisati album u  &quot;Moja galerija&quot;?', 'Morate biti u &quot;Admin-Modu&quot;<br />Odite &quot;Kreiraj/Poredaj moje albume&quot;i kliknite &quot;Novo&quot;. Promijeni &quot;Novi album&quot; u željeno ime.<br />Također možete preimenovati bilo koji album u Vašo galeriji.<br />Kliknite &quot;Primijeni promjene&quot;.', 'allow_private_albums', 0), //cpg1.3.0
  array('Kako mogu izmijeniti i onemogućiti korisnike da gledaju moje albume?', 'Morate biti u &quot;Admin. Modu&quot;<br />Idite na &quot;Izmijeni moje albume. Na &quot;Osvježi album&quot; baru, odaberite album kojeg želite izmijeniti.<br />Ovdje možete promijeniti naziv, opis, thumbnail sliku, ograničiti dopuštenje za pregledanje i komentiranje/ocjenjivanje.<br />Kliknite &quot;Osvježi album&quot;.', 'allow_private_albums', 0), //cpg1.3.0
  ...
  array('Što su kolačići (cookies)?', 'Cookies su tekstualni podaci koji se šalju sa stranica i koji se postavljaju na Vaš kompjuter.<br />Cookies obično dopuštaju korisniku da napusti neke stranice i da se kasnije na njih vrati bez ponovnog logiranja.', 'offline', 0), //cpg1.3.0
  array('Gdje mogu nabaviti ovaj program za moje stranice?', 'Coppermine je besplatna multimedijalna galerija, ostvarena pod GNU GPL. Ima brojne mogućnosti i može se koristiti na različitim platformama. Posjetite <a href="http://coppermine.sf.net/">Coppermine Home Page</a> za više informacija ili za download.', 'offline', 0), //cpg1.3.0

  'Navigating the Site', //cpg1.3.0
  array('Što je &quot;Popis albuma&quot;?', 'On će Vam pokazati cijelu galeriju s linkovima za svaku kategoriju. Thumbnail mugu biti link za kategorije.', 'offline', 0), //cpg1.3.0
  array('Što je &quot;Moja galerija&quot;?', 'Ova omogućuje korisnicima da otvaraju vlastite galerije i da dodaju/brišu ili mijenjaju albume kao i da u njih uploadju.', 'allow_private_albums', 0), //cpg1.3.0
  array('Što je razlika između &quot;Admin Moda&quot; i &quot;Korisničkog Moda&quot;?', 'Kada ste u admin-modu, možete modificirati svoje galerije (kao i druge ako Vam to dopusti administrator).', 'allow_private_albums', 0), //cpg1.3.0
  array('Što je &quot;Uploadaj sliku&quot;?', 'Ova mogućnost dopušta korisniku da uploada sliku (veličinu i vrstu određuje administrator) u galeriju koju odabere ili korisnik ili administrator.', 'allow_private_albums', 0), //cpg1.3.0
  ...
  array('Što je &quot;Najbolje ocijenjene&quot;?', 'Ova rubrika pokazuje najbolje ocijenjene slike od strane korisnika, te pokazuje prosječnu ocjenu (e.g: five users each gave a <img src="images/rating3.gif" width="65" height="14" border="0" alt="" />: the picture would have an average rating of <img src="images/rating3.gif" width="65" height="14" border="0" alt="" /> ;Five users rated the picture from 1 to 5 (1,2,3,4,5) would result in an average <img src="images/rating3.gif" width="65" height="14" border="0" alt="" /> .)<br />The ratings go from <img src="images/rating5.gif" width="65" height="14" border="0" alt="best" /> (best) to <img src="images/rating0.gif" width="65" height="14" border="0" alt="worst" /> (worst).', 'offline', 0), //cpg1.3.0
  array('Što je &quot;Moji favoriti&quot;?', 'Ova rubrika omogućava korisnicima da sačuvaju omiljene slike u cookieju koji je poslan na kompjuter.', 'offline', 0), //cpg1.3.0
);
...
if (defined('FORGOT_PASSWD_PHP')) $lang_forgot_passwd_php = array(
  ...
  'enter_username_email' => 'Unesite Vaše korisničko ime i e-mail adresu', //cpg1.3.0
  'submit' => 'go', //cpg1.3.0
  'failed_sending_email' => 'E-mail podsjetnika za zaporku se ne može poslati !', //cpg1.3.0
  'email_sent' => 'E-mail sa Vašim korisničkim imenom i zaporkom je poslan %s', //cpg1.3.0
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array(
  ...
  'confirm_del' => 'Upozorenje, kada izbrišete grupukorisnici koji pripadaju toj grupi biti će prebačeni u \'Registrirani\' grupu !\n\nŽalite li nastaviti ?', //js-alert //cpg1.3.0
  ...
  'custom_user_upload'=>'Može li korisnik prilagoditi broj upload kućica?', //cpg1.3.0
...
if (defined('LOGIN_PHP')) $lang_login_php = array(
  'login' => 'Login',
  'enter_login_pswd' => 'Unesite Vaše korisničko ime i zaporku',
...
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array(
  'already_rated' => 'Žao nam je, ali već ste ocijenili ovu sliku', //cpg1.3.0
...
Iako će administrator {IME_GALERIJE} brisati ili izmijeniti shvati neprihvatljivi materijal čim prije, nemoguće je pregledati baš svaki komentar. Stoga, prihvaćate da stavovi objavljeni na ovim stranicama izražavaju poglede i mišljenja autora, a ne administratora ili webmastera (osim za njihove vlastite), te oni neće biti odgovorni za iste.<br />
<br />
Prihvaćate klauzulu da nećete objavljivati nikakav materijal koji je uvredljiv, opscen, vulgaran, prepun mržnje, prijetnji, ili bilo kakav drugi koji bi mogao povrijediti postojeće zakone. Slažete se da webmaster, administrator i moderatori {IME_GALERIJE} imaju pravo ukloniti ili izmijeniti bilo koji sadržaj u bilo koje vrijeme ako budu smatrali to potrebnim. Kao korisnik slažete se da sve informacije koje upišete bude spremljene u bazi podataka. Iako ove informacije neće biti proslijeđene trećim strankama bez Vašeg dopuštenja, webmaster i administrator ne mogu biti odgovorni za bilo kakvo hackiranje, koje bi dovelo do kompromitiranja podataka.<br />
<br />
...
<br />
Kliknuvši na 'Slažem se' ispod, potvrđujete da se slažete sa gore navedenim uvjetima.
EOT;
...
$lang_register_php = array(
  ...
  'acct_created' => 'Vaš račun je otvoren i sada se možete logirati s Vašim korisničkim imenom i zaporkom',
  'acct_active' => 'Vaš račun je sada aktivan i i Vi se možete logirati sa Vašim korisničkim imenom i zaporkom',
  'acct_already_act' => 'Vaš račun je već aktivan !',
  'acct_act_failed' => 'Ovaj račun se ne može aktivirati !',
  ...
  'notify_admin_email_body' => 'Novi korisnik s korisničkim imenom "%s" se upravo registrirao u Vašoj galeriji', //cpg1.3.0
);

$lang_register_confirm_email = <<<EOT
Hvala za registraciju u {IME_GALERIJE}

Vaše korisničko ime je : "{KORISNIČKO_IME}"
Vaša zaporka je : "{ZAPORKA}"

Da biste aktivirali Vaš račun, trebate kliknuti na link ispod, ili ga kopirati u Vaš preglednik.
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array(
  ...
  'select_dir_msg' => 'Ova funkcija Vam omogućuje da dodate batch of file koju ste uploadali na Vaš server preko FTP-a.<br /><br />Select the directory where you have uploaded your files', //cpg1.3.0
  ...
  'dir_cant_read' => 'Ne može se čitati. ',
...
if (defined('BANNING_PHP')) $lang_banning_php = array(
  ...
  'error_server_ban' => 'Jeste li htjeli zabraniti pristup vlastitom serveru? Tsk tsk, ne možete to učiniti...', //cpg1.3.0
...
if (defined('UPLOAD_PHP')) $lang_upload_php = array(
  ...
  'cust_instr_1' => 'Možete odabrati prilagođeni broj kućica za upload. Ali, ne možete odabrati više od ograničenja naznačenog ispod.', //cpg1.3.0
  ...
  'cust_instr_7' => 'Molimo Vas, unesite broj svakog tipa kućica za upload koje želite. Tada kliknite  \'Nastavi\'. ', //cpg1.3.0
  'reg_instr_1' => 'Nevaljana radnja za stvaranje obrasca.', //cpg1.3.0
  'reg_instr_2' => 'Sada možete uploadati Vaše slike koristeći kućice za upload ispod. Veličina uploadanih slika na server ne smije prijeći %s KB svaka. ZIP slike uploadane u \'Upload slika\' i \'URI/URL Upload\' rubrike će ostai compressed.', //cpg1.3.0
  'reg_instr_3' => 'Ako želite dekompresirati zip slike ili arhiv, morate koristiti kućicu za upload slika koja se nalazi \'Decompressive ZIP Upload\' rubrici.', //cpg1.3.0
  ...
  'error_instr' => 'Slijedeći uploadi imaju poteškoće:', //cpg1.3.0
  ...
  'exc_php_ini' => 'Premašena dopuštena veličina slike u php.ini.', //cpg1.3.0
  'exc_file_size' => 'Premašena veličina slike dozvoljena po CPG.', //cpg1.3.0
  ...
  'no_file_size' => 'Ne sadrži podatke/Oštećena', //cpg1.3.0
  'impossible' => 'Nemoguće prebaciti.', //cpg1.3.0
  'not_image' => 'Nije slika/oštećeno', //cpg1.3.0
  ...
  'cant_read_URI' => 'Ne može se pročitati URI/URL', //cpg1.3.0
  ...
  'place_instr_1' => 'Molimo Vas, stavite slike u albume.  Možete također unijeti informacije o svakoj slici.', //cpg1.3.0
...
if (defined('UTIL_PHP')) $lang_util_php = array(
  ...
  'what_update_titles' => 'Osvježava naslove iz imena slika',
  'what_delete_title' => 'Briše naslove',
  'what_rebuild' => 'Osvježava thumbnaile i mijenja veličinu slika',
  'what_delete_originals' => 'Briše originalne slike mijenjajući ih sa verzijom promijenjene veličine',
  'file' => 'Slika',
  ...
  'thumbs_wait' => 'Osvježava thumbnaile i/ili slike promijenjene veličine, molimo Vas, sačekajte...',
  'thumbs_continue_wait' => 'Nastavlja osvježavanje thumbnaila i/ili slika promijenjene veličine...',
  ...
  'update' => 'Osvježava thumbe i/ili slike promijenjene veličine',
  'update_what' => 'Što treba osvježiti',
  'update_thumb' => 'Samo thumbnaile',
  ...
  'delete' => 'Izbriši tipove slika ili originalnu veličinu slika', //cpg1.3.0
  'delete_title' => 'Izbriši naslove slika', //cpg1.3.0
  'delete_original' => 'Izbriši originalnu veličinu slika',
  'delete_replace' => 'Briše originalne slike mijenjajući ih slikama promijenjene veličine',
  ...
  'update_db_explanation' => 'Ako ste zamijenili Coppermine files, dodali ispravke ili osvježili sa prethodne verzije Coppermine-a, pazite da osvježite bazu padataka. Ovaj postupak će kreirati potrebne tablice i/ili config vrijednosti u vašoj Coppermine bazi podataka.', //cpg1.3.0
);
