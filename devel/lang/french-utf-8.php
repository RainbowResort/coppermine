...
if (defined('FAQ_PHP')) $lang_faq_data = array(
  ...
  array('Qu\'est-ce-que &quot;Les mieux not̩es&quot; ?', 'Cette fonctionnalit̩ vous montre les photos, tri̩es par leur note moyenne. Par exemples : <br />- Si 5 utilisateurs donnent chacun la note 3 (<img src="images/rating3.gif" width="65" height="14" border="0" alt="3" />), la photo obtient la note moyenne de 3 (<img src="images/rating3.gif" width="65" height="14" border="0" alt="3" />).<br />- Si 5 utilisateurs donnent les notes 1, 2, 3, 4 et 5, la photo obtient une moyenne de 3 ̩galement (<img src="images/rating3.gif" width="65" height="14" border="0" alt="3" /> ).<br />Les notes vont de <img src="images/rating5.gif" width="65" height="14" border="0" alt="5" /> (meilleure) to <img src="images/rating0.gif" width="65" height="14" border="0" alt="0" /> (moins bonne).', 'offline', 0), //cpg1.3.0
