...
$lang_translation_info = array(
  ...
  'trans_name'=> 'Joachim M&uuml;ller',
...
// For the word censor
$lang_bad_words = array('*fuck*', 'Fu\(*', 'fuk*', 'masturbat*', 'motherfucker', 'nigger*', 'penis', 'pussy', 'shit', 'titties', 'titty',  'arsch*', 'fick*', 'fotze', 'votze', 'Sieg Heil', 'Heil Hitler', 'Nutte', 'M&ouml;se', 'Moese', 'Pimmel', 'Schwengel', 'Titte*', 'bums*', 'Scheiss*', 'Schei&szlig;*');
...
$lang_errors = array(
  ...
  'non_exist_ap' => 'Das gew&auml;hlte Album bzw. die gew&auml;hlte Datei existiert nicht!',
  'quota_exceeded' => 'Speicherplatz ersch&ouml;pft<br /><br />Du hast ein Speicherlimit von [quota] kB, Deine Dateien belegen zur Zeit [space] kB, das Hinzuf&uuml;gen dieser Datei w&uuml;rde Deinen Speicherplatz &uuml;berschreiten.',
  ...
  'directory_ro' => 'Das Verzeichnis \'%s\' ist nicht beschreibbar, die Dateien k&ouml;nnen nicht gel&ouml;scht werden',
  ...
  'not_with_udb' => 'Diese Funktion ist innerhalb von Coppermine deaktiviert, weil sie in die Forums-Software integriert ist. Entweder wird das, was Du gerade zu tun versucht hast, in dieser Konfiguration nicht unterst&uuml;tzt oder die Funktion sollte von der Forums-Software &uuml;bernommen werden.',
  'offline_title' => 'Wartungsmodus',
  'offline_text' => 'Die Galerie ist zur Zeit im Wartungsmodus - schau sp&auml;ter nochmal vorbei!', //cpg1.3.0
  'ecards_empty' => 'Es k&ouml;nnen derzeit keine eCard-Eintr&auml;ge gefunden werden. &Uuml;berpr&uuml;fe, ob die Aufzeichung von eCards in den Einstellungen aktivert wurde!',
  'action_failed' => 'Aktion fehlgeschlagen. Coppermine konnte die gew&uuml;nschte Aktion nicht ausf&uuml;hren.', //cpg1.3.0
  'no_zip' => 'Die zum Verarbeiten von ZIP-Dateien notwendigen libraries sind auf dem Server nicht verf&uuml;gbar. Setze Dich mit dem Server-Admin in Verbindung.',
  'zip_type' => 'Keine Berechtigung f&uuml;r den Upload von ZIP-Dateien.',
  'database_query' => 'Beim Ausf&uuml;hren einer Datenbank-Abfrage ist ein Fehler aufgetreten', //cpg1.4
  'non_exist_comment' => 'Der gew&auml;hlte Kommentar existiert nicht', //cpg1.4
);
...
$lang_main_menu = array(
  ...
  'my_gal_title' => 'Gehe zu meiner pers&ouml;nlichen Galerie',
  ...
  'faq_title' => 'H&auml;ufig gestellte Fragen (Frequently Asked Questions) zur Galerie &quot;Coppermine&quot;',
  'faq_lnk' => 'FAQ',
);

$lang_gallery_admin_menu = array(
  'upl_app_title' => 'Neu hochgeladene Dateien best&auml;tigen', //cpg1.4
...
$lang_user_admin_menu = array(
  ...
  'my_prof_title' => 'gehe zu meinem pers&ouml;nlichen Profil', //cpg1.4
  'my_prof_lnk' => 'Mein Profil',
);
...
$lang_thumb_view = array(
  ...
  'enter_alb_pass' => 'Gib das Passwort f&uuml;r das Album ein', //cpg1.4
  'invalid_pass' => 'Ung&uuml;ltiges Passwort', //cpg1.4
...
$lang_img_nav_bar = array(
  ...
  'next_title' => 'n&auml;chste Datei anzeigen',
  'pic_pos' => 'Datei %s/%s',
  'report_title' => 'Diese Datei dem Administrator melden', //cpg1.4
  'go_album_end' => 'Zum Ende gehen', //cpg1.4
  'go_album_start' => 'Zum Anfang zur&uuml;ckkehren', //cpg1.4
  'go_back_x_items' => 'gehe %s Eintr&auml;ge zur&uuml;ck', //cpg1.4
  'go_forward_x_items' => 'gehe %s Eintr&auml;ge weiter', //cpg1.4
);
...
$lang_language_selection = array(
  ...
  'choose_language' => 'W&auml;hle Sprache',
);
...
$lang_version_alert = array(
  'version_alert' => 'Nicht unterst&uuml;tzte Version!', //cpg1.4
  'no_stable_version' => 'Du betreibst Coppermine version  %s (%s), das nur f&uuml;r erfahrene Benutzer gedacht ist - f&uuml;r diese Version gibt es keinen Support oder Funktions-Garantien. Benutze sie auf eigenes Risiko oder downgrade auf die aktuellste stabile Version, wenn Du Support brauchst!', //cpg1.4
  'gallery_offline' => 'Die Galerie ist zur Zeit im Wartungs-Modus und ist nur f&uuml;r Dich als Admin zug&auml;nglich. Vergiss nicht, sie wieder aus dem Wartungs-Modus in den "normalen" Modus zur&uuml;ck zu schalten, wenn Deine Wartungsarbeiten beendet sind.', //cpg1.4
);

$lang_create_tabs = array(
  'previous' => 'vorherige', //cpg1.4
  'next' => 'n&auml;chste', //cpg1.4
);
...
if (defined('ALBMGR_PHP')) $lang_albmgr_php = array(
  'alb_need_name' => 'Alben m&uuml;ssen einen Namen haben!', //js-alert
  'confirm_modifs' => 'Bist Du sicher, dass Du diese &Auml;nderungen durchf&uuml;hren willst?', //js-alert
  'no_change' => 'Du hast nichts ver&auml;ndert!', //js-alert
  'new_album' => 'neues Album',
  'confirm_delete1' => 'Willst Du dieses Album wirklich l&ouml;schen?', //js-alert
  'confirm_delete2' => '\nAlle Dateien und Kommentare, die darin enthalten sind, werden gel&ouml;scht!', //js-alert
  'select_first' => 'W&auml;hle zuerst ein Album', //js-alert
...
if (defined('BANNING_PHP')) $lang_banning_php = array(
  ...
  'expiry' => 'l&auml;uft ab am (leer bedeutet permanent)', //cpg1.4
  'edit_ban' => '&Auml;nderungen speichern', //cpg1.4
  'delete_ban' => 'L&ouml;schen', //cpg1.4
  'add_new' => 'Neuen Bann hinzuf&uuml;gen', //cpg1.4
  'add_ban' => 'Hinzuf&uuml;gen', //cpg1.4
  ...
  'error_ban_id' => 'Ung&uuml;ltige Verbannungs-ID!', //cpg1.4
  ...
  'error_ip_forbidden' => 'Du kannst diese IP-Adresse nicht verbannen - sie ist sowieso nicht route-bar (private)!<br />Wenn Du Verbannungen f&uuml;r private IP-Adressen erlauben m&ouml;chtest, dann erlaube das in Deinen <a href="admin.php">Einstellungen</a> (macht nur Sinn, wenn Coppermine in einem LAN l&auml;uft).', //cpg1.4
  'lookup_ip' => 'IP-Adresse nachschlagen', //cpg1.4
  'submit' => 'los!', //cpg1.4
  'select_date' => 'W&auml;hle Datum', //cpg1.4
);
...
if (defined('BRIDGEMGR_PHP')) $lang_bridgemgr_php = array(
  ...
  'warning' => 'Warnung: bevor Du diesen Assitenten benutzt muss Dir klar sein, dass Sicherheits-relevante Daten &uuml;ber HTML-Formulare versendet werden. F&uuml;hre den Assitenten nur auf Deinem eigenen PC aus (nicht auf einem &ouml;ffentlichen Rechner wie beispielsweise in einem Internet-Caf&eacute;), und l&ouml;sche danach auf jeden Fall Deinen Browser-Cahce und Deine tempor&auml;ren Internet-Dateien, sonst haben andere vielleicht Zugriff zu diesen Daten!',
  'back' => 'zur&uuml;ck',
  'next' => 'weiter',
  'start_wizard' => 'Starte den Bridge-Assistenten',
  'finish' => 'Fertigstellen',
  'hide_unused_fields' => 'unbenutze Formular-Felder verbergen (empfohlen)',
  'clear_unused_db_fields' => 'ung&uuml;ltige Datenbank-Eintr&auml;ge l&ouml;schen (empfohlen)',
  ...
  'reset_to_default' => 'Auf Standard-Wert zur&uuml;cksetzen',
  'choose_bbs_app' => 'W&auml;hle eine Anwendung, mit der Du &quot;bridgen&quot; willst',
  'support_url' => 'F&uuml;r Support zu dieser Anwendung klicke hier',
  ...
  'db_username_explanation' => 'mySQL Benutzer-Konto f&uuml;r die Verbindung mit Deinem Forum',
  'db_password' => 'Datenbank-Passwort',
  'db_password_explanation' => 'Passwort f&uuml;r Die mySQL-Datenbank Deines Forums',
  'full_forum_url' => 'Forums-URL',
  'full_forum_url_explanation' => 'Vollst&auml;ndige Internet-Adresse Deines Forums (einschlie&szlig;lich http:// , z.B. http://www.yourdomain.tld/forum)',
  ...
  'table_prefix_explanation' => 'Die Vorsible (Pr&auml;fix) der Tabellen Deines Forums, die Du bei der Einrichtung Deines Forums festgelegt hast.',
  ...
  'group_mapping_table' => 'Gruppen-Verkn&uuml;pfungs-Tabelle',
  ...
  'validating_group' => 'Best&auml;tigungs-Gruppe',
  'validating_group_explanation' => 'Die ID der Gruppe Deines Forums f&uuml;r Benutzer, deren Konto noch &uuml;berpr&uuml;ft werden muss (normalerweise sind die vorgeschlagenen Standard-Werte OK, wenn Du keine Sondereinstellungen in Deinem Forum vorgenommen hast)',
  'guest_group' => 'G&auml;ste-Gruppe',
  'guest_group_explanation' => 'Die ID der Gruppe Deines Forums f&uuml;r G&auml;ste / anonyme Benutzer (normalerweise sind die vorgeschlagenen Standard-Werte OK, wenn Du keine Sondereinstellungen in Deinem Forum vorgenommen hast)',
  'member_group' => 'Mitglieder-Gruppe',
  'member_group_explanation' => 'Die ID der Gruppe Deines Forums f&uuml;r normale (regul&auml;re) Benutzer (normalerweise sind die vorgeschlagenen Standard-Werte OK, &auml;ndere den Wert nur, wenn Du wirklich weisst, was Du tust)',
  'admin_group' => 'Admin-Gruppe',
  'admin_group_explanation' => 'Die ID der Gruppe Deines Forums f&uuml;r Admins (normalerweise sind die vorgeschlagenen Standard-Werte OK, &auml;ndere den Wert nur, wenn Du wirklich weisst, was Du tust)',
  'banned_group' => 'Gebannte Gruppe',
  'banned_group_explanation' => 'Die ID der Gruppe Deines Forums f&uuml;r verbannte Benutzer (normalerweise sind die vorgeschlagenen Standard-Werte OK, &auml;ndere den Wert nur, wenn Du wirklich weisst, was Du tust)',
  'global_moderators_group' => 'Globale Moderatoren Gruppe',
  'global_moderators_group_explanation' => 'Die ID der Gruppe Deines Forums f&uuml;r globale Moderatoren (normalerweise sind die vorgeschlagenen Standard-Werte OK, &auml;ndere den Wert nur, wenn Du wirklich weisst, was Du tust)',
  ...
  'use_post_based_groups_explanation' => 'Sollen die Beitrags-basierten Benutzergruppen ber&uuml;cksichtigt werden (erm&ouml;glicht eine feinere Rechte-Vergabe) oder nur die Standard-Gruppen (einfachere Administration, empfohlen). Du kannst diese Einstellung auch noch sp&auml;ter &auml;ndern.',
  ...
  'error_bridge_file_not_exist' => 'Die Bridge-datei %s existiert nicht auf dem Server. &Uuml;berpr&uuml;fe die Schreibweise und ob Du sie tats&auml;chlich hochgeladen hast.',
  'finalize' => 'Forums-Integration aktivieren/deaktivieren',
  'finalize_explanation' => 'Bisher wurden Deine Einstellungen in die Datenbank geschrieben, aber die Forums-Integration (Bridging) wurde noch nicht aktiviert. Du kannst die Integration jederzeit sp&auml;ter an- oder abschalten. Merke Dir auf jeden Fall den Benutzernamen und das Passwort Deines Admin-Kontos (Coppermine ohne Bridging), da Du es sp&auml;ter evtl. brauchst, um die Einstellungen zu &auml;ndern. Wenn etwas schief l&auml;uft, gehe zu %s und deaktiveire das Bridging dort (verwende dazu Dein Coppermine-Admin-Konto, das Du beim Installieren von Coppermine benutzt hast).',
  ...
  'error_folder_not_exist' => '%s existiert nicht. Korrigiere den Wert, den Du f&uuml;r %s eingegeben hast',
  'error_cookie_not_readible' => 'Coppermine kann den Cookie namens %s nicht lesen. Korrigiere den Wert, den Du f&uuml;r %s eingegeben hast, oder gehe zum Administrationsbereich Deines Forums und stelle dort sicher, dass der Cookie f&uuml;r Coppermine lesbar ist.',
  'error_mandatory_field_empty' => 'Das Feld %s darf nicht leer bleiben - gib den entsprechenden Wert ein.',
  'error_no_trailing_slash' => 'Im Feld %s darf kein abschlie&szlig;ender Schr&auml;gstrich (Slash) vorhanden sein.',
  'error_trailing_slash' => 'Im Feld %s muss ein abschlie&szlig;ender Schr&auml;gstrich (Slash) vorhanden sein.',
  'error_db_connect' => 'Konnte mit den eingegebenen Daten keine mySQL-Verbindung aufbauen. Hier ist die mySQL-Fehlermeldung:',
  'error_db_name' => 'Obwohl Coppermine eine Verbindung aufbauen konnte, wurde die datenbank %s nicht gefunden. &Uuml;berpr&uuml;fe Deine Einstellungen f&uuml;r %s. Hier ist die mySQL-Fehlermeldung:',
  'error_prefix_and_table' => '%s und ',
  'error_db_table' => 'Konnte die Tabelle %s nicht finden. &Uuml;berpr&uuml;fe Deine Einstellungen f&uuml;r %s.',
  ...
  'recovery_success_content' => 'Du hast die Forums-Integration erfolgreich deaktiviert. Deine Coppermine-Galerie l&auml;uft jetzt im &quot;Standalone-Modus&quot; (ohne Integration/Bridging).',
  ...
  'recovery_wait_content' => 'Aus Sicherheitsgr&uuml;nden erlaubt das Skript keine fehlgeschlagenen Anmeldeversuche in kurzer Reihenfolge - deshalb musst Du ein bi&szlig;chen warten, bevor Du wieder einen Anmelde-Versuch unternehmen darfst.',
  'wait' => 'warte',
  'create_redir_file' => 'Umleitungs-Datei anlegen (empfohlen)',
  'create_redir_file_explanation' => 'Um Benutzer nach der Anmeldung im Forum wieder zu Coppermine umzuleiten brauchst Du eine Umleitungs-Datei in Deinem Forums-Verzeichnis. Wenn diese Option aktiviert ist wird der Bridge-Assistent versuchen, diese datei f&uuml;r Dich anzulegen, oder Dir den Code den Code f&uuml;r das manuelle Anlegen der Datei per markieren und kopieren zu erzeugen.',
  'browse' => 'durchsuchen',
);
...
if (defined('CALENDAR_PHP')) $lang_calendar_php = array(
  ...
  'clear_date' => 'Datum l&ouml;schen', //cpg1.4
);
...
if (defined('CATMGR_PHP')) $lang_catmgr_php = array(
  ...
  'confirm_delete' => 'Willst Du diese Kategorie wirklich L&Ouml;SCHEN', //js-alert
  'category' => 'Kategorie',
...
if (defined('ADMIN_PHP')) $lang_admin_php = array(
  ...
  'notice1' => '(*) Diese Einstellungen d&uuml;rfen nicht mehr ver&auml;ndert werden, wenn bereits Dateien in der Datenbank vorhanden sind.', //cpg1.4 - (relocated)
  'notice2' => '(**) Bei &Auml;nderung dieser Einstellung werden die ge&auml;nderten Werte nur f&uuml;r Dateien herangezogen, die ab dem Zeitpunkt der &Auml;nderung hinzugef&uuml;gt werden - daher ist es ratsam, hier nichts zu &auml;ndern, wenn bereits Bilder in der Galerie vorhanden sind. Die ge&auml;nderten Einstellungen k&ouml;nnen jedoch auch auf &auml;ltere Dateien angewendet werden durch Verwendung der &quot;<a href="util.php">Admin-Werkzeuge</a> (Thumbnails und/oder Bilder in Zwischengr&ouml;sse aktualisieren)&quot; aus dem Admin-Men&uuml;.', //cpg1.4 - (relocated)
...
if (defined('ADMIN_PHP')) $lang_admin_data = array(
  ...
  array('Verschl&uuml;sselte Passw&ouml;rter aktivieren (kann nicht r&uuml;ckg&auml;ngig gemacht werden)','enable_encrypted_passwords',1, 'f=index.htm&amp;as=admin_general_encrypt_password_start&amp;ae=admin_general_encrypt_password_end&amp;top=1'), // cpg 1.4
  array('Hilfe-Icons aktivieren (Hilfe nur in Englisch verf&uuml;gbar)','enable_help',9, 'f=index.htm&amp;as=admin_general_help&amp;ae=admin_general_help_end'), //cpg1.4
  array('Anklickbare Stichw&ouml;rter in Suche aktivieren','clickable_keyword_search',14, 'f=index.htm&amp;as=admin_general_keywords_start&amp;ae=admin_general_keywords_end'), //cpg1.4
  ...
  array('Baumstruktur f&uuml;r Batch-hinzuf&uuml;gen aktivieren', 'browse_batch_add', 1, 'f=index.htm&amp;as=admin_general_browsable_batch_add&amp;ae=admin_general_browsable_batch_add_end'), //cpg1.4
  ...
  array('Auf Englisch zur&uuml;ckgreifen, wenn Deutsche &Uuml;bersetzung nicht verf&uuml;gbar?', 'language_fallback', 1, 'f=index.htm&amp;as=admin_language_fallback&amp;ae=admin_language_fallback_end'), //cpg1.4
  ...
  //array('zur&uuml;ck/vorw&auml;rts in Tabs anzeigen', 'previous_next_tab', 1), //cpg1.4
  ...
  array('Name eines benutzerdefinierten Men&uuml;-Eintrags', 'custom_lnk_name', 0,'f=index.htm&amp;as=admin_theme_custom_lnk_name&amp;ae=admin_theme_custom_lnk_name_end'), //cpg1.4
  array('URL eines benutzerdefinierten Men&uuml;-Eintrags', 'custom_lnk_url', 0,'f=index.htm&amp;as=admin_language_custom_lnk_url&amp;ae=admin_language_custom_lnk_url_end'), //cpg1.4
  ...
  array('Thumbnail-Gr&ouml;&szlig;e in Pixeln', 'alb_list_thumb_size', 0, 'f=index.htm&amp;as=admin_album_thumbnail-size&amp;ae=admin_album_thumbnail-size_end'), //cpg1.4
  ...
  array('Datei-Beschriftung anzeigen (zus&auml;tzlich zum Datei-Titel) unterhalb der Thumbnails', 'caption_in_thumbview', 1, 'f=index.htm&amp;as=admin_thumbnail_display_caption&amp;ae=admin_thumbnail_display_caption_end'), //cpg1.4
  ...
  array('Standard-Sortierung f&uuml;r Dateien', 'default_sort_order', 3, 'f=index.htm&amp;as=admin_thumbnail_default_sortorder&amp;ae=admin_thumbnail_default_sortorder_end'), //cpg1.4
  array('Mindestmenge Stimmen, die eine Datei ben&ouml;tigt, um in der \'am besten bewertet\'-Liste zu erscheinen', 'min_votes_for_rating', 0, 'f=index.htm&amp;as=admin_thumbnail_minimum_votes&amp;ae=admin_thumbnail_minimum_votes_end'), //cpg1.4

  'Ansicht Bild', //cpg1.4
  array('Tabellenbreite f&uuml;r Bildanzeige (in Pixel oder %)', 'picture_table_width', 0, 'f=index.htm&amp;as=admin_image_comment_table-width&amp;ae=admin_image_comment_table-width_end'), //cpg1.4
  array('Datei-Informationen sind standardm&auml;&szlig;ig sichtbar', 'display_pic_info', 1, 'f=index.htm&amp;as=admin_image_comment_info_visible&amp;ae=admin_image_comment_info_visible_end'), //cpg1.4
  array('Maximall&auml;nge f&uuml;r Dateibeschreibung', 'max_img_desc_length', 0, 'f=index.htm&amp;as=admin_image_comment_descr_length&amp;ae=admin_image_comment_descr_length_end'), //cpg1.4
  ...
  array('Schimpfw&ouml;rter in Kommentaren zensieren', 'filter_bad_words', 1, 'f=index.htm&amp;as=admin_image_comment_bad_words&amp;ae=admin_image_comment_bad_words_end'), //cpg1.4
  ...
  array('Aufeinanderfolgende Kommentare eines Benutzers zu einer Datei zulassen (&Uuml;berflutungs-Schutz abschalten)', 'disable_comment_flood_protect', 1, 'f=index.htm&amp;as=admin_image_comment_flood&amp;ae=admin_image_comment_flood_end'), //cpg1.4
  ...
  array('Maximale L&auml;nge eines Kommentars', 'max_com_size', 0, 'f=index.htm&amp;as=admin_image_comment_length&amp;ae=admin_image_comment_length_end'), //cpg1.4
  array('Admin &uuml;ber abgegebene Kommentare per eMail benachrichtigen', 'email_comment_notification', 1, 'f=index.htm&amp;as=admin_image_comment_admin_notify&amp;ae=admin_image_comment_admin_notify_end'), //cpg1.4
  ...
  array('Vorsilbe f&uuml;r anonyme Kommentatoren', 'comments_anon_pfx', 0, 'f=index.htm&amp;as=comments_anon_pfx&amp;ae=comments_anon_pfx_end'), //cpg1.4

  'Bild/Datei- und Thumbnail-Einstellungen',
  array('Qualit&auml;t f&uuml;r JPEG-Dateien', 'jpeg_qual', 0, 'f=index.htm&amp;as=admin_picture_thumbnail_jpeg_quality&amp;ae=admin_picture_thumbnail_jpeg_quality_end'), //cpg1.4
  array('Maximalgr&ouml;&szlig;e Thumbnail<a href="#notice2" class="clickable_option">**</a>', 'thumb_width', 0, 'f=index.htm&amp;as=admin_picture_thumbnail_max-dimension&amp;ae=admin_picture_thumbnail_max-dimension_end'), //cpg1.4
  array('Welche Dimension soll genutzt werden f&uuml;r Thumbnails ( Breite oder H&ouml;he oder das, was jeweils gr&ouml;&szlig;er ist)<a href="#notice1" class="clickable_option">**</a>', 'thumb_use', 7, 'f=index.htm&amp;as=admin_picture_thumbnail_use-dimension&amp;ae=admin_picture_thumbnail_use-dimension_end'), //cpg1.4
  array('Bilder in Zwischengr&ouml;&szlig;e erzeugen','make_intermediate',1, 'f=index.htm&amp;as=admin_picture_thumbnail_intermediate_toggle&amp;ae=admin_picture_thumbnail_intermediate_toggle_end'), //cpg1.4
  array('Maximale Breite oder H&ouml;he von Bildern/Videos in Zwischengr&ouml;&szlig;e <a href="#notice2" class="clickable_option">**</a>', 'picture_width', 0, 'f=index.htm&amp;as=admin_picture_thumbnail_intermediate_dimension&amp;ae=admin_picture_thumbnail_intermediate_dimension_end'), //cpg1.4
  array('Maximalgr&ouml;&szlig;e f&uuml;r das Hochladen von Dateien (kB)', 'max_upl_size', 0, 'f=index.htm&amp;as=admin_picture_thumbnail_max_upload_size&amp;ae=admin_picture_thumbnail_max_upload_size_end'), //cpg1.4
  array('Maximale Breite oder H&ouml;he f&uuml;r das Hochladen von Bildern/Videos (in Pixel)', 'max_upl_width_height', 0, 'f=index.htm&amp;as=admin_picture_thumbnail_max_upload_dimension&amp;ae=admin_picture_thumbnail_max_upload_dimension_end'), //cpg1.4
  array('Automatische verkleinerung von Bildern, die die Maximalgr&ouml;&szlig;e &uuml;berschreiten', 'auto_resize', 16, 'f=index.htm&amp;as=admin_picture_thumbnail_auto-resize&amp;ae=admin_picture_thumbnail_auto-resize_end'), //cpg1.4

  'Erweiterte Bild/Datei- und Thumbnail-Einstellungen',
  array('Alben k&ouml;nnen nicht-&ouml;ffentlich sein (Anmerkung: beim Umschalten von \'ja\' auf \'nein\' werden <i>alle</i> nicht-&ouml;ffentlichen Alben &ouml;ffentlich)', 'allow_private_albums', 1, 'f=index.htm&amp;as=admin_picture_thumb_advanced_private_toggle&amp;ae=admin_picture_thumb_advanced_private_toggle_end'), //cpg1.4
  array('Icons f&uuml;r Pers&ouml;nliche Alben nicht-eingeloggten Benutzern anzeigen?','show_private',1, 'f=index.htm&amp;as=admin_picture_thumb_advanced_private_icon_show&amp;ae=admin_picture_thumb_advanced_private_icon_show_end'), //cpg1.4
  ...
  //array('erlaubte Datei-Erweiterungen f&uuml;r das Hochladen von Bildern', 'allowed_file_extensions',0, 'f=index.htm&amp;as=&amp;ae=_end'), //cpg1.4
  ...
  array('Autostart f&uuml;r Filme', 'media_autostart',1, 'f=index.htm&amp;as=admin_movie_autoplay&amp;ae=admin_movie_autoplay_end'), //cpg1.4
  ...
  array('Methode zur Gr&ouml;&szlig;en&auml;nderung von Bildern','thumb_method',2, 'f=index.htm&amp;as=admin_picture_thumb_advanced_resize_method&amp;ae=admin_picture_thumb_advanced_resize_method_end'), //cpg1.4
  ...
  //array('Erlaubte Datei-Typen (nur g&uuml;ltig f&uuml;r ImageMagick)', 'allowed_img_types',0, 'f=index.htm&amp;as=admin_picture_thumb_advanced_allowed_imagetypes&amp;ae=admin_picture_thumb_advanced_allowed_imagetypes_end'), //cpg1.4
  array('Kommandozeilen-Parameter f&uuml;r ImageMagick', 'im_options', 0, 'f=index.htm&amp;as=admin_picture_thumb_advanced_im_commandline&amp;ae=admin_picture_thumb_advanced_im_commandline_end'), //cpg1.4
  ...
  array('Verzeichnis f&uuml;r Benutzer-Dateien <a href="#notice1" class="clickable_option">*</a>', 'userpics', 0, 'f=index.htm&amp;as=admin_picture_thumb_advanced_userpics_dir&amp;ae=admin_picture_thumb_advanced_userpics_dir_end'), //cpg1.4
  array('Vorsilbe f&uuml;r Bilder in Zwischengr&ouml;&szlig;e <a href="#notice1" class="clickable_option">*</a>', 'normal_pfx', 0, 'f=index.htm&amp;as=admin_picture_thumb_advanced_intermediate_prefix&amp;ae=admin_picture_thumb_advanced_intermediate_prefix_end'), //cpg1.4
  array('Vorsilbe f&uuml;r Thumbnails <a href="#notice1" class="clickable_option">*</a>', 'thumb_pfx', 0, 'f=index.htm&amp;as=admin_picture_thumb_advanced_thumbs_prefix&amp;ae=admin_picture_thumb_advanced_thumbs_prefix_end'), //cpg1.4
  array('Standard-Modus f&uuml;r Verzeichnisse', 'default_dir_mode', 0, 'f=index.htm&amp;as=admin_picture_thumb_advanced_chmod_folder&amp;ae=admin_picture_thumb_advanced_chmod_folder_end'), //cpg1.4
  array('Standard-Modus f&uuml;r Dateien', 'default_file_mode', 0, 'f=index.htm&amp;as=admin_picture_thumb_advanced_chmod_files&amp;ae=admin_picture_thumb_advanced_chmod_files_end'), //cpg1.4
  ...
  array('Nicht-angemeldeten Besuchern (G&auml;ste) Zugriff erlauben', 'allow_unlogged_access', 1, 'f=index.htm&amp;as=admin_allow_unlogged_access&amp;ae=admin_allow_unlogged_access_end'), //cpg1.4
  array('Registrierung von Benutzern erfordert &Uuml;berpr&uuml;fung per eMail', 'reg_requires_valid_email', 1, 'f=index.htm&amp;as=admin_registration_verify&amp;ae=admin_registration_verify_end'), //cpg1.4
  array('Admin &uuml;ber neu-registrierten Benutzer per eMail benachrichtigen', 'reg_notify_admin_email', 1, 'f=index.htm&amp;as=admin_registration_notify&amp;ae=admin_registration_notify_end'), //cpg1.4
  ...
  array('Admin &uuml;ber genehmigungspflichtige Benutzer-Uploads per eMail benachrichtigen', 'upl_notify_admin_email', 1, 'f=index.htm&amp;as=admin_approval_notify&amp;ae=admin_approval_notify_end'), //cpg1.4
  ...
  array('Benutzern erlauben, Ihre eMail-Adresse im Profil zu &auml;ndern', 'allow_email_change', 1, 'f=index.htm&amp;as=admin_user_allow_email_change&amp;ae=admin_user_allow_email_change_end'), //cpg1.4
  array('Benutzern bleiben Eigent&uuml;mer von Bildern, die sie in &ouml;ffentliche Alben hochgeladen haben (sie k&ouml;nnen diese dann &auml;ndern, beschriften und l&ouml;schen', 'users_can_edit_pics', 1, 'f=index.htm&amp;as=admin_user_editpics_public_start&amp;ae=admin_user_editpics_public_end'), //cpg1.4
...
// custom profile fields,  //cpg1.4
  'Benutzerdefinierte Felder f&uuml;r Benutzerprofile (leer lassen, falls ungenutzt).
  Benutze Profilfeld 6 f&uuml;r Langeintr&auml;ge (wie Biographien).', //cpg1.4
  ...
  'Benutzerdefinierte Felder f&uuml;r zus&auml;tzliche Dateiinformationen (leer lassen, falls nicht ben&ouml;tigt)',
  ...
  array('eCards aufzeichnen (Logging)<br />(Anmerkung: das Aufzeichnen von Benutzer-Daten kann Datenschutz-rechtliche Konsequenzen haben. Der Benutzer sollte &uuml;ber die Tatsache, dass die eCards gelogged werden, informiert werden und sein Einverst&auml;ndnis gegeben haben, z.B. bei der Registrierung. Details, wie eine Datenschutz-Policy, die den Schutz der Privatsph&auml;re regelt, sollten separat auf der Seite verf&uuml;gbar sein.)', 'log_ecards', 1, 'f=index.htm&amp;as=admin_general_log_ecards&amp;ae=admin_general_log_ecards_end'), //cpg1.4
  ...
  array('Detailierte Treffer-Statistiken aufzeichnen (Besucherz&auml;hler)','hit_details',1, 'f=index.htm&amp;as=admin_logging_hitdetails&amp;ae=admin_logging_hitdetails_end'), //cpg1.4
...
if (defined('DB_ECARD_PHP')) $lang_db_ecard_php = array(
  ...
  'ecard_recipient' => 'Empf&auml;nger',
  'ecard_date' => 'Datum',
  ...
  'ecard_by_recipient_name' => 'nach Empf&auml;nger-Name',
  'ecard_by_recipient_email' => 'nach eMail-Adresse des Empf&auml;ngers',
  'ecard_number' => 'zeige Eintrag %s bis %s von %s',
  'ecard_goto_page' => 'gehe zu Seite',
  'ecard_records_per_page' => 'Eintr&auml;ge pro Seite',
  'check_all' => 'alle markieren',
  'uncheck_all' => 'alle Markierungen entfernen',
  'ecards_delete_selected' => 'Gew&auml;hlte eCard-Eintr&auml;ge l&ouml;schen',
  'ecards_delete_confirm' => 'Alle Eintr&auml;ge l&ouml;schen? Entsprechendes Feld ankreuzen!',
  'ecards_delete_sure' => 'wirklich l&ouml;schen',
);
...
if (defined('DB_INPUT_PHP')) $lang_db_input_php = array(
  ...
  'unknown_album' => 'Das gew&auml;hlte Album existiert nicht oder Du hast keine Berechtigung, Dateien in dieses Album hochzuladen',
  'no_pic_uploaded' => 'Es wurde keine Datei hochgeladen!<br /><br />Wenn Du tats&auml;chlich eine Datei zum Hochladen selektiert hast, &uuml;berpr&uuml;fe, ob Dein Server das Hochladen von Dateien zul&auml;sst...',
  ...
  'err_fsize_too_large' => 'Die Datei, die Du hochgeladen hast, ist zu gro&szlig; (maximal zul&auml;ssig ist %s x %s) !', //obsolete since cpg1.3 - consider removal in cpg1.4 once upload.php has been overhauled
  'err_imgsize_too_large' => 'Die Datei, die Du hochgeladen hast, ist zu gro&szlig; (maximal zul&auml;ssig ist %s kB) !', //obsolete since cpg1.3 - consider removal in cpg1.4 once upload.php has been overhauled
  ...
  'upload_success' => 'Deine Datei wurde erfolgreich hochgeladen.<br /><br />Es wird nach der Best&auml;tigung durch den Admin sichtbar sein.',
  'notify_admin_email_subject' => '%s - Upload-Benachrichtigung',
  'notify_admin_email_body' => '%s hat eine Datei hochgeladen, die best&auml;tigt werden muss. Gehe zu %s',
  'info' => 'Information',
  ...
  'no_flood' => 'Leider bist Du schon der Autor des letzten Kommentars zu dieser Datei<br /><br />Bearbeite Deinen bestehenden Kommentar, wenn Du ihn ver&auml;ndern willst',
  'redirect_msg' => 'Du wirst weitergeleitet.<br /><br /><br />Klicke \'weiter\', falls sich die Seite nicht automatisch aktualisiert',
  'upl_success' => 'Deine Datei wurde erfolgreich hinzugef&uuml;gt',
  ...
  'album_not_selected' => 'Kein Album ausgew&auml;hlt', //cpg1.4
...
if (defined('DELETE_PHP')) $lang_delete_php = array(
  ...
  'ns_pic' => 'normal-gro&szlig;es Bild',
  'err_del' => 'kann nicht gel&ouml;scht werden',
  'thumb_pic' => 'Thumbnail',
  'comment' => 'Kommentar',
  'im_in_alb' => 'Bild in Album',
  'alb_del_success' => 'Album &laquo;%s&raquo; gel&ouml;scht', //cpg1.4
  ...
  'anonymized_uploads' => '%s &ouml;ffentliche Upload(s) anonymisiert', //cpg1.4
  'deleted_comments' => '%s Kommentar(e) gel&ouml;scht', //cpg1.4
  'deleted_uploads' => '%s &ouml;ffentliche Upload(s) gel&ouml;scht', //cpg1.4
  'user_deleted' => 'Benutzer %s gel&ouml;scht', //cpg1.4
  ...
  'reset_password' => 'Passwort zur&uuml;cksetzen', //cpg1.4
  'password_reset' => 'Passwort zur&uuml;ckgesetzt auf %s', //cpg1.4
  'change_group' => 'Prim&auml;re Gruppe &auml;ndern', //cpg1.4
  'change_group_to_group' => '&Auml;ndere von %s zu %s', //cpg1.4
  'add_group' => 'Sekund&auml;re Gruppe hinzuf&uuml;gen', //cpg1.4
  'add_group_to_group' => 'F&uuml;ge Benutzer %s zu Gruppe %s hinzu. Er ist nun Mitglied von %s als prim&auml;re Gruppe und von %s als sekund&auml;re Mitgliedergruppe(n).', //cpg1.4
...
$lang_displayecard_php = array(
  'invalid_data' => 'Die Daten f&uuml;r die gew&uuml;nschte eCard wurden von Deinem eMail-Client korrumpiert. &Uuml;berpr&uuml;fe den Link auf Vollst&auml;ndigkeit.', //cpg1.4
);
}
...
$lang_display_image_php = array(
  'confirm_del' => 'Diese Datei wirklich L&Ouml;SCHEN? \\nKommentare werden ebenfalls gel&ouml;scht.',
  'del_pic' => 'Diese Datei l&ouml;schen',
  'size' => '%s x %s Pixel',
  'views' => '%s mal',
  'slideshow' => 'Diashow',
  'stop_slideshow' => 'Diashow anhalten',
  'view_fs' => 'Klicken f&uuml;r Bild in voller Gr&ouml;&szlig;e',
  'edit_pic' => 'Datei-Information bearbeiten', //cpg1.4
  'crop_pic' => 'Zuschneiden und drehen',
  'set_player' => 'Player &auml;ndern',
);
...
$lang_picinfo = array(
  ...
  'Date Added' => 'Hinzugef&uuml;gt am', //cpg1.4
  'Dimensions' => 'Abmessungen',
  'Displayed' => 'Angezeigt',
  'URL' => 'URL', //cpg1.4
  ...
  'xResolution' => 'x-Aufl&ouml;sung', //cpg1.4
  'yResolution' => 'y-Aufl&ouml;sung', //cpg1.4
  'ResolutionUnit' => 'Aufl&ouml;sungs-Einheit', //cpg1.4
  ...
  'Quality' => 'Qualit&auml;t', //cpg1.4
  'ImageSharpening' => 'Bildsch&auml;rfung', //cpg1.4
  ...
  'Saturation' => 'S&auml;ttigung', //cpg1.4
  'NoiseReduction' => 'Rauschunterdr&uuml;ckung', //cpg1.4
  'FlashPixVersion' => 'Flash Pix Version', //cpg1.4
  'ExifImageWidth' => 'Exif Bildbreite', //cpg1.4
  'ExifImageHeight' => 'Exif Bildh&ouml;he', //cpg1.4
  'ExifInteroperabilityOffset' => 'Exif Zusammenarbeitsf&auml;higkeit Offset', //cpg1.4
  ...
  'WhiteBalance' => 'Wei&szlig;abgleich', //cpg1.4
  'DigitalZoomRatio' => 'Verh&auml;ltnis Digitalzoom', //cpg1.4
  'SceneCaptureMode' => 'Scene Capture Modus', //cpg1.4
  'GainControl' => 'Verst&auml;rkerregelung', //cpg1.4
  'Contrast' => 'Kontrast', //cpg1.4
  'Saturation' => 'S&auml;ttigung', //cpg1.4
  'Sharpness' => 'Sch&auml;rfe', //cpg1.4
...
$lang_display_comments = array(
  ...
  'confirm_delete' => 'Willst Du diesen Kommentar wirklich l&ouml;schen?', //js-alert
...
$lang_fullsize_popup = array(
  'click_to_close' => 'Bild anklicken, um das Fenster zu schlie&szlig;en!',
);
...
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php =array(
  'title' => 'eCard senden',
  'invalid_email' => '<b>Achtung</b> : ung&uuml;ltige eMail-Adresse !',
  'ecard_title' => 'Eine eCard von %s f&uuml;r Dich',
  'error_not_image' => 'Nur Bilder k&ouml;nnen als eCard verschickt werden.', //cpg1.3.0
  'view_ecard' => 'Falls diese eCard nicht korrekt angezeigt wird, klicke auf den folgenden Link: ',
  'view_ecard_plaintext' => 'Markiere die folgende URL und f&uuml;ge sie in die Adresszeile Deines Browsers ein, um diese eCard anzuzeigen:', //cpg1.4
  'view_more_pics' => 'Klicke auf diesen Link, um mehr Bilder ansehen zu k&ouml;nnen!', //cpg1.4
  ...
  'rcpt_email' => 'Empf&auml;nger eMail-Adresse',
  'greetings' => '&Uuml;berschrift', //cpg1.4
  ...
  'preview_view_ecard' => 'Dies wird der Alternatgiv-Link zur eCard sein, sobald sie tats&auml;chlich eerstellt wurde - funktioniert nicht f&uuml;r die Vorschau.', //cpg1.4
);
...
if (defined('REPORT_FILE_PHP') || defined('DISPLAYREPORT_PHP')) $lang_report_php =array(
  ...
  'invalid_email' => '<b>Achtung</b> : ung&uuml;ltige eMail-Adresse!', //cpg1.4
  'report_subject' => 'Eine Meldung von %s &uuml;ber die Galerie %s', //cpg1.4
  ...
  'comment_field_name' => 'Meldung bez&uuml;glich Kommentar von "%s"', //cpg1.4
  'reason' => 'Grund', //cpg1.4
  'message' => 'Nachricht', //cpg1.4
  'report_footer' => 'Gesendet durch %s von IP-Adresse %s um %s (Zeitzone der Galerie)', //cpg1.4
  'obscene' => 'unanst&auml;ndig ', //cpg1.4
  ...
  'reasons_list_heading' => 'Grund/Gr&uuml;nde f&uuml;r Meldung:', //cpg1.4
  'no_reason_given' => 'es wurde kein Grund angegeben', //cpg1.4
  'go_comment' => 'Gehe zu Kommentar', //cpg1.4
  'view_comment' => 'Vollst&auml;ndige Meldung mit Kommentar anzeigen', //cpg1.4
...
if (defined('EDITPICS_PHP')) $lang_editpics_php = array(
  ...
  'del_pic' => 'Datei l&ouml;schen',
  'del_all' => 'ALLE Dateien l&ouml;schen', //cpg1.4
  'read_exif' => 'EXIF-Daten erneut einlesen',
  'reset_view_count' => 'Z&auml;hler \'x mal angesehen\' auf Null setzen',
  'reset_all_view_count' => 'ALLE Z&auml;hler \'x mal angesehen\' auf Null setzen', //cpg1.4
  ...
  'del_all_comm' => 'ALLE Kommentare l&ouml;schen', //cpg1.4
  'upl_approval' => 'Genehmigung zum Hochladen', //cpg1.4
  'edit_pics' => 'Dateien bearbeiten',
  'see_next' => 'n&auml;chste Dateien ansehen',
  ...
  'sel_on_img' =>'Die Auswahl muss vollst&auml;ndig innerhalb des Bildes liegen!', //js-alert
...
if (defined('FAQ_PHP')) $lang_faq_php = array(
  'faq' => 'H&auml;ufig gestellte Fragen (Frequently Asked Questions)',
  'toc' => 'Inhalt',
  'question' => 'Frage: ',
  'answer' => 'Antwort: ',
);
...
if (defined('FAQ_PHP')) $lang_faq_data = array(
  'Allgemeines',
  array('Warum muss ich mich registrieren?', 'Der Administrator kann verlangen, dass Du Dich registrierst (oder auch nicht). Durch die Registrierung erh&auml;lst Du m&ouml;glicherweise einige zus&auml;tzliche Features, wie z.B. Dateien hochladen, eine Favoriten-Liste, Bewertung von Bildern, Abgabe von Kommentaren etc. ', 'allow_user_registration', '0'),
  array('Wie kann ich mich registrieren?', 'Klicke auf &quot;Registrieren&quot; und f&uuml;lle die notwendigen Felder aus (und die optionalen, wenn Du m&ouml;chtest).<br />Wenn der Administrator eMail-Aktivierung eingeschaltet hat, bekommst Du eine eMail an die Adresse, die Du bei der Registrierung angegeben hast, in der Anweisungen enthalten sind, wie Du Dein Benutzerkonto aktivieren kannst. In diesem Fall muss Dein Konto aktiviert werden, bevor Du Dich anmelden kannst.', 'allow_user_registration', '1'),
  array('Wie kann ich mich anmelden?', 'Klicke auf &quot;Anmelden&quot;, gib Deinen Benutzernamen und Dein Passwort ein, und kreuze die Option &quot;Immer angemeldet bleiben&quot; an, damit Du Dich nicht bei Deinem n&auml;chsten Besuch auf der Seite erneut anmelden musst.<br /><b>WICHTIG: Um Dich anzumelden, musst Du Cookies in Deinem Browser zulassen, und das Cookie darf nicht gel&ouml;scht werden, wenn Du die Option &quot;Immer angemeldet bleiben&quot; nutzen willst.</b>', 'offline', 0),
  array('Warum kann ich mich nicht anmelden?', 'Hast Du Dich registriert und die Anweisungen ausgef&uuml;hrt, die in der Aktivierungsmail an Dich gesendet wurden?. Der Link in der Aktivierungsmail schaltet Dein Benutzerkonto frei. Bez&uuml;glich anderer Probleme beim anmelden, wende Dich an den Admin dieser Seite.', 'offline', 0),
  ...
  //array('Meine eMail-Adresse hat sich ge&auml;ndert. Was tun?', 'Melde Dich an und &auml;ndere Deine eMail-Adresse im Men&uuml;punkt &quot; mein Profil&quot;', 'offline', 0),
  array('Wie speichere ich eine Datei in &quot;meine Favoriten&quot;?', 'Klicke auf &quot;Datei-Info&quot; (<img src="images/info.gif" width="16" height="16" border="0" alt="Bild-Info" />); gehe ganz nach unten auf der Seite und klicke auf &quot;Zu Favoriten hinzuf&uuml;gen&quot;.<br />M&ouml;glicherweise ist die Anzeige des Datei-Info Bereichs auch standardm&auml;&szlig;ig eingeschaltet.<br />Wichtig: Cookies m&uuml;ssen aktiviert sein und Du darfst den Cookie nicht l&ouml;schen (im Cookie werden die Favoriten gespeichert).', 'offline', 0),
  array('Wie kann ich eine Datei bewerten?', 'Klicke auf das Thumbnail (kleine Vorschaugrafik) einer Datei und w&auml;hle eine Bewertung (angezeigt unterhalb des Bildes).', 'offline', 0),
  array('Wie kann ich einen Kommentar abgeben?', 'Klicke auf das Thumbnail (kleine Vorschaugrafik) einer Datei, gehe nach unten auf der Seite und gib Deinen Kommentar ein. Wenn keine Eingabe eines Kommentars m&ouml;glich ist, musst Du Dich eventuell erst registrieren und anmelden, damit diese Option zur Verf&uuml;gung steht.', 'offline', 0),
  array('Wie kann ich eine Datei hochladen?', 'Klicke auf &quot;Datei hochladen&quot; und w&auml;hle das Album aus, in das Du die Datei hochladen willst, klicke auf &quot;Durchsuchen&quot; und w&auml;hle die Datei aus, die Du hochladen willst und klicke dann auf &quot;&ouml;ffnen&quot; (f&uuml;ge einen Titel, eine Beschriftung und ein paar Stichworte ein, wenn Du m&ouml;chtest). Um den Vorgang abzuschliessen, klicke auf &quot;Datei hochladen&quot;', 'allow_private_albums', 0),
  array('Wohin kann ich Dateien hochladen?', 'Du kannst Dateien in Alben hochladen, die Du innerhalb der Kategorie &quot;meine Galerie&quot; erstellen kannst. Der Administrator der Seite kann Dir auch das Recht einr&auml;umen, in ein oder mehrere Alben der allgemeinen Galerie hochzuladen. Falls das der Fall ist, werden Dir diese Alben im Auswahlmen&uuml; auf der Upload-Seite angezeigt', 'allow_private_albums', 0),
  array('Welche Art und Gr&ouml;&szlig;e von Dateien kann ich hochladen?', 'Die Art (z.B. jpg oder png) und Gr&ouml;&szlig;e bestimmt der Administrator dieser Seite.', 'allow_private_albums', 0),
  array('Was ist &quot;meine Galerie&quot;?', '&quot;Meine Galerie&quot; ist Deine pers&ouml;nliche Galerie, innerhalb der Du Dateien hochladen und bearbeiten kannst.', 'allow_private_albums', 0),
  array('Wie kann ich Alben erzeugen, umbenennen oder l&ouml;schen in &quot;meine Galerie&quot;?', 'Du siehst die Optionen erst nach der Anmeldung im Admin-Modus<br />Klicke auf &quot;Erzeuge/&auml;ndere meine Alben&quot; und klicke auf &quot;Neu&quot;. &Auml;ndere den Text &quot;Neues Album&quot; in den gew&uuml;nschten Namen ab.<br />Du kannst auch bestehende Alben umbenennen, indem Du sie zuerst anklickst und dann im Eingabefeld unten einen neuen Namen daf&uuml;r eingibst.<br />Klicke auf &quot;&Auml;nderungen &uuml;bernehmen&quot;, um Deine &Auml;nderungen durchzuf&uuml;hren.', 'allow_private_albums', 0),
  array('Wie kann ich meine Alben ab&auml;ndern und die Zugriffsrechte darauf &auml;ndern?', 'Du solltest nach der Anmeldung bereits im Admin-Modus sein.<br />Klicke auf &quot; Meine Alben bearbeiten&quot;. W&auml;hle in der Zeile &quot;Album aktualisieren&quot; das Album aus, das Du aktualisieren m&ouml;chtest.<br />Du kannst dann den Namen, die Beschreibung, das Thumbnail (Vorschaugrafik) &auml;ndern und die Rechte &auml;ndern, wer das Album sehen und Kommentare dazu abgeben darf.<br />Um Deine &Auml;nderungen zu best&auml;tigen, klicke am Schlu&szlig; auf &quot;Album aktualisieren&quot;.', 'allow_private_albums', 0),
  array('Was sind Cookies?', 'Cookies sind kleine Textdateien, die von einem Webserver versendet werden und auf Deinem Rechner gespeichert werden. Beim erneuten Aufsuchen der Seite k&ouml;nnen die Cookies wieder vom Server gelesen werden.<br />In der Regel werden Sie dazu genutzt, Dich als Benutzer auf der Seite wiederzuerkennen. Cookies selbst k&ouml;nnen keine Viren oder sonstige b&ouml;sartigen Schad-Programme enthalten und sind daher in erster Linie ungef&auml;hrlich. Einige Seitenbetreiber setzen Cookies allerdings ein, um Verhaltensprofile von Surfern im Internet zu erstellen und nutzen die Informationen in der Regel, um zielgerichtet Werbung f&uuml;r den Surfer zur Verf&uuml;gung zu stellen.', 'offline', 0),
  array('Woher kann ich dieses Porgramm f&uuml;r meine Homepage bekommen?', 'Diese Seite l&auml;uft mit Coppermine. Coppermine ist eine kostenlose Multimedia-Galerie, die unter der Lizenz GNU GPL erscheint. Die Software ist voller Features und f&uuml;r einige Platformen erh&auml;ltlich. Besuche die <a href="http://coppermine.sf.net/">Coppermine Home Page</a> f&uuml;r zus&auml;tzliche Informationen oder um die Software herunterzuladen.', 'offline', 0),

  'Navigation auf der Seite',
  array('Was ist die &quot;Alben-&Uuml;bersicht&quot;?', 'Zeigt die gesamte Kategorie an, in der Du Dich gerade befindest, mit einem Link zu jedem Album. Wenn Du Dich gerade nicht innerhalb einer Kategorie bnefindest zeigt Dir &quot;Alben-&Uuml;bersicht&quot; die gesamte Galerie mit Links zu den einzelnen Kategorien an. M&ouml;glicherweise existieren Thumbnails als Links zu den einzelnen Kategorien.', 'offline', 0),
  array('Was ist &quot;meine Galerie&quot;?', 'Mit diesem Men&uuml;punkt kannst Du Deine eigene Benutzer-Galerie erstellen und bearbeiten.', 'allow_private_albums', 1), //cpg1.4
  array('Was ist der Unterschied zwischen &quot;Admin-Modus&quot; und &quot;Benutzer-Modus&quot;?', 'Im Admin-Modus werden die Navigations-Elemente zum Erstellen und &Auml;ndern Deiner Benutzer-Galerie angezeigt; der Benutzer-Modus zeigt Dir, wie Deine Benutzer-Galerie f&uuml;r andere Benutzer aussieht (ohne die entsprechenden Men&uuml;punkte).', 'allow_private_albums', 0),
  array('Was ist &quot;Dateien hochladen&quot;?', 'Dieses Feature erm&ouml;glicht es Benutzern, eigene Dateien hochzuladen und in Alben zu positionieren (Dateigr&ouml;&szlig;e und -typ wurden vom Admin festgelegt).', 'allow_private_albums', 0),
  ...
  array('Was ist &quot;am besten bewertet&quot;?', 'Durchschnittliche Bewertung der Datei (Bsp.: 5 Benutzer gaben einem Bild ein Bewertung von <img src="images/rating3.gif" width="65" height="14" border="0" alt="" />: das Bild hat eine durchschnittliche Bewertung von <img src="images/rating3.gif" width="65" height="14" border="0" alt="" /> ;Wenn 5 Benutzer ein Bild mit Noten von 1 bis 5 (1,2,3,4,5) bewerten, w&uuml;rde der Schnitt ebenfalls so aussehen: <img src="images/rating3.gif" width="65" height="14" border="0" alt="" /> .)<br />Die Bewertungs-Skala reicht von <img src="images/rating5.gif" width="65" height="14" border="0" alt="super" /> (super) bis <img src="images/rating0.gif" width="65" height="14" border="0" alt="sehr schlecht" /> (sehr schlecht).', 'offline', 0),
  array('Was ist &quot;Meine Favoriten&quot;?', 'Mit diesem Feature kannst Du Bilder, die Du sp&auml;ter noch einmal ansehen willst, in einer Favoriten-Liste speichern. Dazu musst Du nicht einmal angemeldet sein, da die Liste in einem Cookie auf Deinem Computer gespeichert wird. Beachte aber: die Favoriten stehen Dir nur an diesem Computer zur Verf&uuml;gung; wenn die Cookies gel&ouml;scht werden, sind die Favoriten ebenfalls verschwunden.', 'offline', 0),
);
...
if (defined('FORGOT_PASSWD_PHP')) $lang_forgot_passwd_php = array(
  ...
  'submit' => 'los!',
  'illegal_session' => 'Die Session f&uuml;r die Passwort-Erinnerung ist ung&uuml;ltig oder abgelaufen.', //cpg1.4
  ...
  'verify_email_sent' => 'EineeMail wurde an %s gesendet. Bitte &uuml;berpr&uuml;fe Deine Mailbox, um den Vorgang abzuschliessen.', //cpg1.4
  'err_unk_user' => 'Der gew&auml;hlte Benutzer existiert nicht!',
  'account_verify_subject' => '%s - Anforderung neues Passwort', //cpg1.4
  'account_verify_body' => 'Du hast ein neues Passwort beantragt - um dieses neue Passwort tats&auml;chlich zu erhalten, klicke auf nachstehenden Link:
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array(
  ...
  'public_albums' => 'Upload in &ouml;ffentliche Alben', //cpg1.4
  'personal_gallery' => 'Pers&ouml;nliche Galerie', //cpg1.4
  ...
  'approval' => 'Best&auml;tigung', //cpg1.4
  'boxes_number' => 'Anzahl Felder', //cpg1.4
  'variable' => 'variabel', //cpg1.4
  'fixed' => 'fest', //cpg1.4
  'apply' => '&Auml;nderungen &uuml;bernehmen',
  ...
  'reset_to_default' => 'Auf Standard-Gruppennamen (%s) zur&uuml;cksetzen - empfohlen!', //cpg1.4
  ...
  'explain_guests_greyed_out_text' => 'Die Eigenschaften dieser Gruppe k&ouml;nnen nicht ver&auml;ndert werden, weil die Option &quot;Nicht-angemeldeten Besuchern (G&auml;ste) Zugriff erlauben&quot; in der Coppermine-Knofiguration auf &quot;Nein&quot; gesetzt wurde. Alle G&auml;ste (Mitglieder der Gruppe %s) k&ouml;nnen nichts tun au&szlig;er sich anzumelden; daher sind keine der Gruppen-Verrechtungen f&uuml;r sie zutreffend.', //cpg1.4
  'explain_banned_greyed_out_text' => 'Die Eigenschaften der Gruppe %s k&ouml;nnen nicht ver&auml;ndert werden, da deren Mitglieder sowieso nicht tun d&uuml;rfen.', //cpg1.4
...
$lang_album_admin_menu = array(
  'confirm_delete' => 'Willst Du dieses Album wirklich L&Ouml;SCHEN? \\nAlle darin befindlichen Dateien und Kommentare werden ebenfalls gel&ouml;scht.',
  'delete' => 'l&ouml;schen',
...
$lang_list_albums = array(
  ...
  'n_link_pictures' => '%s verkn&uuml;pfte Dateien', //cpg1.4
...
if (defined('KEYWORDMGR_PHP')) $lang_keywordmgr_php = array(
  ...
  'delete' => 'l&ouml;schen', //cpg1.4
  'search' => 'suchen', //cpg1.4
  'keyword_test_search' => 'nach %s in einem neuen Fenster suchen', //cpg1.4
  'keyword_del' => 'das Stichwort %s l&ouml;schen', //cpg1.4
  'confirm_delete' => 'Willst Du wirklich das Stichwort %s aus der gesamten Galerie l&ouml;schen?', //cpg1.4  // js-alert
  'change_keyword' => 'Stichwort &auml;ndern', //cpg1.4
);
...
if (defined('MINIBROWSER_PHP')) $lang_minibrowser_php = array(
  'close' => 'schliessen', //cpg1.4
  'submit' => 'OK', //cpg1.4
  'up' => 'eine Ebene h&ouml;her', //cpg1.4
  'current_path' => 'derzeitiger Pfad', //cpg1.4
  'select_directory' => 'W&auml;hle ein Verzeichnis', //cpg1.4
...
if (defined('MODIFYALB_PHP')) $lang_modifyalb_php = array(
  ...
  'can_upload' => 'Besucher k&ouml;nnen Dateien hochladen',
  'can_post_comments' => 'Besucher k&ouml;nnen Kommentare abgeben',
  'can_rate' => 'Besucher k&ouml;nnen Dateien bewerten',
  ...
  'reset_album' => 'Album zur&uuml;cksetzen', //cpg1.4
  'reset_views' => 'Anzeigez&auml;hler zur&uuml;cksetzen auf &quot;0&quot; f&uuml;r %s', //cpg1.4
  'reset_rating' => 'Abstimmungen auf alle Dateien im Album %s zur&uuml;cksetzen', //cpg1.4
  'delete_comments' => 'Alle Kommentare im Album %s l&ouml;schen', //cpg1.4
  'delete_files' => 'Unwiederbringlich alle Dateien im Album %s l&ouml;schen', //cpg1.4
  'views' => 'Treffer', //cpg1.4
  'votes' => 'Stimmen', //cpg1.4
  'comments' => 'Kommentare', //cpg1.4
  'files' => 'Dateien', //cpg1.4
  'submit_reset' => '&Auml;nderungen durchf&uuml;hren', //cpg1.4
  'reset_views_confirm' => 'ich bin mir sicher', //cpg1.4
  'notice1' => '(*) abh&auml;ngig von den %sGruppen%s Einstellungen',  //cpg1.4 //(do not translate %s!)
  'alb_password' => 'Passwort des Albums', //cpg1.4
  'alb_password_hint' => 'Hinweis f&uuml;r Albums-Passwort', //cpg1.4
...
if (defined('PHPINFO_PHP')) $lang_phpinfo_php = array(
  'php_info' => 'PHP info',
  'explanation' => 'Diese Ausgabe wird durch die PHP-Funktion <a href="http://www.php.net/phpinfo">phpinfo()</a> erzeugt, und innerhalb von Coppermine angezeigt (dabei wird m&ouml;glicherweise die Ausgabe einiger Felder am rechten Rand abgeschnitten).',
  'no_link' => 'Anderen Personen die phpinfo-Daten anzuzeigen, kann ein Sicherheitsrisiko sein - daher wird diese Seite nur angezeigt, wenn Du als Admin angemeldet bist. Du kannst daher anderen keinen Link auf diese Seite zukommen lassen, da ihnen der Zugriff verw&auml;hrt werden wird!',
);
...
if (defined('PICMGR_PHP')) $lang_picmgr_php = array(
  ...
  'select_album' => 'W&auml;hle Album', //cpg1.4
  'delete' => 'L&ouml;schen', //cpg1.4
  'confirm_delete1' => 'Dieses Bild wirklich l&ouml;schen?', //cpg1.4
  'confirm_delete2' => '\nL&ouml;schen ist dauerhaft und endg&uuml;ltig.', //cpg1.4
  'apply_modifs' => '&Auml;nderungen &uuml;bernehmen', //cpg1.4
  'confirm_modifs' => '&Auml;nderungen best&auml;tigen', //cpg1.4
  'pic_need_name' => 'Bild muss einen Namen haben', //cpg1.4
  'no_change' => 'Es wurden keine &Auml;nderungen vorgenommen', //cpg1.4
  'no_album' => '* Kein Album *', //cpg1.4
  'explanation_header' => 'Die benutzerdefinierte Sortierreihenfolge, die Du auf dieser Seite w&auml;hlen kannst wird nur angewendet, wenn', //cpg1.4
  'explanation1' => 'der Administrator die Konfigurationsoption f&uuml;r "Benutzerdefinierte Sortierreihenfolde f&uuml;r Dateien" auf "Position absteigend" oder "Position aufsteigend" gesetzt hat (globale Einstellung f&uuml;r alle Benutzer, die keine andere individuelle Sortierreihenfolge gew&auml;hlt haben)', //cpg1.4
  'explanation2' => 'der Benutzer als Sortierreihenfolde "Position absteigend" oder "Position aufsteigend" auf der Thumbnail-Seite gew&auml;hlt hat (Einstellung pro Benutzer)', //cpg1.4
);
...
$lang_pluginmgr_php = array(
  ...
  'confirm_delete' => 'Dieses Plugin wirklich L&Ouml;SCHEN', //cpg1.4
...
Obwohl die Administratoren von {SITE_NAME} versuchen werden, generell alle anst&ouml;ssigen Inhalte so schnell wie m&ouml;glich zu l&ouml;schen oder zu bearbeiten, ist es unm&ouml;glich, jeden Beitrag zu &uuml;berpr&uuml;fen. Daher best&auml;tigst Du, dass alle Beitr&auml;ge auf dieser Seite die Ansichten und Meinungen des Authors widerspiegeln und nicht die des Administrators oder Webmasters (au&szlig;er den Beitr&auml;gen, die durch sie verfasst wurden) und sie daher daf&uuml;r nicht verantwortlich gemacht werden k&ouml;nnen.<br />
<br />
Du stimmst zu, keine beleidigende, obsz&ouml;ne, vulg&auml;re, verleumderische, verhetzende, drohende, sexuell-orientierte oder sonstwie illegalen Beitr&auml;ge zu verfassen. Du stimmst zu, dass der/die Webmaster, Administrator(en) oder Moderator(en) von {SITE_NAME} das Recht haben, jeden Inhalt zu l&ouml;schen oder zu &auml;ndern, bei dem sie es f&uuml;r richtig halten. Als Benutzer stimmst Du zu, dass alle Informationen, die Du oben eingetragen hast, in einer Datenbank gespeichert werden. Obwohl diese Daten ohne Deine ausdr&uuml;ckliche Zustimmung nicht an Dritte weitergegeben werden, k&ouml;nnen der Webmaster oder Administrator nicht daf&uuml;r zur Verantwortung gezogen werden, wenn durch einen Angriff (Hacking) die gespeicherten Daten kompromitiert werden.<br />
<br />
Diese Seite benutzt Cookies, um Daten auf Deinem Rechner zu speichern. Diese Cookies dienen nur dazu, die Bedienung der Seite zu erm&ouml;glichen. Die eMail-Adresse wird nur dazu verwendet, die Registrierungs-Details und das Passwort zu best&auml;tigen.<br />
<br />
...
$lang_register_php = array(
  ...
  'err_invalid_email' => 'eMail-Adresse ist ung&uuml;ltig',
  ...
  'failed_sending_email' => 'Die Registrierungs-Best&auml;tigung kann nicht per eMail versendet werden!',
  'thank_you' => 'Danke f&uuml;r Deine Registrierung.<br /><br />Eine eMail mit Informationen, wie Du Dein Benutzerkonto aktivieren kannst, wurde an die angegebene eMail-Adresse gesendet.',
  ...
  'acct_active_admin_activation' => 'Das Benutzerkonto ist jetzt aktiv. Dem Benutzer wurde eine Benachrichtigung dar&uuml;ber per eMail gesendet.', //cpg1.4
...
$lang_search_php = array(
  ...
  'keyword_msg' => 'Obenstehende Liste ist nicht vollst&auml;ndig - sie enth&auml;lt keine W&ouml;rter aus Titeln oder Beschreibungen. Versuche eine Volltext-Suche.',  //cpg1.4
  ...
  'older_than' => '&auml;lter als', //cpg1.4
  'days' => 'Tage(e)', //cpg1.4
  'all_words' => 'mit allen W&ouml;rtern (UND)', //cpg1.4
  'any_words' => 'mit irgendeinem der W&ouml;rter (ODER)', //cpg1.4
);
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array(
  ...
  'select_dir_msg' => 'Diese Funktion erm&ouml;glicht, mehrere Dateien der Galerie hinzuzuf&uuml;gen, die mit einem FTP-Programm schon auf Deine Webseite hochgeladen wurden.<br /><br />W&auml;hle das Verzeichnis, in das Du die Dateien hochgeladen hast.', //cpg1.4
  'no_pic_to_add' => 'Keine Datei zum Hinzuf&uuml;gen gefunden',
  'need_one_album' => 'Du brauchst mindestens ein Album, um dieses Funktion auszuf&uuml;hren',
  'warning' => 'Achtung',
  'change_perm' => 'Das Skript kann nicht in dieses Verzeichnis schreiben, Du musst die Lese-/Schreibberechtigung (chmod) auf 755 oder 777 setzen, bevor Du versuchst, Dateien hinzuzuf&uuml;gen!',
  ...
  'insert' => 'F&uuml;ge neue Dateien der Galerie hinzu',
  'list_new_pic' => 'Liste neuer Dateien',
  'insert_selected' => 'Markierte Dateien einf&uuml;gen',
  ...
  'no_album' => 'Kein Album gew&auml;hlt',
  'result_icon' => 'Klicken f&uuml;r Details oder zum erneut laden',  //cpg1.4
  'notes' =>  '<ul>'.
    '<li><b>OK</b> : bedeuted, dass die Datei erfolgreich hinzugef&uuml;gt wurde'.
    '<li><b>DP</b> : bedeutet, dass die Datei ein Duplikat ist und schon in der Datenbank vorhanden ist'.
    '<li><b>PB</b> : bedeutet, dass die Datei nicht hinzugef&uuml;gt werden konnte; &uuml;berpr&uuml;fe Deine Einstellungen und die Berechtigungen der Verzeichnisse, in dem die Dateien liegen'.
    '<li><b>NA</b> : bedeutet, dass Du kein Album gew&auml;hlt hast, in das die Dateien eingef&uuml;gt werden sollen, klicke \'<a href="javascript:history.back(1)">zur&uuml;ck</a>\' und w&auml;hle ein Album aus. Wenn kein Album ausgew&auml;hlt werden kann, dann musst Du erst <a href="albmgr.php">ein Album erzeugen</a>.</li>'.
    ...
    '</ul>',
  'select_album' => 'W&auml;hle ein Album',
  'check_all' => 'alle ausw&auml;hlen',
  'uncheck_all' => 'Auswahl aufheben',
  'no_folders' => 'Im Verzeichnis "albums" wurden noch keine Unterverzeichnisse angelegt. Du musst mindestens ein benutzerdefiniertes Unterverzeichnis innerhalb des Ordners "albums" anlegen und Deine Dateien per FTP dorthin hochladen. Du darfst per FTP keine Dateien in die Unterverzeichnisse "userpics" oder "edit" hochladen, da diese f&uuml;r http-uploads und interne Zwecke reserviert sind.', //cpg1.4
   'albums_no_category' => 'Alben ohne Kategorie', //cpg1.4 // album pulldown mod, added by frogfoot
  'personal_albums' => '* Pers&ouml;nliche Alben', //cpg1.4 // album pulldown mod, added by frogfoot
  'browse_batch_add' => 'Durchsuchbare Oberfl&auml;che (empfohlen)', //cpg1.4
...
if (defined('UPLOAD_PHP')) $lang_upload_php = array(
  ...
  'cust_instr_1' => 'Die Anzahl der Upload-Felder kann angepasst werden, darf jedoch die untenstehenden Maximalwerte nicht &uuml;berschreiten.',
  ...
  'cust_instr_7' => 'Gib die Anzahl der gew&uuml;nschten Felder ein und klicke auf \'weiter\'.',
  'reg_instr_1' => 'Unzul&auml;ssige Aktion bei der Formular-Erzeugung.',
  'reg_instr_2' => 'Du kannst jetzt Dateien mit den untenstehenden Feldern hochladen. Keine Datei darf gr&ouml;&szlig;er als %s kB sein. ZIP-Dateien, die mit Datei-Upload oder URI/URL-Upload hochgeladen werden, bleiben komprimiert.',
  'reg_instr_3' => 'Um ZIP-Dateien auf dem Server automatisch zu entpacken, verwende die ZIP-Upload Felder.',
  'reg_instr_4' => 'Die URI/URL-Upload Felder m&uuml;ssen dieses Format haben \'http://www.meinseite.de/bilder/beispiel.jpg\'',
  'reg_instr_5' => 'Wenn alle Upload-Felder ausgef&uuml;llt sind, klicke auf \'weiter\'.',
  ...
  'exc_php_ini' => 'Dateigr&ouml;&szlig;e gr&ouml;&szlig;er als Limit in php.ini.',
  'exc_file_size' => 'Dateigr&ouml;&szlig;e gr&ouml;&szlig;er als Coppermine-Einstellungen.',
  'partial_upload' => 'Nur teilweiser Upload.',
  'no_upload' => 'Kein Upload erfolgt.',
  'unknown_code' => 'Unbekannter PHP-Upload-Fehlercode.',
  'no_temp_name' => 'Kein Upload - kein tempor&auml;rer Name.',
  'no_file_size' => 'Enth&auml;lt keine Daten/defekt',
  'impossible' => 'Kann nicht verschieben.',
  'not_image' => 'kein Bild/korrupt',
  'not_GD' => 'Keine GD-Erweiterung.',
  'pixel_allowance' => 'maximale Bild-Abmessungen (Pixel-Gr&ouml;&szlig;e) &uuml;berschritten.',
  'incorrect_prefix' => 'Ung&uuml;ltige URI/URL Vorsible',
  'could_not_open_URI' => 'Konnte URI nicht &ouml;ffnen.',
  'unsafe_URI' => 'Sicherheit nicht &uuml;berpr&uuml;fbar.',
  ...
  'http_503' => '503 Service nicht verf&uuml;gbar',
  ...
  'add' => 'Klicke auf \'weiter\', um die Dateien den Alben hinzuzuf&uuml;gen.',
  ...
  'max_fsize' => 'Maximal erlaubte Dateigr&ouml;&szlig;e ist %s kB',
  'album' => 'Album',
  'picture' => 'Datei',
  'pic_title' => 'Datei-Titel',
  'description' => 'Datei-Beschreibung',
  'keywords' => 'Stichworte (Trennung mit Komma)<br /><a href="#" onClick="return MM_openBrWindow(\'keyword_select.php\',\'selectKey\',\'width=250, height=400, scrollbars=yes,toolbar=no,status=yes,resizable=yes\')">von Liste einf&uuml;gen</a>', //cpg1.4
  'keywords_sel' =>'W&auml;hle Schlagwort', //cpg1.4
  'err_no_alb_uploadables' => 'Leider gibt es kein Album, in das Du Bilder hochladen darfst',
  'place_instr_1' => 'Bitte Dateien jetzt den Alben zuordnen.  Es k&ouml;nnen jetzt zus&auml;tzliche Angaben zu den Dateien gemacht werden.',
  'place_instr_2' => 'Es m&uuml;ssen noch mehr Dateien Alben zugeordnet werden. Klicke \'weiter\'!',
  'process_complete' => 'Alle Dateien wurden erfolgreich Alben zugeordnet.',
  'albums_no_category' => 'Alben ohne Kategorie', //cpg1.4. //album pulldown mod, added by frogfoot
  'personal_albums' => '* Pers&ouml;nliche Alben', //cpg1.4 //album pulldown mod, added by frogfoot
  'select_album' => 'W&auml;hle Album', //cpg1.4 //album pulldown mod, added by frogfoot
  'close' => 'schliessen', //cpg1.4
  'no_keywords' => 'Leider keine Schlagworte verf&uuml;gbar!', //cpg1.4
  'regenerate_dictionary' => 'W&ouml;rterbuch aktualisieren', //cpg1.4
);
...
if (defined('USERMGR_PHP')) $lang_usermgr_php = array(
  ...
  'delete' => 'l&ouml;schen', //cpg1.4
  'delete_files_no' => 'Dateien in &ouml;ffentlichen Alben behalten (aber anonymisieren)', //cpg1.4
  'delete_files_yes' => 'Dateien in &ouml;ffentlichen Alben ebenfalls l&ouml;schen', //cpg1.4
  'delete_comments_no' => 'Kommentare behalten (aber anonymisieren)', //cpg1.4
  'delete_comments_yes' => 'Kommentare ebenfalls l&ouml;schen', //cpg1.4
  'activate' => 'Aktivieren', //cpg1.4
  'deactivate' => 'Deaktivieren', //cpg1.4
  'reset_password' => 'Passwort zur&uuml;cksetzen', //cpg1.4
  'change_primary_membergroup' => 'Prim&auml;re Mitgliedergruppe &auml;ndern', //cpg1.4
  'add_secondary_membergroup' => 'Sekund&auml;re Mitgliederguppe hinzuf&uuml;gen', //cpg1.4
  'name' => 'Benutzername',
  'group' => 'Gruppe',
  'inactive' => 'Inaktiv',
  'operations' => 'Aktion',
  ...
  'confirm_del' => 'Willst Du diesen Benutzer wirklich L&Ouml;SCHEN? \\nAlle seine Dateien und Alben werden ebenfalls gel&ouml;scht.', //js-alert
  'mail' => 'Mail',
  ...
  'user_occupation' => 'Beruf/Besch&auml;ftigung',
  ...
  'alert_no_selection' => 'Du musst zuerst mindestens einen Benutzer ausw&auml;hlen!', //cpg1.4 //js-alert
  'password' => 'Passwort', //cpg1.4
  'select_group' => 'W&auml;hle Gruppe', //cpg1.4
  'groups_alb_access' => 'Alben-Berechtigung nach Gruppenzugeh&ouml;rigkeit', //cpg1.4
  'album' => 'Album', //cpg1.4
  'category' => 'Kategorie', //cpg1.4
  'modify' => '&Auml;ndern?', //cpg1.4
...
'L&ouml;scht Titel', //cpg1.4
'Erneuert Thumbnails und Dateien in Zwischengr&ouml;&szlig;e gem&auml;&szlig; aktuellen Einstellungen', //cpg1.4
'L&ouml;scht Bilder in Original-Gr&ouml;&szlig;e und ersetzt sie mit Bildern in Zwischengr&ouml;&szlig;e', //cpg1.4
'L&ouml;scht Bilder in Originalgr&ouml;sse oder Zwischengr&ouml;sse, um Speicherplatz frei zu geben', //cpg1.4
'L&ouml;scht verwaiste Kommentare', //cpg1.4
'Liest Dateigr&ouml;ssen und Dimensionen erneut ein (falls Du Bilder manuell bearbeitet hast)', //cpg1.4
'Setzt Hits-Z&auml;hler zur&uuml;ck', //cpg1.4
'Zeigt phpinfo an', //cpg1.4
'Aktualisert die Datenbank', //cpg1.4
'Zeigt Log-Dateien an', //cpg1.4
);
$lang_util_php = array(
  'title' => 'Admin-Werkzeuge (Gr&ouml;&szlig;e &auml;ndern)',
  ...
  'thumbs_wait' => 'Aktualisiere Thumbnails und/oder Bilder in Zwischengr&ouml;&szlig;e, bitte warten...',
  'thumbs_continue_wait' => 'Fortfahren mit der Aktualisierung der Thumbnails und/oder Bilder in Zwischengr&ouml;&szlig;e...',
  'titles_wait' => 'Aktualisiere &Uuml;berschriften, bitte warten...',
  'delete_wait' => 'L&ouml;sche &Uuml;berschriften, bitte warten...',
  'replace_wait' => '&ouml;sche Originale und ersetze sie mit Bilder in Zwischengr&ouml;&szlig;e, bitte warten...',
  ...
  'update' => 'Thumbnails und/oder Bilder in Zwischengr&ouml;&szlig;e aktualisieren',
  'update_what' => 'Was soll aktualisiert werden',
  'update_thumb' => 'Nur Thumbnails',
  'update_pic' => 'Nur Bilder in Zwischengr&ouml;&szlig;e',
  'update_both' => 'Sowohl Thumbnails als auch Bilder in Zwischengr&ouml;&szlig;e',
  ...
  'delete' => 'L&ouml;sche Bild-&Uuml;berschriften oder Bilder in Original-Gr&ouml;&szlig;e',
  'delete_title' => 'Bild-&Uuml;berschriften l&ouml;schen',
  'delete_title_explanation' => 'Diese Option l&ouml;scht alle Titel von allen Dateien in dem angegebenen Album.', //cpg1.4
  'delete_original' => 'Bilder in Original-Gr&ouml;&szlig;e l&ouml;schen',
  'delete_original_explanation' => 'Diese Option entfernt die Bilder in Originalgr&ouml;&szlig;e.', //cpg1.4
  'delete_intermediate' => 'Bilder in Zwischengr&ouml;&szlig;e l&ouml;schen', //cpg1.4
  'delete_intermediate_explanation' => 'Diese Option l&ouml;scht alle Bilder in Zwischengr&ouml;&szlig;e (normal_).<br />Empfohlen, um Speicherplatz freizugeben, wenn die Option \'Bilder in Zwischengr&ouml;&szlig;e erzeugen\' in den Coppermine-Einstellungen deaktiviert wurde NACHDEM Bilder zur Datenbank hinzugef&uuml;gt wurden.', //cpg1.4
  'delete_replace' => 'L&ouml;sche die Original-Bilder und ersetze sie mit Bilder in Zwischengr&ouml;&szlig;e',
  'titles_deleted' => 'Alle Titel in dem angegebenen Album werden gel&ouml;scht', //cpg1.4
  'deleting_intermediates' => 'L&ouml;sche Bilder in Zwischengr&ouml;&szlig;e, bitte warten...', //cpg1.4
  'searching_orphans' => 'Suche nach verwaisten Eintr&auml;gen, bitte warten...', //cpg1.4
  'select_album' => 'W&auml;hle Album',
  'delete_orphans' => 'Verwaiste Kommentare l&ouml;schen', //cpg1.4
  'delete_orphans_explanation' => 'Diese Option identifiziert und l&ouml;scht Kommentare, die mit Dateien verkn&uuml;pft sind, die nicht mehr in der Datenbank vorhanden sind.<br />Durchl&auml;uft alle Alben.', //cpg1.4
  'refresh_db' => 'Informationen &uuml;ber Dateigr&ouml;&szlig;en und -abmessungen erneuern.', //cpg1.4
  'refresh_db_explanation' => 'Diese Option liest die Dateigr&ouml;&szlig;en und -abmessungen erneut ein. Benutze sie, wenn die Speicherplatz-Anzeige unkorrekt erscheint oder wenn Du die Dateien manuell ver&auml;ndert hast..', //cpg1.4
  'reset_views' => 'Hits-Z&auml;hler zur&uuml;cksetzen', //cpg1.4
  'reset_views_explanation' => 'Setzt alle "Datei x mal angesehen" Z&auml;hler auf Null im angegebenen Album.', //cpg1.4
  'orphan_comment' => 'verwaiste Kommentare gefunden',
  'delete' => 'l&ouml;schen',
  'delete_all' => 'alle l&ouml;schen',
  'delete_all_orphans' => 'Alle verwaisten Kommentare l&ouml;schen?', //cpg1.4
  'comment' => 'Kommentar: ',
  'nonexist' => 'Bezug auf nicht-existierende Datei # ',
  'phpinfo' => 'phpinfo anzeigen',
  'phpinfo_explanation' => 'Zeigt technische Informationen &uuml;ber Deinen Server an.<br /> - M&ouml;glicherweise wirst Du nach diesen Informationen gefragt, wenn Du im Coppermine-Forum um Hilfe bittest.', //cpg1.4
  'update_db' => 'Datenbank aktualisieren',
  'update_db_explanation' => 'Wenn Du Coppermine-Dateien ersetzt hast, eine Modifikation oder ein Upgrade von einer fr&uuml;hreren Version von Coppermine durchgef&uuml;hrt hast, lasse diese Datenbank-Aktualisierung einmal laufen, um die m&ouml;glicherweise notwendigen &Auml;nderungen an der Datenbank durchzuf&uuml;hren bzw. fehlende Tabellen zu erzeugen.',
  'view_log' => 'Log-Dateien anzeigen', //cpg1.4
  'view_log_explanation' => 'Coppermine kann verschiedene Benutzer-Aktionen protokollieren. Diese Protokolle k&ouml;nnen hier angesehen werden, wenn die Aufzeichnung von Log-Dateien in den Coppermine-<a href="admin.php">Einstellungen</a> aktiviert wurde.', //cpg1.4
  'versioncheck' => 'Versions-Check', //cpg1.4
  'versioncheck_explanation' => '&Uuml;berpr&uuml;fe die Versionen Deiner Dateien um herauszufinden, ob alle Dateien bei einem Update korrekt ersetzt wurden, oder ob die Coppermine-Dateien nach der Ver&ouml;ffentlichung eines Pakets aktualisiert wurden.', //cpg1.4
...
if (defined('VERSIONCHECK_PHP')) $lang_versioncheck_php = array(
  ...
  'what_it_does' => 'Diese Seite ist f&uuml;r Benutzer gedacht, die ihre Version von Coppermine katualisiert haben. Dieses Skript durchl&auml;uft alle Dateien auf dem Webserver und versucht festzustellen, ob Deine lokalen Dateiversionen mit denen der Referenz auf http://coppermine.sourceforge.net &uuml;bereinstimmen. Dadurch werden die Dateien, die irrt&uuml;mlich nicht aktualisiert wirden angezeigt.<br />Alles, was korrigiert werden muss wird in rot angezeigt. Eintr&auml;ge in gelb m&uuml;ssen einer n&auml;heren Betrachtung unterzogen werden. Eintr&auml;ge in gr&uuml;n (oder Deiner Standard-Schriftfarbe) sind OK.<br />Klicke auf die Hilfe-Icons f&uuml;r Details.', //cpg1.4
  'online_repository_unable' => 'Konnte nicht mit Referenz-Datei abgleichen', //cpg1.4
  'online_repository_noconnect' => 'Coppermine konnte sich nicht mit der Referenz-Datei abzugleichen. Dies kann 2 Gr&uuml;nde haben:', //cpg1.4
  'online_repository_reason1' => 'die Referenzdatei ist derzeit nicht online - &uuml;berpr&uuml;fe, ob Du mit dem Browser diese Seite anzeigen kannst: %s - falls nicht, versuche sp&auml;ter noch einmal, den Versions-Check durchzuf&uuml;hren.', //cpg1.4
  'online_repository_reason2' => 'Auf Deinem Webserver ist PHP so konfiguriert, dass %s deaktiviert ist (Standard-m&auml;ssig ist diese Option aktiviert). Falls Du den Webserver administrieren kannst, aktiviere diese Option in Deiner <i>php.ini</i> (erlaube zumindest, dass die globale EInstellung mit %s tempor&auml;r umgangen werden kann). Falls Du jedoch auf einem fremden Server gehostet bist musst Du wahrscheinlich damit leben, dass Du Deine Dateien nicht online vergleichen kannst. In diesem Fall wird diese Seite nur die Dateiversionen mit denen der Ditribution vergleichen - sp&auml;tere Updates werden nicht in Betracht gezogen.', //cpg1.4
  'online_repository_skipped' => 'Verbindung mit der Referenz-Datei &uuml;bersprungen', //cpg1.4
  'online_repository_to_local' => 'Das Skript benutzt jetzt die lokale Kopie der Versions-Dateien. Die Daten sind m&ouml;glicherweise ungenau, falls Du Coppermine aktualisiert und nicht alle Dateien hochgeladen hast. &Auml;nderungen an Dateiversionen, die nach der Ver&ouml;ffentlichung des Pakets vorgenommen wurden werden nicht ber&uuml;cksichtigt.', //cpg1.4
  'local_repository_unable' => 'Das Skript konnte sich nicht mit der Referenzdatei auf Deinem Server verbidnen', //cpg1.4
  'local_repository_explanation' => 'Coppermine konnte sich nicht mit der Refernzdatei %s auf Deinem Webserver verbinden. Das bedeutet wahrscheinlich, dass Du die Refernzdatei nicht auf den Server hochgeladen hast. Erledige das nun und versuche dann, diese Seite erneut zu laden (klicke auf "aktualisieren").<br />Falls das immer noch fehl schl&auml;gt, dann hat Dein Webhost m&ouml;glicherweise Teile der <a href="http://www.php.net/manual/de/ref.filesystem.php">Dateifunktionen von PHP</a> komplett deaktiviert. In diesem Fall kannst Du dieses Tool leider gar nicht benutzen.', //cpg1.4
  ...
  'help_file_not_exist_mandatory2' => 'Datei/Verzeichnis %s wurde auf dem Server nicht gefunden, obwohl es zwingend ben&ouml;tigt wird. Lade die Datei (mit Hilfe Deines FTP-Programms) auf Deinen Webserver hoch..', //cpg1.4
  'help_no_local_version1' => 'Keine lokale Dateiversion', //cpg1.4
  'help_no_local_version2' => 'Das Skript konnte die Versionsinformation aus der lokalen Datei-Version nicht extrahieren - Deine Datei ist entweder veraltet, oder Du hast die Datei ver&auml;ndert und dabei den Datei-Header ge&auml;ndert. Es ist empfehlenswert, die Datei zu aktualisieren.', //cpg1.4
  'help_local_version_outdated1' => 'Lokale Version veraltet', //cpg1.4
  'help_local_version_outdated2' => 'Deine Version der Datei scheint von einer &auml;lteren Version von Coppermine zu stammen (Du hast wahrscheinlich ein Upgrade durchgef&uuml;hrt). Ersetze auch diese Datei mit der aktuelleren Version.', //cpg1.4
  ...
  'help_local_version_dev2' => 'Die Datei auf Deinem Webserver scheint neuer zu sein als Deine Coppermine-Version. Du benutzt entweder eine Entwicklungs-Version (nur empfohlen f&uuml;r erfahrene Anwender), oder Du hast Deine Coppermine-Installation aktualisiert und die Datei include/init.inc.php nicht hochgeladen.', //cpg1.4
  'help_not_writable1' => 'Verzeichnis nicht beschreibbar', //cpg1.4
  'help_not_writable2' => '&Auml;ndere die Berechtigungen (CHMOD), um dem Skript Schreibrechte auf den Ordner %s und alles darin befindliche zu gew&auml;hren.', //cpg1.4
  'help_writable1' => 'Verzeichnis beschreibbar', //cpg1.4
  'help_writable2' => 'Das Verzeichnis %s ist beschreibbar. DIes stellt ein unn&ouml;tiges Sicherheitsrisiko dar, Coppermine ben&ouml;tigt nur Lese- und Ausf&uuml;hgrungsrechte.', //cpg1.4
  ...
  'total' => 'Summe der &uuml;berpr&uuml;ften Verzeichnisse/Dateien', //cpg1.4
  'mandatory_files_missing' => 'Fehlende verbindlich ben&ouml;tigte Dateien', //cpg1.4
  ...
  'show_mandatory_files' => 'verbindlich ben&ouml;tigte Dateien anzeigen', //cpg1.4
  ...
  'coppermine_in_webroot' => 'Coppermine ist im Wurzelverzeichnis der Dom&auml;ne installiert', //cpg1.4
  ...
  'submit' => '&Auml;nderungen durchf&uuml;hren / aktualisieren', //cpg1.4
...
if (defined('VIEWLOG_PHP')) $lang_viewlog_php = array(
  'delete_all' => 'Alle Logs l&ouml;schen', //cpg1.4
  'delete_this' => 'Dieses Log l&ouml;schen', //cpg1.4
...
<h1>XP Web Publishing Assistent</h1><p>Dieses Modul erm&ouml;glicht es, den <b>Windows XP</b> web publishing Assistenten mit Coppermine zu benutzen.</p><p>Der zugrunde liegende Code basiert auf einem Artikel von
EOT;

$lang_xp_publish_required = <<<EOT
<h2>Was wird ben&ouml;tigt</h2><ul><li>Windows XP, damit der Assistent zur Verf&uuml;gung steht.</li><li>Eine funktionierende Coppermine-Installation, bei der das Hochladen von Dateien funktioniert.</b></li></ul><h2>Wie installiere ich die n&ouml;tige Software auf meinem Rechner</h2><ul><li>Rechts-Klicke auf
EOT;

$lang_xp_publish_select = <<<EOT
W&auml;hle &quot;Zeil speichern unter..&quot;. Speichere die Datei auf Deiner Festplatte. &Uuml;berpr&uuml;fe beim Speichern, dass der vorgeschlagene Name  <b>cpg_###.reg</b> lautet (die ###-Symbole repr&auml;sentieren einen numerischen Zeitstempel). &Auml;ndere ggf. den Namen ab (aber lasse die Zahlen so, wie sie sind). Nach erfolgtem Download, dopperlklicke auf die heruntergeladene Datei, um den Coppermine-Server beim Web Publishing-Assistenten zu registrieren.</li></ul>
EOT;

$lang_xp_publish_testing = <<<EOT
<h2>Testen</h2><ul><li>Markiere einige Grafik-Dateien im Windows Explorer und klicke dann auf <b>xxx im Internet ver&ouml;ffentlichen</b> in der linken Leiste des Explorers.</li><li>Best&auml;tige Deine Dateiauswahl. Klicke auf <b>weiter</b>.</li><li>In der Liste der zur Verf&uuml;gung stehenden Dienste, w&auml;hle Deine Foto-Galerie (der Eintrag hat den Namen Deiner Galerie). Falls der Diesnt nicht erscheint, &uuml;berpr&uuml;fe, ob Du <b>cpg_pub_wizard.reg</b> wie oben beschrieben installiert hats.</li><li>Gib Deine Zugangsinformationen ein, falls notwendig.</li><li>W&auml;hle ein Album als Ziel der Bilder oder erzeuge ein neues Album.</li><li>Klicke auf <b>weiter</b>. Der Upload Deiner Bilder startet jetzt.</li><li>Wenn der Upload beendet ist, &uuml;berpr&uuml;fe auf der Galerie-Seite, dass alle Bilder korrekt hochgeladen wurden.</li></ul>
EOT;

$lang_xp_publish_notes = <<<EOT
<h2>Anmerkungen :</h2><ul><li>Wenn der Upload-Vorgang erst einmal gestartet ist kann der Assistent keine Fehlermeldungen anzeigen, die vom Skript generiert werden; daher kann man nicht wissen, ob ein Upload erfolgreich war oder nicht, au&szlig;er durch Besuch der Coppermine-Galerie.</li><li>Wenn ein Upload fehlschl&auml;gt, aktiviere den &quot;Debug-Modus&quot; in den Coppermine-Einstellungen, lade ein einzelnes Bild hoch und &uuml;berpr&uuml;fe dann die Fehlermeldungen in der
EOT;

$lang_xp_publish_flood = <<<EOT
Datei, die im Coppermine-Verzeichnis auf Deinem Server liegt.</li><li>Um zu vermeiden, dass die Galerie &uuml;berflutet wird mit Uploads durch den Assistenten k&ouml;nnen nur die <b>Administratoren der Galerie</b> und <b>Benutzer, die eigene Alben haben d&uuml;rfen</b> dieses Feature nutzen.</li>
EOT;
...
$lang_xp_publish_php = array(
  ...
  'create_new' => 'Erstelle ein neues Album f&uuml;r Deine Bilder', //cpg1.4
  'album' => 'Album', //cpg1.4
  'category' => 'Kategorie', //cpg1.4
