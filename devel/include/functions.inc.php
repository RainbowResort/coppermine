...
function get_pic_data($album, &$count, &$album_name, $limit1=-1, $limit2=-1, $set_caption = true)
{
        ...
        case 'lastup': // Last uploads
                ...
                if ($set_caption) foreach ($rowset as $key => $row){
                        $user_link = ($CONFIG['display_uploader'] && $row['owner_id'] && $row['owner_name'] && !($CONFIG['hide_admin_uploader'] && in_array($row['owner_id'],$CONFIG['ADMIN_USERS']))) ? '<span class="thumb_title"><a href ="profile.php?uid='.$row['owner_id'].'">'.$row['owner_name'].'</a></span>' : '';
...
$lang_language_data['chinese_big5'] = array('Chinese simplified','&#20013;&#25991; - &#31616;&#20307;','tw');
$lang_language_data['chinese_gb'] = array('Chinese traditional','&#20013;&#25991; - &#32321;&#39636;','cn');
