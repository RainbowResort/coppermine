...
<table align="center" width="$width" cellspacing="1" cellpadding="0" class="maintable">
        ...
        <tr>
                <td class="tableb_compact" width="17%" align="center"><a href="{RATE0}" title="{RUBBISH}" class="nobg"><img src="themes/fruity/images/rating0.gif" alt="{RUBBISH}" border="0" alt="" /></a><br /></td>
                <td class="tableb_compact" width="17%" align="center"><a href="{RATE1}" title="{POOR}" class="nobg"><img src="themes/fruity/images/rating1.gif" alt="{POOR}" border="0" alt="" /></a><br /></td>
                <td class="tableb_compact" width="17%" align="center"><a href="{RATE2}" title="{FAIR}" class="nobg"><img src="themes/fruity/images/rating2.gif" alt="{FAIR}" border="0" alt="" /></a><br /></td>
                <td class="tableb_compact" width="17%" align="center"><a href="{RATE3}" title="{GOOD}" class="nobg"><img src="themes/fruity/images/rating3.gif" alt="{GOOD}" border="0" alt="" /></a><br /></td>
