...
$template_image_rating = <<<EOT
        ...
        <tr>
                <td class="tableb_compact" width="17%" align="center"><a href="{RATE0}" title="{RUBBISH}"><img src="themes/mac_ox_x/images/rating0.gif" alt="{RUBBISH}" border="0" alt="" /><br /></a></td>
                <td class="tableb_compact" width="17%" align="center"><a href="{RATE1}" title="{POOR}"><img src="themes/mac_ox_x/images/rating1.gif" alt="{POOR}" border="0" alt="" /><br /></a></td>
                <td class="tableb_compact" width="17%" align="center"><a href="{RATE2}" title="{FAIR}"><img src="themes/mac_ox_x/images/rating2.gif" alt="{FAIR}" border="0" alt="" /><br /></a></td>
                <td class="tableb_compact" width="17%" align="center"><a href="{RATE3}" title="{GOOD}"><img src="themes/mac_ox_x/images/rating3.gif" alt="{GOOD}" border="0" alt="" /><br /></a></td>
                <td class="tableb_compact" width="17%" align="center"><a href="{RATE4}" title="{EXCELLENT}"><img src="themes/mac_ox_x/images/rating4.gif" alt="{EXCELLENT}" border="0" alt="" /><br /></a></td>
                <td class="tableb_compact" width="17%" align="center"><a href="{RATE5}" title="{GREAT}"><img src="themes/mac_ox_x/images/rating5.gif" alt="{GREAT}" border="0" alt="" /><br /></a></td>
        </tr>
