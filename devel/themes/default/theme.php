...
function pagefooter()
{
	...
	global $USER, $USER_DATA, $ALBUM_SET, $CONFIG, $time_start, $query_stats;
	...
	if ($CONFIG['debug_mode']) {
		...
		$GROUP_SET = USER_GROUP_SET;

		starttable('100%', 'Debug info');
		echo "<tr><td class=\"tableb\">";
		echo "USER: <pre>";
		print_r($USER);
		echo "</pre></td></tr><tr><td class=\"tableb\">";
		echo "USER_DATA :<pre>";
		print_r($USER_DATA);
		echo "</pre></td></tr><tr><td class=\"tableb\">";
		echo "GET :<pre>";
		...
		echo "</pre></td></tr><tr><td class=\"tableb\" align=\"center\">";
		echo <<<EOT
		Page generated in <b>$time</b> seconds - <b>$query_count</b> queries in <b>$total_query_time</b> seconds - Album set : $ALBUM_SET - Group set : $GROUP_SET
EOT;
		echo "</td></tr>";
		endtable();
	}
