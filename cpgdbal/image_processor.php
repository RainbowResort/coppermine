...
/*************************
  ...
  ********************************************
  ...
  $HeadURL: https://coppermine.svn.sourceforge.net/svnroot/coppermine/trunk/cpg1.5.x/image_processor.php $
  $Revision: 5129 $
...
function make_form($next_form_action, $path_to_preview_image, $path_to_primary_image, $file_name) {
	...
	if ($superCage->post->keyExists('degrees')) {
	
			// Display initial form.
	
			// First, we must capture all the data sent to us by upload.php.
	
			$event    = $superCage->post->getAlpha('event');
	...
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
			...
			make_form($CPG_PHP_SELF, $path_to_preview_image, $path_to_primary_image, $file_name);
			...
			$degrees  = $superCage->post->getRaw('degrees');
			$event    = $superCage->post->getRaw('event');
			$path_to_primary_image = $superCage->post->getRaw('transitory_image_path');
			$path_to_preview_image = $superCage->post->getRaw('preview_image_path');
	...
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
			...
			if ($degrees == "no") {
					...
					make_form($CPG_PHP_SELF, $path_to_preview_image, $path_to_primary_image, $transitory_file_name);
