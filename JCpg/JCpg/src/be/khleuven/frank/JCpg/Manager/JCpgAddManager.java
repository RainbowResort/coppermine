...
/**
 * 
 * This class will take care of all the actions when the user clicks on the + button. First we will determine which node is selected in the tree, determine the type of this node and then
