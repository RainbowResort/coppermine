...
------Text of original readme file ends here---------------------------
ADDED for packaging as coppermine icon folder:
The icons in this package have been renamed to be used with the software
Coppermine Photo Gallery, version cpg1.5.x. 
The package has been bundled by Joachim Müller. A few icons have been composed
based on existing ones. 
Most icons had to be renamed to match the naming scheme of coppermine. Other than that,
the full credits go to the original author David Vignoni.