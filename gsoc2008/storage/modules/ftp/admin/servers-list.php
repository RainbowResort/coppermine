...
starttable('100%', $lang_admin_php['storage_servers_admin_ftp_servers'], 1);

$result = cpg_db_query("SELECT * FROM {$CONFIG['TABLE_FTP_SERVERS']}");
...
print "
    <tr>
        <td class=\"tableb\">
          <a href='admin-storage-servers.php?module=ftp&action=add_edit_delete'>".$lang_admin_php['storage_servers_add_new']."</a>
        </td>
    </tr>
";
