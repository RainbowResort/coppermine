...
// admin + confguation				
    ...
    $pic_link['link_locate'] = 'Den Link in der Tabelle mit den Bildinformationen zeigen';
	...
	$pic_link['link_title'] = 'In voller Größe in einem neuen Fenster öffnen'; 
	$pic_link['link_save_title'] = 'Bild in voller Größe abspeichern'; 
	$pic_link['link_text'] = 'Download-Link'; 
