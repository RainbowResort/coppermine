...
if (file_exists("./plugins/photo_summary/lang/{$CONFIG['lang']}.php")) {
  require "./plugins/photo_summary/lang/{$CONFIG['lang']}.php";
} else {require "./plugins/photo_summary/lang/english.php";}
?>