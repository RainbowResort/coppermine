...
$extra_info = <<<EOT
    ...
    <a href="http://forum.coppermine-gallery.net/index.php/topic,58638.0.html" title="&laquo;{$lang_plugin_moncalb['config_name']}&raquo; - {$lang_plugin_moncalb['announcement_thread']}" rel="external" class="admin_menu">{$moncal_icon_array['announcement']}{$lang_plugin_moncalb['announcement_thread']}</a>&nbsp;
