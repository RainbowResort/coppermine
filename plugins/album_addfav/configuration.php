...
$extra_info = $install_info = '<a href="http://forum.coppermine-gallery.net/index.php/topic,57565.0.html" rel="external" class="admin_menu">'.cpg_fetch_icon('announcement', 1).'Announcement thread for '.$name.' plugin</a>';
?>
