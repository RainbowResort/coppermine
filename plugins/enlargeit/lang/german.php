...
$lang_plugin_enlargeit['format_explain'] = 'Wähle die Dateiformate, auf die das EnlargeIt!-Plugin angewendet werden soll. Alle anderen Datei-Formate (falls in Deiner Galerie vorhanden) werden durch die "normalen" Coppermine-Mechanismen angezeigt. Diese Option legt also NICHT fest, welche Art von Dateien hochgeladen werden kann; stattdessen wird das in den Coppermine-Einstellungen festgelegt.';
$lang_plugin_enlargeit['press_ctrl_to_select_multiple_rows'] = 'Halte die [Strg]-Tase gedrückt, um mehrere Zeilen zu selektieren.';
$lang_plugin_enlargeit['asterisk_explain'] = 'Die mit einem Asterisk (*) markierten Zeilen verweisen auf Datei-Formate, die in den Coppermine-Einstellungen nicht aktiviert sind, so dass sie höchstwahrscheinlich nicht in Deiner Galerie vorhanden sind.';
