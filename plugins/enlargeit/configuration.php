...
$configuration_link = '<a href="index.php?file=enlargeit/admin" title="Configure EnlargeIt!" class="admin_menu">'.$enlargeit_icon_array['configure'].'EnlargeIt! Configuration</a>';
