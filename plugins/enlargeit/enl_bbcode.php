...
if ($isie) echo '<br /><input type="button" value="'.$lang_plugin_enlargeit['enl_copytoclipbrd'].'" onclick="window.clipboardData.setData(\'Text\', \''.$img_url.'\');">';
echo '</td></tr>';
...
if ($isie) echo '<br /><input type="button" value="'.$lang_plugin_enlargeit['enl_copytoclipbrd'].'" onclick="window.clipboardData.setData(\'Text\', \''.$name_url.'\');">';
echo '</td>';
echo '</tr>';
echo '</table>';
