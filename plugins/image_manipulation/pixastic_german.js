...
function im_afterload()
{
 ...
 im_btn.innerHTML = '<input value="Originalbild" class="admin_menu" type="button" onclick="im_reset();">';
 im_btn.innerHTML += ' <input value="S/W" onclick="im_isbw = (im_isbw) ? 0 : 1; if (im_isbw) '+changestate;
 im_btn.innerHTML += ' <input value="Heller" onclick="im_lightval = (im_lightval > 10) ? 10 : im_lightval+2; im_setit();" class="admin_menu" type="button">';
 im_btn.innerHTML += ' <input value="Dunkler" onclick="im_lightval = (im_lightval < -8) ? -8 : im_lightval-2; im_setit();" class="admin_menu" type="button">';
 im_btn.innerHTML += ' <input value="Spiegeln vert" onclick="im_isflipv = (im_isflipv) ? 0 : 1; if (im_isflipv) '+changestate;
 im_btn.innerHTML += ' <input value="Spiegeln hori" onclick="im_isfliph = (im_isfliph) ? 0 : 1; if (im_isfliph)'+changestate;
 im_btn.innerHTML += ' <input value="Negativ" onclick="im_isinvert = (im_isinvert) ? 0 : 1; if (im_isinvert) '+changestate;
 im_btn.innerHTML += ' <input value="Relief" onclick="im_isemboss = (im_isemboss) ? 0 : 1; if (im_isemboss)  '+changestate;
 im_btn.innerHTML += ' <input value="Weichzeichnen" onclick="im_isblur = (im_isblur) ? 0 : 1; if (im_isblur)  '+changestate;
