...
$lang_plugin_im['description'] = 'Allows the visitor to non-destructively manipulate the image. Depending on the plugin configuration, changes will be reflected in the URL as well as saved in a cookie of the visitor\'s browser';
$lang_plugin_im['install_info'] = 'You may configure the plugin after installation using the button on the plugin manager.';
...
$lang_plugin_im['im_documentation'] = 'Image Manipulation documentation';
