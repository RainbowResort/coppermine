...
function mp4_player_other_media($pic_html) {
    ...
    if ($CURRENT_PIC_DATA['extension'] == "mp4") {
        ...
        $new_html = "<embed type=\"{$CURRENT_PIC_DATA['mime']}\" width=\"{$CURRENT_PIC_DATA['pwidth']}\" height=\"{$CURRENT_PIC_DATA['pheight']}\" allowfullscreen=\"true\" src=\"plugins/mp4_player/player.swf\" flashvars=\"file=$file&image=$thumb&autostart=$autostart\" />";
