...
$lang_plugin_limit_upload['announcement_thread'] = 'Local da discussão';
$lang_plugin_limit_upload['limit_reached_x'] = 'Atingiu o limite máximo de envios %s files %s.';
$lang_plugin_limit_upload['limit_reached_wait'] = 'Deve esperar %s %s antes de enviar outra foto.';
