...
$extra_info = $install_info = '<a href="http://forum.coppermine-gallery.net/index.php/topic,65868.0.html" rel="external" class="admin_menu">'.cpg_fetch_icon('announcement', 1).$lang_plugin_limit_upload['announcement_thread'].'</a>';
