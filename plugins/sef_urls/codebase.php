...
function sef_urls_convert($html) {
    ...
    // Rewrite displayimage.php?album=[album]&cat=[category]&pid=[pid] URLs to displayimage-[album]-[category]-[pid].html
    $html = preg_replace('/displayimage\.php\?album=([a-z0-9]+)(\&|\&amp;)cat=([\-0-9]+)(\&|\&amp;)pid=([\-0-9]+)/i','displayimage-$1-$3-$5.html',$html);

    // Rewrite displayimage.php?album=[album]&pid=[pid] URLs to displayimage-[album]-[pid].html
    $html = preg_replace('/displayimage\.php\?album=([a-z0-9]+)(\&|\&amp;)pid=([\-0-9]+)/i','displayimage-$1-$3.html',$html);

    // Rewrite displayimage.php?pid=[pid] URLs to displayimage-[pid].html
    $html = preg_replace('/displayimage\.php\?pid=([0-9]+)/i','displayimage-$1.html',$html);
