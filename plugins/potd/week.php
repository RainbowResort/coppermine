...
/**
* Coppermine Photo Gallery 1.4.x week.php
*
    ...
    <table width="378px" height="410px" border="0" cellpadding="0" cellspacing="0" align="center">
      <tr>
        <td align="center">
          ...
          <br />
          <a href="{$CONFIG['path_to']}thumbnails.php?album=potwarch">{$lang_meta_album_names['potwarch']}</a><br />
        </td>
      </tr>
    </table>
...
if (!$CONFIG['path_to']) { pageheader('Photo of the Week'); }
print $content;
