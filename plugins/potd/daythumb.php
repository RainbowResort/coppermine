...
/**
* Coppermine Photo Gallery 1.4.x daythumb.php
*
* This file can be called using an iframe into any other page
*
*/

define('DAYTHUMB_PHP', true);
...
EOT;
  ...
  $content .= <<< EOT
    <table>
      <tr>
        <td align="center">
          <a href="{$CONFIG['path_to']}plugins/potd/day.php" target="new">$img</a><br />
          <br />
          {$lang_meta_album_names['potd']}<br />
          ...
          <br />
          <a href="{$CONFIG['path_to']}thumbnails.php?album=potdarch" target="new">{$lang_meta_album_names['potdarch']}</a>
        </td>
      </tr>
    </table>
