...
$lang_plugin_thumb_rotate['resources_warning'] = 'The rotated thumbnails get cached in the folder %s. Despite of that, this plugin is a CPU hog and shouldn\'t be used with large galleries or on slow servers. If you experience performance issues, turn this plugin off! Consider this plugin to be in beta status only.';
...
$lang_plugin_thumb_rotate['option_maxrotation'] = 'Maximum rotation';
...
$lang_plugin_thumb_rotate['in_pixels'] = 'in pixels';
$lang_plugin_thumb_rotate['submit_to_install'] = 'Submit this form to install the plugin';
$lang_plugin_thumb_rotate['author'] = 'Created by %s, internationalization and config screen by %s';
