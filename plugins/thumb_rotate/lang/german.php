...
$lang_plugin_thumb_rotate['cache_write_access_ok'] = 'Erfolgreich: das temporäre Thumbnail-Verzeichnis %s ist beschreibbar.';
$lang_plugin_thumb_rotate['cache_write_access_failed'] = 'Fehlschlag: das temporäre Thumbnail-Verzeichnis %s ist nicht beschreibbar für Coppermine oder existiert nicht. Sorge dafür, dass das Verzeichnis existiert und setze entsprechende Schreibrechte auf Dateisystem-Ebene.';
$lang_plugin_thumb_rotate['continue_anyway'] = 'Trotzdem weitermachen';
$lang_plugin_thumb_rotate['option_maxrotation'] = 'Maximaler Drehwinkel';
...
$lang_plugin_thumb_rotate['in_pixels'] = 'in Pixeln';
$lang_plugin_thumb_rotate['submit_to_install'] = 'Sende dieses Formular ab, um das Plugin zu installieren';
$lang_plugin_thumb_rotate['author'] = 'Erzeugt durch %s, Internationalisierung und Einstellungs-Dialog durch %s, colorpicker jQuery Plugin &quot;Farbtastic&quot; von %s';
...
$lang_plugin_thumb_rotate['empty_cache'] = 'Temporäres Verzeichnis (Cache) leeren?';
$lang_plugin_thumb_rotate['files'] = '%s Dateien';
?>