...
$extra_info = <<<EOT
    ...
    <a href="http://forum.coppermine-gallery.net/index.php/topic,57468.0.html" title="&laquo;{$lang_plugin_thumb_rotate['config_name']}&raquo; - {$lang_plugin_thumb_rotate['announcement_thread']}" class="admin_menu external">{$thumb_rotate_icon_array['announcement']}{$lang_plugin_thumb_rotate['announcement_thread']}</a>
EOT;
