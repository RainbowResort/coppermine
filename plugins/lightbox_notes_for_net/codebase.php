...
function lightbox_notes_for_net_header($meta) {
    global $CONFIG, $CPG_PHP_SELF, $JS, $THEME_DIR, $lang_plugin_lightbox_notes_for_net;
    if ($CPG_PHP_SELF == 'displayimage.php') {		
        ...
        set_js_var('config_slideshow_interval', $CONFIG['slideshow_interval']);
        ...
        if ($CONFIG['plugin_lightbox_nfn_buttonset'] == '1') {
            ...
            set_js_var('plugin_lightbox_nfn_image_btnnext', $theme_navbar_folder . 'images/navbar/right.png');
            set_js_var('plugin_lightbox_nfn_image_btnclose', $theme_navbar_folder . 'images/navbar/close.png');
            set_js_var('plugin_lightbox_nfn_image_btnbottomprev', $theme_navbar_folder . 'images/navbar/left.png');
            set_js_var('plugin_lightbox_nfn_image_btnbottomnext', $theme_navbar_folder . 'images/navbar/right.png');
            set_js_var('plugin_lightbox_nfn_image_btnplay', $theme_navbar_folder . 'images/navbar/slideshow.png');
            set_js_var('plugin_lightbox_nfn_image_btnstop', $theme_navbar_folder . 'images/navbar/cancel.png');
        }
...
function lightbox_notes_for_net_install() {
    ...
    cpg_db_query("INSERT IGNORE INTO {$CONFIG['TABLE_CONFIG']} (`name`, `value`) VALUES ('plugin_lightbox_nfn_buttonset', '0')");
    return true;
}
