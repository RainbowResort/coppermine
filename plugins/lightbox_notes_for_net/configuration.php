...
$documentation_link = '<a href="plugins/lightbox_notes_for_net/docs/{$documentation_file}.htm" class="admin_menu greybox">' . $lightbox_notes_for_net_icon_array['documentation'] . $lang_plugin_lightbox_notes_for_net['plugin_documentation'] . '</a> ';
