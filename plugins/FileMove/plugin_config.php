...
starttable('100%', $lang_plugin_FileMove['display_name'].' - v'.$lang_plugin_FileMove['version'].'    '.'<a href="pluginmgr.php" class="admin_menu">' . $lang_gallery_admin_menu['pluginmgr_lnk'] . '</a>',2);
//if(isset($selection)){
    switch($selection){
        case "ok":
