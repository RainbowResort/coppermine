...
/**************************************************
  ...
  ********************************************
  $HeadURL: https://coppermine.svn.sourceforge.net/svnroot/coppermine/branches/cpg1.5.x/plugins/xfeed/configuration.php $
  $Revision: 6989 $
...
pageheader($lang_xfeeds['display_name']);starttable('100%', $lang_xfeeds['main_title'].' - '.$lang_xfeeds['version'].'<font size=1 color=red> by <a href="http://adityamooley.net">Aditya</font> - <a href="pluginmgr.php" class="admin_menu">'.$lang_xfeeds['pluginmanager'].'</a>', 3);

echo $xfdchk_row['name'];
?>

<TR>
  <TD class="tableh2" colSpan="3" onClick="show_section('section1')"><SPAN style="CURSOR: pointer"><IMG title="Config" height=9 alt="" src="images/descending.gif" width=9 border=0> <strong><?php echo $lang_xfeeds['main_title']?></strong></SPAN> </TD>
</TR>
<TR>
  <td><form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="xfeeds_settings">
      <table class="maintable" cellSpacing="2" cellPadding="2" width="100%" align="<?php echo $align; ?>" border="0" id="section1">
        ...
        <tr>
          <td>&nbsp;</td>
          <td align="left"><input name="Submit" type="submit" value="<?php echo $lang_xfeeds['submit_button']; ?>" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td align="center">&nbsp;</td>
