...
//basically this is a a copy of register.php with following changes
//for the photoshop we ALWAYS HAVE TO allow registration -> disabling config entry for this registration page
//set active always to yes for this reg page
//disabled all confirmation checkboxes and mails to users for this reg page
//added a function that auto logs on the user after registration and continues in the checkout
//added a login form --> it's using the function in login.php and redirects here... but if logged on this page redirects to checkout
//basically this should work with a bridged coppermine, but not the auto logon and not the login page -> then this need changes
//like 2 links 1-> link to forum signup page
//2 -> link to forum login page
...
function input_user_info($errors = '')
{
    ...
    global $lang_register_php, $lang_login_php, $REFERER, $lang_photoshop_register;

	starttable ("100%", "Checkout", 2);
	echo "<tr><td width=\"67%\">";

    starttable("100%", $lang_register_php['enter_info'], 2);
    echo <<<EOT
        <form method="post" action="{$_SERVER['PHP_SELF']}?file=photo_shop/photo_shop_register">
...
EOT;
	...
	starttable("100%%", $lang_photoshop_register['already_member']);
...
<table>
                  ...
                  <tr>
                    <td colspan="2" align="center" class="tableb"><input name="remember_me" type="hidden" class="checkbox" value="1" tabindex="3" /></td>
                  </tr>
                  <tr>
