...
function slid_addLoad(slid_func) { var slid_oldonload = window.onload; if (typeof window.onload != 'function') { window.onload = slid_func; } else { window.onload = function() { if (slid_oldonload) { slid_oldonload(); } slid_func(); }; } }

function cpgslideplug_fillup()
{
	slid_usecookies      = parseInt(js_vars.slid_usecookies);
	slideshowgap = 2;
