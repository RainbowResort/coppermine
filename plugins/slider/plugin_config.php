...
if(isset($_POST['update'])){
  ...
  $slider_numberofpics = $_POST['slider_numberofpics'];
  $slider_speed = $_POST['slider_speed'];
  $slider_bgcolor = $_POST['slider_bgcolor'];
  $slider_album = $_POST['slider_album'];
  $slider_skipportrait = $_POST['slider_skipportrait'];
  $slider_align = $_POST['slider_align'];
  $slider_useenlarge = $_POST['slider_useenlarge'];
  $slider_pictype = $_POST['slider_pictype'];
  $slider_autowidth = $_POST['slider_autowidth'];
  ...
  cpg_db_query($s); 
    ...
    msg_box($lang_plugin_slider['display_name'], $lang_plugin_slider['update_success'], $lang_continue, 'index.php');
  pagefooter();
        exit;
...
<?php
starttable('100%', $lang_plugin_slider['main_title'].' - '.$lang_plugin_slider['version'].'<font size=1 color=red> by <a href="http://www.timos-welt.de">Timos-Welt</font> - <a href="pluginmgr.php" class="admin_menu">'.$lang_plugin_slider['pluginmanager'].'</a>', 3);
?>
