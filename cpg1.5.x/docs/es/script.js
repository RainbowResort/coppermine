...
doc_toc += '<h6>Tabla de contenidos (<a href="../index.htm" class="en">Selección de idioma</a>)</h6>\n';
doc_toc += '<ul id="tree" class="en">\n';
doc_toc += '  <li><a href="index.htm" class="en">Documentación de Coppermine</a>\n';
doc_toc += '    <ul>\n';
doc_toc += '      <li><a href="index.htm#about" class="en">Sobre Coppermine</a></li>\n';
doc_toc += '      <li><a href="index.htm#about_documentation" class="en">Sobre la documentación</a>\n';
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="index.htm#about_documentation_conventions" class="en">Convención sobre la documentación</a></li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="index.htm#features" class="en">Características</a></li>\n';
...
doc_toc += '          <li><a href="languages.htm#how" class="en">Cómo funcionan los idiomas en Coppermine</a></li>\n';
...
doc_toc += '    </ul>\n';
doc_toc += '  </li>\n';
doc_toc += '  <li><a href="install.htm" class="en">Instalación y puesta en funcionamiento</a>\n';
doc_toc += '    <ul>\n';
doc_toc += '      <li><a href="install.htm#how" class="en">Cómo instalar el script</a></li>\n';
doc_toc += '      <li><a href="install.htm#what" class="en">Qué hace el instalador</a></li>\n';
...
doc_toc += '                  <li><a href="install_permissions.htm#chmod_groups" class="en">Grupos en Lunix</a></li>\n';
doc_toc += '                  <li><a href="install_permissions.htm#chmod_daemon" class="en">El servicio del Webserver</a></li>\n';
doc_toc += '                  <li><a href="install_permissions.htm#chmod_binary_arithmetics" class="en">Aritm´ñetica binaria</a></li>\n';
doc_toc += '                  <li><a href="install_permissions.htm#chmod_benefit" class="en">¿Para qué es bueno esto?</a></li>\n';
...
doc_toc += '          <li><a href="install_screen.htm#install_screen_wizard" class="en">El sistente de instalación</a></li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
...
doc_toc += '    </ul>\n';
doc_toc += '  </li>\n';
doc_toc += '  <li><a href="upgrading.htm" class="en">Actualizar la versión</a>\n';
doc_toc += '    <ul>\n';
doc_toc += '      <li><a href="upgrading.htm#upgrade_why" class="en">¿Por qué actualizar?</a>\n';
doc_toc += '          <ul>\n';
doc_toc += '              <li><a href="upgrading.htm#upgrade_why_reasons" class="en">Motivos para sacar paquetes de actualización</a></li>\n';
doc_toc += '              <li><a href="upgrading.htm#upgrade_why_changelog" class="en">Log de cambios (Changelog)</a></li>\n';
doc_toc += '          </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="upgrading.htm#upgrade_any" class="en">Pasos necesarios para subir de versión Coppermine (para cualquier versión)</a></li>\n';
doc_toc += '      <li><a href="upgrading.htm#upgrade_particular" class="en">Acciones adicionales para algunas versiones</a>\n';
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="upgrading.htm#upgrade_10" class="en">Actualizar desde las versiones cpg1.0,1.1,1.2.x or 1.3.x</a></li>\n';
doc_toc += '          <li><a href="upgrading.htm#upgrade_14" class="en">Actualizar desde cpg1.4.x a la versión cpg1.5.x</a></li>\n';
doc_toc += '          <li><a href="upgrading.htm#upgrade_15" class="en">Actualizar desde versiones cpg1.5.x to a la más reciente</a></li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="upgrading.htm#updater" class="en">El script de actualización</a>\n';
doc_toc += '          <ul>\n';
doc_toc += '              <li><a href="upgrading.htm#updater_what_it_does" class="en">Qué hace</a></li>\n';
doc_toc += '              <li><a href="upgrading.htm#updater_purpose" class="en">Propósito</a></li>\n';
doc_toc += '              <li><a href="upgrading.htm#updater_authorization" class="en">Comprobaciones de autorización</a></li>\n';
doc_toc += '              <li><a href="upgrading.htm#updater_when" class="en">¿Cuándo se debe ejecutar el \'actualizador\'?</a></li>\n';
doc_toc += '          </ul>\n';
doc_toc += '      </li>\n';
...
doc_toc += '          <li><a href="upgrading.htm#versioncheck_options_start" class="en">Opciones</a></li>\n';
doc_toc += '          <li><a href="upgrading.htm#versioncheck_comparison_start" class="en">Comparación de versiones</a></li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
...
doc_toc += '    <ul>\n';
doc_toc += '      <li><a href="faq.htm#faq_setup" class="en">Puesta en marcha / Configuración</a></li>\n';
doc_toc += '      <li><a href="faq.htm#hacks" class="en">Añadidos / Modificaciones / Hacks</a></li>\n';
doc_toc += '      <li><a href="faq.htm#support_board" class="en">Consejo de soporte de Coppermine (Coppermine Support board)</a></li>\n';
doc_toc += '    </ul>\n';
doc_toc += '  </li>\n';
...
doc_toc += '          </ul>\n';
doc_toc += '        </li>\n';
doc_toc += '        <li><a href="theme_upgrade_13x-14x.htm" class="en">Conversión de temas cpg1.3.x a cpg1.4.x</a>\n';
doc_toc += '          <ul>\n';
doc_toc += '            <li><a href="theme_upgrade_13x-14x.htm#style" class="en">Edita style.css</a></li>\n';
doc_toc += '            <li><a href="theme_upgrade_13x-14x.htm#template" class="en">Edita template.html</a></li>\n';
doc_toc += '            <li><a href="theme_upgrade_13x-14x.htm#theme" class="en">Edita theme.php</a></li>\n';
doc_toc += '            <li><a href="theme_upgrade_13x-14x.htm#validation" class="en">Metodología de validación</a></li>\n';
doc_toc += '          </ul>\n';
doc_toc += '        </li>\n';
doc_toc += '      </ul>\n';
doc_toc += '      </li>\n';
...
doc_toc += '          <li><a href="theme_create_matching_page_tutorial.htm#theme_matching" class="en">Crear un tema Coppermine que combine con el diseño general de tu sitio</a></li>\n';
doc_toc += '          <li><a href="theme_template.htm#theme_template_html" class="en">Editar template.html</a>\n';
doc_toc += '            <ul>\n';
doc_toc += '              <li><a href="theme_template.htm#theme_template_token" class="en">Tokens del modelo</a></li>\n';
doc_toc += '              <li><a href="theme_template.htm#theme_template_important" class="en">Importante</a></li>\n';
...
doc_toc += '          <li><a href="admin_menu.htm#" class="en">Estadísticas generales</a></li>\n';
...
doc_toc += '          <li><a href="admin_menu.htm#" class="en">Modo de administración para usuarios regulares</a></li>\n'; //Jmatute: pendiente
...
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="configuration.htm" class="en">Configuración</a>\n';
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="configuration.htm#admin_general" class="en">Configuración general</a></li>\n';
...
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="users.htm#user_cp" class="en">Panel de control de usuarios</a></li>\n';
doc_toc += '          <li><a href="users.htm#user_cp_page" class="en">Controles de la página</a></li>\n'; //Jmatute: pendiente
doc_toc += '          <li><a href="users.htm#user_cp_search" class="en">Buscando usuarios</a></li>\n';
doc_toc += '          <li><a href="users.htm#user_cp_new" class="en">Crear nuevos</a></li>\n';
doc_toc += '          <li><a href="users.htm#user_cp_edit" class="en">Editar usuarios</a></li>\n';
doc_toc += '          <li><a href="users.htm#user_cp_group" class="en">Asignación de grupos</a></li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
...
doc_toc += '            <ul>\n';
doc_toc += '              <li><a href="plugins.htm#plugin_manager_upload" class="en">Subiendo un plugin</a></li>\n';
doc_toc += '              <li><a href="plugins.htm#plugin_manager_install" class="en">Instalar un plugin</a></li>\n';
doc_toc += '              <li><a href="plugins.htm#plugin_manager_configuration" class="en">Configuración de un plugin</a></li>\n';
...
doc_toc += '          <li><a href="dev_subversion.htm#dev_subversion_repository_structure" class="en">Repository structure</a></li>\n';
...
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
doc_toc += '          <li><a href="dev_subversion.htm#dev_subversion_download" class="en">Is there no single package that I could download instead?</a></li>\n';
...
function cpgDocSearch() {
	...
	doc_search += '    </form>\n';
	doc_search += '    <script type="text/javascript" src="http://www.google.com/coop/cse/brand?form=cse-search-box&lang=es"></script>\n';
	doc_search += '  </div>\n';
