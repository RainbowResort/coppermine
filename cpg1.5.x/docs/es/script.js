...
doc_toc += '          <li><a href="credits.htm#acknowledgements" class="en">Reconocimientos</a></li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
...
doc_toc += '      <li><a href="install.htm#install_server_config" class="es">Configuración del servidor</a></li>\n';
...
doc_toc += '    </ul>\n';
doc_toc += '  </li>\n';
doc_toc += '  <li><a href="upgrading.htm" class="es">Actualizar la versión</a>\n';
doc_toc += '    <ul>\n';
...
doc_toc += '          </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="upgrading.htm#versioncheck" class="es">Herramienta de comprobación de versiones</a>\n';
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="upgrading.htm#versioncheck_description_start" class="es">Qué hace</a></li>\n';
doc_toc += '          <li><a href="upgrading.htm#versioncheck_first_run" class="es">Primera ejecución</a></li>\n';
doc_toc += '          <li><a href="upgrading.htm#versioncheck_options_start" class="es">Opciones</a>\n';
doc_toc += '              <ul>\n';
doc_toc += '                  <li><a href="upgrading.htm#versioncheck_options_display_output" class="es">Salida</a></li>\n';
doc_toc += '                  <li><a href="upgrading.htm#versioncheck_options_only_show_potential_errors" class="es">Mostrar sólo los posibles errores</a></li>\n';
doc_toc += '                  <li><a href="upgrading.htm#versioncheck_options_hide_images" class="es">Ocultar imágenes</a></li>\n';
doc_toc += '                  <li><a href="upgrading.htm#versioncheck_options_no_modification_check" class="es">No comprobar los ficheros modificados</a></li>\n';
doc_toc += '                  <li><a href="upgrading.htm#versioncheck_options_no_connect_online_repository" class="es">No conectar al repositorio online</a></li>\n';
doc_toc += '              </ul>\n';
doc_toc += '          </li>\n';
doc_toc += '          <li><a href="upgrading.htm#versioncheck_comparison_start" class="es">Salida de la comprobación</a>\n';
doc_toc += '              <ul>\n';
doc_toc += '                  <li><a href="upgrading.htm#versioncheck_comparison_path" class="es">Ruta</a></li>\n';
doc_toc += '                  <li><a href="upgrading.htm#versioncheck_comparison_missing" class="es">Falta</a></li>\n';
doc_toc += '                  <li><a href="upgrading.htm#versioncheck_comparison_permissions" class="es">Permisos</a></li>\n';
doc_toc += '                  <li><a href="upgrading.htm#versioncheck_comparison_version" class="es">Versión</a></li>\n';
doc_toc += '                  <li><a href="upgrading.htm#versioncheck_comparison_revision" class="es">Revisión</a></li>\n';
doc_toc += '                  <li><a href="upgrading.htm#versioncheck_comparison_modified" class="es">Modificado</a></li>\n';
doc_toc += '                  <li><a href="upgrading.htm#versioncheck_comparison_comment" class="es">Comentario</a></li>\n';
doc_toc += '                  <li><a href="upgrading.htm#versioncheck_comparison_repository_link" class="es">Enlace al repositorio</a></li>\n';
doc_toc += '              </ul>\n';
doc_toc += '          </li>\n';
doc_toc += '          <li><a href="upgrading.htm#versioncheck_problems" class="es">Qué podría fallar al usar versioncheck</a></li>\n';
doc_toc += '          <li><a href="upgrading.htm#versioncheck_expect" class="es">Falsas expectativas</a></li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="upgrading.htm#upgrade_faq" class="es">FAQ del cambio de versión</a></li>\n';
doc_toc += '      <li><a href="upgrading.htm#downgrading" class="es">Volver desde cpg1.5.x a una versión anterior</a></li>\n';
doc_toc += '    </ul>\n';
doc_toc += '  </li>\n';
