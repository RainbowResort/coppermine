...
doc_toc += '          </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="upgrading.htm#upgrade_any" class="en">Pasos necesarios para subir la versión de Coppermine (para cualquier versión)</a></li>\n';
doc_toc += '      <li><a href="upgrading.htm#upgrade_particular" class="en">Acciones adicionales para algunas versiones</a>\n';
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="upgrading.htm#upgrade_10" class="en">Actualizar desde las versiones cpg1.0,1.1,1.2.x or 1.3.x a cpg1.5.x</a></li>\n';
doc_toc += '          <li><a href="upgrading.htm#upgrade_14" class="en">Actualizar desde cpg1.4.x a cpg1.5.x</a></li>\n';
...
doc_toc += '              <li><a href="upgrading.htm#updater_authorization" class="en">Permisos de ejecución</a></li>\n';
doc_toc += '              <li><a href="upgrading.htm#updater_when" class="en">¿Cuándo hay que ejecutar la actualización?</a></li>\n';
doc_toc += '          </ul>\n';
doc_toc += '      </li>\n';
...
doc_toc += '          <li><a href="upgrading.htm#versioncheck_comparison_start" class="en">Resultado de la comprobación</a></li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
