...
d.add(450,420,'Content of a theme','theme.htm#theme_files');
...
d.add(500,420,'Copyright-disclaimer in footer','theme.htm#theme_copyright');
...
d.add(1290,1230,'Upload troubleshooting','uploading.htm#upload_trouble');
