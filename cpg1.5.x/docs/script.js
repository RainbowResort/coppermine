...
d.add(208,130,'Uninstall','uninstall.htm');
...
d.add(1103,560,'Keywords','keywords.htm');
d.add(1104,1103,'Assigning keywords','keywords.htm#keywords_assign');
d.add(1105,1103,'Assigning keywords when uploading','keywords.htm#keywords_assign_upload');
d.add(1106,1103,'Editing/adding keywords','keywords.htm#keywords_assign_edit');
d.add(1107,1103,'Keywords manager','keywords.htm#keywords_manager');
d.add(1108,1103,'Album keywords','keywords.htm#keywords_album');
...
d.add(1225,560,'Admin Tools','admin-tools.htm#admin_tools');
d.add(1227,560,'Errors','errors.htm#errors');
...
d.add(1293,1290,'Asking for support on upload issues','upload_troubleshooting.htm#upload_support');
d.add(1295,1290,'Error messages','upload_troubleshooting.htm#upload_error_messages');
d.add(1296,1290,'Server-sided restrictions','upload_troubleshooting.htm#upload_trouble_server-sided_restrictions');
d.add(1297,1290,'Things to check','upload_troubleshooting.htm#upload_trouble_server-sided_restrictions_check');
...
d.add(1460,1430,'Path(s) used by your bridge app','bridging.htm#bridge_manager_path_start');
d.add(1470,1430,'Bridge-app-specific settings','bridging.htm#bridge_manager_specific_start');
d.add(1480,1430,'Enable/disable bridging','bridging.htm#bridge_manager_enable_start');
d.add(1490,1350,'Recover from failed bridging','bridging.htm#bridge_manager_recover_start');
d.add(1500,1350,'Synchronising the bridge app groups with Coppermine\'s groups','bridging.htm#integrating_steps_sync_start');
d.add(1502,1350,'Bridging support','bridging.htm#integrating_support_start');
d.add(1504,1350,'Some config options get disabled','bridging.htm#integrating_config_options_start');
d.add(1506,1350,'Bridging files','bridging.htm#integrating_files_start');
d.add(1508,1350,'Creating a custom bridge file','bridging.htm#integrating_bridge_file_creating_start');
