...
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="index.htm#about_documentation_conventions" class="en">Documentation Conventions</a></li>\n';
doc_toc += '        <ul>\n';
doc_toc += '      </li>\n';
...
doc_toc += '    </ul>\n';
doc_toc += '  </li>\n';
doc_toc += '  <li><a  href="start.htm"class="us_fr">Démarage</a>\n';
doc_toc += '    <ul>\n';
doc_toc += '      <li><a  href="start.htm#getting_concepts">Concepts de Base</a></li>\n';
doc_toc += '      <li><a  href="start.htm#getting_initial_configuration"class="en">Configuration Initiale</a></li>\n';
doc_toc += '      <li><a  href="start.htm#getting_structure"class="en">Structure des Categories/Albums/Fichiers</a></li>\n';
doc_toc += '      <li><a  href="start.htm#getting_resizing"class="en">Images redimmensionnées</a></li>\n';
doc_toc += '      <li><a  href="start.htm#getting_admin_account"class="en">Votre Compte Administrateur</a></li>\n';
doc_toc += '      <li><a  href="start.htm#getting_check_uploads"class="en">Vérification des téléchargements</a></li>\n';
doc_toc += '      <li><a  href="start.htm#getting_consider_bridging"class="en">Penser à l\'intégration</a></li>\n';
doc_toc += '      <li><a  href="start.htm#getting_interaction"class="en">Qu\'est ce que vos visiteurs sont autorisés à faire ?</a></li>\n';
doc_toc += '      <li><a  href="start.htm#getting_design"class="en">Changez l\'aspect de votre galerie Coppermine</a></li>\n';
doc_toc += '      <li><a  href="start.htm#getting_typical"class="en">Réglages particuliers</a></li>\n';
doc_toc += '    </ul>\n';
doc_toc += '  </li>\n';
