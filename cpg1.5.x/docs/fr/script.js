...
doc_toc += '    </ul>\n';
doc_toc += '  </li>\n';
doc_toc += '  <li><a href="upgrading.htm"class="us_fr">Mise à Jour</a>\n';
doc_toc += '    <ul>\n';
...
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a  href="upgrading.htm#updater"class="en">Le script de mise à jour</a>\n';
doc_toc += '          <ul class="level3" id="updater">\n';
doc_toc += '              <li><a  href="upgrading.htm#updater_what_it_does"class="en">Ce qu\'il fait</a></li>\n';
doc_toc += '              <li><a  href="upgrading.htm#updater_purpose"class="en">Objectif</a></li>\n';
doc_toc += '              <li><a  href="upgrading.htm#updater_authorization"class="en">Vérification des autorisation</a></li>\n';
doc_toc += '              <li><a  href="upgrading.htm#updater_when"class="en">Quand faut\'il lancer le script de mise à jour ?</a></li>\n';
doc_toc += '          </ul>\n';
doc_toc += '      </li>\n';
