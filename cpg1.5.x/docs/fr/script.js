...
d.add(0,-1,'Documentation de Coppermine', '../index.htm');
d.add(100,0,'A Propos de Coppermine','index.htm');
d.add(110,100,'A propos de cette Documentation','index.htm#about_documentation');
//d.add(120,100,'Features','index.htm#features');
//d.add(150,100,'Quick-Start guide','quickstart.htm');
d.add(200,100,'Table des Matières','toc.htm');
d.add(300,100,'Minimum Requis','requirements.htm');
d.add(400,100,'Version Beta (Test)','testing.htm');
d.add(500,100,'Langues','languages.htm');
d.add(600,500,'Guide de Traduction','translation.htm');
...
//d.add(2200,2100,'Why upgrade?','upgrading.htm#upgrade_why');
//d.add(2210,2200,'Reasons for package releases','upgrading.htm#upgrade_why_reasons');
//d.add(2220,2200,'Changelog','upgrading.htm#upgrade_why_changelog');
//d.add(2250,2100,'Necessary upgrading steps (from any version)','upgrading.htm#upgrade_any');
//d.add(2300,2100,'Additional actions for updating from particular versions','upgrading.htm#upgrade_particular');
//d.add(2400,2300,'Upgrading from versions cpg1.0,1.1,1.2.x or 1.3.x','upgrading.htm#upgrade_10');
...
//d.add(3100,2100,'Upgrading FAQ','upgrading.htm#downgrading');
//d.add(3150,2100,'Downgrading from cpg1.5.x to an older version','upgrading.htm#upgrade_faq');
...
//d.add(15505,15500,'Overview of the Coppermine Plugin API','dev_plugin_api.htm#plugin_api_overview');
//d.add(15510,15500,'Plugin Tutorial','dev_plugin_api.htm#plugin_api_tutorial');
//d.add(15515,15500,'Plugin Hooks','dev_plugin_api.htm#plugin_api_hooks');
//d.add(15520,15500,'Plugin Class Properties &amp; Methods','dev_plugin_api.htm#plugin_api_plugin_class');
//d.add(15525,15500,'Global Variables &amp; Constants','dev_plugin_api.htm#plugin_api_globals');
//d.add(15530,15500,'System Global Variables','dev_plugin_api.htm#plugin_api_globals_system');
//d.add(15535,15500,'Coppermine Constants','dev_plugin_api.htm#plugin_api_globals_cpg');
...
function cpgDocHeader() {
  ...
  document.write('<h1>Coppermine Photo Gallery v1.5.0: Manuel et Documentation</h1>');
