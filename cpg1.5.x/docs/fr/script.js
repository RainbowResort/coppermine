...
document.write('          <li><a href="credits.htm#developers">L\'équipe de Coppermine</a></li>');
document.write('          <li><a href="credits.htm#contributors">Contributeurs</a></li>');
document.write('          <li><a href="credits.htm#translators">Traducteurs</a></li>');
document.write('          <li><a href="credits.htm#codebase">Codes libres utilisés</a></li>');
document.write('        </ul>');
document.write('      </li>');
//document.write('      <li><a href="copyrights.htm">License &amp; Copyright</a></li>');
document.write('      <li><a href="known_issues.htm">Problèmes connus</a></li>');
document.write('    </ul>');
document.write('  </li>');
document.write('  <li><a href="install.htm">Installation et Configuration</a>');
document.write('    <ul class="level2" id="install">');
document.write('      <li><a href="install.htm#how">Comment installer le script</a></li>');
document.write('      <li><a href="install.htm#what">Ce que fait l\'installeur</a></li>');
document.write('      <li><a href="install_permissions.htm">Configurer les permissions</a>');
document.write('        <ul class="level3" id="install_permissions">');
document.write('          <li><a href="install_permissions.htm#chmod">Apache sur Unix/Linux (CHMOD)</a></li>');
document.write('          <li><a href="install_permissions.htm#apache_windows">Apache sur Windows</a></li>');
document.write('          <li><a href="install_permissions.htm#iis">IIS sur Windows</a></li>');
document.write('          <li><a href="install_permissions.htm#support">Demander de l\'aide sur les problèmes liés aux permissions</a></li>');
document.write('        </ul>');
document.write('      </li>');
document.write('      <li><a href="install_screen.htm">L\'écran d\'Installation</a></li>');
document.write('      <li><a href="auto-installers.htm">Les Auto-Installeurs</a></li>');
document.write('      <li><a href="install_faq.htm">FAQ d\'Installation</a></li>');
document.write('      <li><a href="uninstall.htm">Désinstallation</a></li>');
document.write('    </ul>');
document.write('  </li>');
document.write('  <li><a href="upgrading.htm">Mise à Jour</a>');
document.write('    <ul class="level2" id="upgrading">');
document.write('      <li><a href="upgrading.htm#upgrade_why">Pourquoi mettre à jour?</a>');
document.write('      	<ul class="level3" id="why_upgrade">');
document.write('      		<li><a href="upgrading.htm#upgrade_why_reasons">Raison de publication de mises à jour par package</a></li>');
document.write('      		<li><a href="upgrading.htm#upgrade_why_changelog">Changelog</a></li>');
document.write('      	</ul>');
document.write('      </li>');
document.write('      <li><a href="upgrading.htm#upgrade_any">Etapes nécessaires pour une mise à jour de Coppermine (depuis n\'importe quelle version)</a></li>');
document.write('      <li><a href="upgrading.htm#upgrade_particular">Etapes supplémentaires pour une mise à jour depuis une version particulière</a>');
document.write('        <ul class="level3" id="upgrade_particular">');
document.write('          <li><a href="upgrading.htm#upgrade_10">Mise à jour depuis les versions cpg1.0,1.1,1.2.x ou 1.3.x</a></li>');
document.write('          <li><a href="upgrading.htm#upgrade_14">Mise à jour depuis cpg1.4.x vers cpg1.5.x</a></li>');
document.write('        </ul>');
document.write('      </li>');
document.write('      <li><a href="upgrading.htm#versioncheck">L\'outil de vérification de version</a>');
document.write('        <ul class="level3" id="versioncheck">');
document.write('          <li><a href="upgrading.htm#versioncheck_description_start">Ce qu\'il fait</a></li>');
document.write('          <li><a href="upgrading.htm#versioncheck_options_start">Options</a></li>');
document.write('          <li><a href="upgrading.htm#versioncheck_comparison_start">Comparaison de version</a></li>');
document.write('        </ul>');
document.write('      </li>');
document.write('      <li><a href="upgrading.htm#upgrade_faq">FAQ de mise à Jour</a></li>');
document.write('      <li><a href="upgrading.htm#downgrading">Retour de cpg1.5.x vers une version antérieurs</a></li>');
document.write('    </ul>');
document.write('  </li>');
...
//document.write('        <ul class="level3" id="dev_plugins">');
...
//document.write('            <ul class="level4" id="plugin_api">');
...
//document.write('            <ul class="level5">');
//document.write('              <li><a href="dev_plugin_hooks.htm#plugin_api_hooks_choosing">Choosing Plugin Hooks</a></li>');
//document.write('              <li><a href="dev_plugin_hooks.htm#plugin_api_hooks_finding">Finding Plugin Hooks</a></li>');
//document.write('              <li><a href="dev_plugin_hooks.htm#plugin_api_hooks_using">Using Plugin Hooks</a></li>');
//document.write('              <li><a href="dev_plugin_hooks.htm#plugin_api_hooks_list">Plugin Hooks Listed</a>');
...
//document.write('                </ul>');
//document.write('              </li>');
//document.write('              <li><a href="dev_plugin_hooks.htm#plugin_api_hooks_alpha">Plugin Hooks Alphabetically</a></li>');
//document.write('            </ul>');
//document.write('          </li>');
//document.write('        </ul>');
//document.write('      </li>');
...
document.write('      <input type="submit" name="sa" value="Chercher dans la Doc" style="font-size:9px;" />');
document.write('    </div>');
document.write('  </form>');
...
function cpgDocFooter() {
  ...
  document.write('<a href="#top">Haut de Page</a>');
  document.write('</div>');
  //cpgDocPrevNext();
}
...
function cpgDocPrevNext() {
  ...
  if(docSections[thisPage]['previous'] != '') {
    document.write('<a href="' + docSections[docSections[thisPage]['previous']]['file'] + '" class="prev_next">&laquo; précédent (' + docSections[docSections[thisPage]['previous']]['name'] + ')</a>&nbsp;&nbsp;&nbsp;');
  }
  if(docSections[thisPage]['next'] != '') {
    document.write('<a href="' + docSections[docSections[thisPage]['next']]['file'] + '" class="prev_next">suivant (' + docSections[docSections[thisPage]['next']]['name'] + ') &raquo;</a>');
  }
  document.write('</div>');
}
