...
doc_toc += '            <li><a href="theme_upgrade_14x-15x.htm#validation">Methode de Validation</a></li>\n';
doc_toc += '          </ul>\n';
doc_toc += '        </li>\n';
...
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="theme_template.htm#theme_template_html" class="en">Modifier  template.html</a>\n';
doc_toc += '              <ul class="level3" id="theme_template_html" class="en">\n';
doc_toc += '                  <li><a href="theme_template.htm#theme_template_token" class="en">balises (tokens) du thème</a></li>\n';
doc_toc += '                  <li><a href="theme_template.htm#theme_template_important" class="en">Important</a></li>\n';
doc_toc += '                  <li><a href="theme_template.htm#theme_template_token_list" class="en">Liste des balises dans template.html</a></li>\n';
doc_toc += '              </ul>\n';
doc_toc += '          </li>\n';
doc_toc += '          <li><a href="theme_style_css.htm#theme_style_css" class="en">Modifier style.css</a>\n';
doc_toc += '            <ul>\n';
doc_toc += '              <li><a href="theme_style_css.htm#theme_style_css_tools" class="en">Outils</a>\n';
doc_toc += '              <li><a href="theme_style_css.htm#theme_style_css_list" class="en">Liste des classes dans style.css</a>\n';
doc_toc += '              <li><a href="theme_style_css.htm#theme_style_css_overall" class="en">Feuilles de style additionnelles</a>\n';
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
doc_toc += '          <li><a href="theme_theme_php.htm#theme_create_theme_php" class="en">Modifier theme.php</a>\n';
...
doc_toc += '                  <li><a href="theme_theme_php.htm" class="en">Le thème sample - un thème pour copier/coller</a></li>\n';
doc_toc += '                  <li><a href="theme_theme_php.htm#theme_php_method" class="en">Méthode</a></li>\n';
doc_toc += '                  <li><a href="theme_theme_php.htm#theme_php_scope" class="en">Scope</a></li>\n';
doc_toc += '                  <li><a href="theme_theme_php.htm#theme_php_list" class="en">Liste des  items dans theme.php</a></li>\n';
...
doc_toc += '          <li><a href="admin_menu.htm#" class="en">Overall stats</a></li>\n';
doc_toc += '          <li><a href="admin_menu.htm#stats" class="en"></a></li>\n';
...
doc_toc += '      <li><a href="export.htm#backup_export" class="en">Backup &amp; Export</a>\n';
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="export.htm#backup_export_decision" class="en">Decide for one method</a></li>\n';
doc_toc += '          <li><a href="export.htm#backup" class="en">Backup</a>\n';
doc_toc += '            <ul>\n';
...
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
doc_toc += '          <li><a href="export.htm#export" class="en">Exporting</a>\n';
doc_toc += '            <ul>\n';
doc_toc += '              <li><a href="export.htm#export_scope" class="en">Scope</a></li>\n';
doc_toc += '              <li><a href="export.htm#export_usage" class="en">Usage</a></li>\n';
doc_toc += '              <li><a href="export.htm#export_preparations" class="en">Preparations</a></li>\n';
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
