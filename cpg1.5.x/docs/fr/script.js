...
doc_toc += '      </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="theme.htm#theme_files"class="en">Contenu d\'un thème</a></li>\n';
doc_toc += '        <ul>\n';
...
doc_toc += '              <li><a href="dev_plugin_api.htm#plugin_api_globals"class="en">Global Variables &amp; Constants</a>\n';
doc_toc += '                <ul class="level5">\n';
doc_toc += '                  <li><a href="dev_plugin_api.htm#plugin_api_globals_system"class="en">System Global Variables</a></li>\n';
doc_toc += '                  <li><a href="dev_plugin_api.htm#plugin_api_globals_cpg"class="en">Coppermine Constants</a></li>\n';
doc_toc += '                </ul>\n';
doc_toc += '              </li>\n';
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
