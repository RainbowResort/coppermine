...
doc_toc += '          <li><a href="files.htm#cust_thmb" >Vignettes personnalisées</a></li>\n';
doc_toc += '            <ul>\n';
...
doc_toc += '          <li><a href="exif.htm#exif_makers">Differentes versions</a></li>\n';
...
doc_toc += '          <li><a href="exif.htm#exif_limitations">Limitates</a></li>\n';
doc_toc += '          <li><a href="exif.htm#exif_manager">Gestionnaire d\'EXIF manager</a></li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
...
doc_toc += '              <li><a href="admin-tools.htm#admin_tools_options_keyword_convert">Convertir le séparteur de mots clé</a></li>\n';
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
...
doc_toc += '            <ul>\n';
doc_toc += '              <li><a href="errors.htm#errors_messages_database">Messages d\'erreur relatifs à la base de donnée</a></li>\n';
...
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="export.htm#backup_export">Sauvegarde</a>\n';
doc_toc += '        <ul>\n';
...
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
doc_toc += '          <li><a href="export.htm#backup_database">Sauvegarde de la base de donnée</a>\n';
doc_toc += '            <ul>\n';
doc_toc += '              <li><a href="export.htm#backup_database_what">Ce qui doit être sauvegardé</a></li>\n';
doc_toc += '              <li><a href="export.htm#backup_database_tools">Outils de sauvegarde de la base de donnée</a>\n';
doc_toc += '                <ul>\n';
...
doc_toc += '                </ul>\n';
doc_toc += '              </li>\n';
doc_toc += '              <li><a href="export.htm#backup_database_after">Après la sauvegarde de la base de donnée</a></li>\n';
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
...
doc_toc += '              <li><a href="export.htm#moving_server">Déplacement d\'un serveurvers un autre</a></li>\n';
...
doc_toc += '    </ul>\n';
doc_toc += '  </li>\n';
doc_toc += '  <li><a href="dev.htm" class="us_fr">Documentation des développeurs</a>\n';
doc_toc += '    <ul>\n';
...
doc_toc += '              <li><a href="dev_coding.htm#dev_coding_control_structures">Sctructures de contrôle</a></li>\n';
...
doc_toc += '            <ul>\n';
doc_toc += '              <li><a href="dev_coding.htm#dev_coding_usability_forms">Formulairess</a></li>\n';
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
...
doc_toc += '          <li><a href="dev_files.htm#dev_files_adding">Ajouts de fichiers</a></li>\n';
