...
doc_toc += '          <li><a href="exif.htm#exif_manager">Gestionnaire d\'EXIFr</a></li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
...
doc_toc += '    </ul>\n';
doc_toc += '  </li>\n';
doc_toc += '  <li><a href="bridging.htm">Intégration/Bridge</a>\n';
doc_toc += '    <ul>\n';
doc_toc += '      <li><a href="bridging.htm#integrating_bridge_purpose">Ce que fait l\'intégration</a></li>\n';
doc_toc += '      <li><a href="bridging.htm#integrating_bridge_start">Fichiers bridge disponibles</a></li>\n';
doc_toc += '      <li><a href="bridging.htm#integrating_prerequisites_start">Pre-requis</a>\n';
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="bridging.htm#integrating_cookie_start">Authentification par cookie</a></li>\n';
doc_toc += '          <li><a href="bridging.htm#integrating_standalone_start">Version autonome d\'abbord</a></li>\n';
...
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="bridging.htm#bridge_manager_recover_start">Restauration après l\'echèc de l\'intégration</a></li>\n';
...
function cpgDocHeader() {
	...
	$('#docheader').text('Coppermine Photo Gallery v1.5.4: Documentation and Manual');
