...
doc_toc += '<ul id="tree">\n';
doc_toc += '  <li><a href="index.htm" class="us_de">Coppermine Dokumentation</a>\n';
doc_toc += '    <ul class="level2" id="index">\n';
doc_toc += '      <li><a href="index.htm#about">Über Coppermine</a></li>\n';
doc_toc += '      <li><a href="index.htm#about_documentation">Über die Dokumentation</a>\n';
doc_toc += '        <ul>\n';
...
doc_toc += '          <li><a href="translation.htm" class="en">Übersetzungs-Assistent</a></li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
...
doc_toc += '          <li><a href="copyrights.htm#copyright_additional">Zusätzliche Bedingungen</a>\n';
doc_toc += '            <ul class="level3" id="additional_terms">\n';
doc_toc += '              <li><a href="copyrights.htm#copyright_additional_preservation">Erhaltung der Autorenschaftshinweise</a></li>\n';
doc_toc += '              <li><a href="copyrights.htm#copyright_additional_marking">Kennzeichnung von modifizierte Versionen des Materials</a></li>\n';
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
...
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="dev_plugin_api.htm" class="en">Plugin-Tutorial, API-Beschreibung</a>\n';
doc_toc += '            <ul>\n';
...
doc_toc += '              <li><a href="dev_plugin_api.htm#plugin_api_globals" class="en">Globale Variablen &amp; Konstanten</a></li>\n';
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
...
doc_toc += '      <li><a href="dev_vars.htm#vars_constants" class="en">Variablen &amp; Konstanten</a>\n';
doc_toc += '        <ul class="level5">\n';
doc_toc += '          <li><a href="dev_vars.htm#vars_constants_system" class="en">Systemweite globale Variablen</a></li>\n';
doc_toc += '          <li><a href="dev_vars.htm#vars_constants_constants" class="en">Coppermine Konstanten</a></li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
