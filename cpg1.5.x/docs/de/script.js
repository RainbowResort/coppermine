...
d.add(0,-1,'Coppermine Dokumentation', '../index.htm');
...
d.add(6100,5800,'Themen-Einstellungen','configuration.htm#admin_theme');
d.add(6200,5800,'Ansicht Albenliste','configuration.htm#admin_album_list');
d.add(6300,5800,'Ansicht Thumbnail','configuration.htm#admin_thumbnail_view');
...
d.add(6900,5800,'Benutzer-Einstellungen','configuration.htm#admin_user');
d.add(7000,5800,'Benutzerdefinierte Felder für Benutzerprofile','configuration.htm#admin_custom');
d.add(7100,5800,'Benutzerdefinierte Felder für zusätzliche Dateiinformationen','configuration.htm#admin_custom_image');
d.add(7200,5800,'Cookie-Einstellungen','configuration.htm#admin_cookie');
d.add(7300,5800,'Email-Einstellungen','configuration.htm#admin_email');
d.add(7400,5800,'Logging und Statistiken','configuration.htm#admin_logging');
d.add(7500,5800,'Wartungs-Einstellungen','configuration.htm#admin_misc');
...
//d.add(15500,15200,'Plugin hooks','dev_plugin_hooks.htm');
