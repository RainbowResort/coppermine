...
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="testing.htm" class="en">Test (Alpha/Beta-Versionen!)</a>\n';
doc_toc += '        <ul>\n';
...
doc_toc += '              <li><a href="translation.htm#translation_documentation" class="en">Translating the documentation</a></li>\n';
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
...
doc_toc += '            <ul class="level3" id="translators" class="de">\n';
...
doc_toc += '          <ul class="level3" id="updater" class="en">\n';
...
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="export.htm#backup_export" class="en">Backup und Export</a>\n';
doc_toc += '        <ul>\n';
...
doc_toc += '    <ul>\n';
doc_toc += '      <li><a href="dev_coding.htm" class="en">Coding-Richtlinien</a>\n';
doc_toc += '        <ul>\n';
...
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="dev_files.htm" class="en">Dateien hinzufügen/entfernen/umbenennen</a>\n';
doc_toc += '        <ul>\n';
...
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="dev_superglobals.htm" class="en">Superglobals bereinigen mit Inspekt</a>\n';
doc_toc += '        <ul>\n';
...
doc_toc += '              <li><a href="dev_plugin_api.htm#plugin_api_overview_skills" class="en">Benötigte Fähigkeiten und Kenntnisse</a></li>\n';
doc_toc += '              <li><a href="dev_plugin_api.htm#plugin_api_overview_tools" class="en">Empfohlene Software und Support-Foren</a></li>\n';
...
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="dev_documentation.htm" class="en">Dokumentation bearbeiten</a>\n';
doc_toc += '        <ul>\n';
...
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="dev_subversion.htm" class="en">Subversion Versionskontrolle</a>\n';
doc_toc += '        <ul>\n';
...
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="dev_config.htm" class="en">Einstellungs-Optionen hinzufügen</a>\n';
doc_toc += '        <ul>\n';
...
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="dev_vars.htm#vars_constants" class="en">Variablen und Konstanten</a>\n';
doc_toc += '        <ul class="level5">\n';
...
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="dev_update.htm" class="en">Aktualisieren (Updates)</a>\n';
doc_toc += '        <ul>\n';
...
doc_toc += '              <li><a href="dev_database.htm#db_banned"v class="en">cpg15x_banned</a></li>\n';
...
function cpgDocHeader() {
	...
	$('#docheader').text('Coppermine Photo Gallery v1.5.3: Dokumentation und Handbuch');
