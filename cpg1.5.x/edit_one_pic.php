...
print <<<EOT
        ...
        <tr>
                        ...
                        <td class="tableb" valign="top">
                                <textarea name="caption" rows="1" cols="100" class="textinput autogrow" onkeydown="textCounter(this, {$CONFIG['max_img_desc_length']});" onkeyup="textCounter(this, {$CONFIG['max_img_desc_length']});">{$CURRENT_PIC['caption']}</textarea>
                        </td>
        </tr>
        <tr>
                        <td class="tableb" style="white-space: nowrap;">
