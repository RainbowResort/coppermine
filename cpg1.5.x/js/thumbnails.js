...
function addSortable(){
	...
	sortable +=	'		<tr>';
	sortable +=	'				<td class="sortorder_options">' + js_vars.sort_vars.sort_title + '</td>';
	sortable +=	'				<td class="sortorder_options"><span class="statlink">&nbsp;<a href="thumbnails.php?album=' + js_vars.sort_vars.aid
	...
	sortable +=	'		</tr>';
	sortable +=	'		<tr>';
	sortable +=	'				<td class="sortorder_options">' + js_vars.sort_vars.sort_name + '</td>';
	sortable +=	'				<td class="sortorder_options"><span class="statlink">&nbsp;<a href="thumbnails.php?album=' + js_vars.sort_vars.aid
	...
	sortable +=	'		</tr>';
	sortable +=	'		<tr>';
	sortable +=	'				<td class="sortorder_options">' + js_vars.sort_vars.sort_date + '</td>';
	sortable +=	'				<td class="sortorder_options"><span class="statlink">&nbsp;<a href="thumbnails.php?album=' + js_vars.sort_vars.aid
	...
	sortable +=	'		</tr>';
	sortable +=	'		<tr>';
	sortable +=	'				<td class="sortorder_options">' + js_vars.sort_vars.sort_position + '</td>';
	sortable +=	'				<td class="sortorder_options"><span class="statlink">&nbsp;<a href="thumbnails.php?album=' + js_vars.sort_vars.aid
