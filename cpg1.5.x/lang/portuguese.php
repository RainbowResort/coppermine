...
$lang_common['keywords'] = 'Senhas'; // cpg1.5
$lang_common['keywords_insert1'] = 'Senhas (separadas com %s)'; // cpg1.5
...
$lang_main_menu['register_lnk'] = 'Registo';
...
$lang_main_menu['memberlist_title'] = 'Exibir Lista Utilizadores';
...
$lang_gallery_admin_menu['update_database_title'] = 'Se substituiu ficheiros do Coppermine, alterou ou actualizou de uma versão anterior do Coppermine, execute, uma vez, o actualizador da base de dadaos. Assim, serão criadas as tabelas necessárias e/ou valores de configuração na base de dados do Coppermine.'; // cpg1.5
...
$lang_gallery_admin_menu['overall_stats_title'] = 'Ver estatísticas gerais de acesso por browser e por sistema operativo (se as opções correspondentes estiverem activadas na configuração).'; // cpg1.5
...
$lang_version_alert['no_iframe'] = 'O seu browser não consegue apresentar frames'; // cpg1.5
...
$lang_mailer['mailer_not_supported'] = ' mailer não é suportado.';
...
$lang_albmgr_php['submit_reminder'] = 'As alterações não serão gravadas até que clique em Salvar alterações.'; // cpg1.5
}
...
$lang_ecard_php['view_ecard_plaintext'] = 'Para ver o postal, copie e cole este URL na barra de endereços do seu browser:';
...
$lang_report_php['view_report_plaintext'] = 'Para ver o relatório, copie e cole este URL na barra de endereços do seu browser:';
...
$lang_groupmgr_php['group_assigned_album'] = 'álbum(s) atribuído(s)';
...
$lang_install['cpg_info_frames'] = 'O seu browser parece incapaz de apresentar frames. Pode verificar a licença na directoria docs que vem no pacote de instalação do Coppermine.';
...
$lang_install['no_cookie'] = 'O seu browser não aceitou o cookie. É recomendado que aceite cookies.';
$lang_install['no_javascript'] = 'O seu browser não parece ter o Javascript activo - é altamente recomendado que o active.';
...
$lang_login_php['cookie_warning'] = 'Aviso: O seu browser não aceita cookies';
...
$lang_pluginmgr_php['explanation'] = 'Instalar/desinstalar/gerir plugins com esta página.'; // cpg1.5
...
Por forma a activar a sua conta com o nome de utilizador "{USER_NAME}", é necessário que clique no link seguinte ou que o copie e o cole no seu browser.
...
Por forma a activar a conta, necessita de clicar no link seguinte ou que o copie e o cole no seu browser.
...
$lang_sidebar_php['install_explain'] = 'De entre os vários métodos inteligentes de aceder rapidamente ao conteúdo do site, fornecemos barras laterais para os browsers mais comuns usados nos diferentes sistemas operativos. Aqui pode encontrar a informação necessária para instalar, configurar e desinstalar os browsers suportados.'; // cpg1.5
$lang_sidebar_php['os_browser_detect'] = 'Detectando o sistema operativo e o browser'; // cpg1.5
$lang_sidebar_php['os_browser_detect_explain'] = 'O script está a tentar detectar a sua versão de sistema operativo e de browser - aguarde um momento. Se a auto-detecção falhar, pode querer %smostrar%s todas as opções manuais de instalação da barra lateral.'; // cpg1.5
...
$lang_sidebar_php['ie7_win_explain'] = 'Se usa o Internet Explorer 7 no Windows, pode adicionar um pop-up à sua barra links ou pode adicioná-la aos favoritos e clicando nela pode ver a barra numa janela pop-up ao clicar com o botão direito do rato %saqui%s e seleccionando "Adicionar aos Favoritos" no menu. Em versões anteriores do IE, era possível adicionar mesmo uma barra lateral, mas no IE7 tal só é possível com hacks complicados no registry. É recomendado que use outro browser se pretende usar a barra lateral.'; // cpg1.5
...
$lang_sidebar_php['additional_options_explain'] = 'Se tem outro browser diferente, clique %aqui% para mostar todas as opções de barra lateral disponíveis.'; // cpg1.5
$lang_sidebar_php['cannot_add_sidebar'] = 'A barra lateral não pode ser adicionada! O seu browser não suporta este método!'; // cpg1.5 // js-alert
...
$lang_send_activation_php['submit'] = 'Ok'; // cpg1.5
...
$lang_upload_php['exc_file_size'] = 'O tamanho de ficheiro excedeu o permitido pelo Coppermine.';
$lang_upload_php['partial_upload'] = 'Só se fez um envio parcial.';
$lang_upload_php['no_upload'] = 'Não foram feitos envios.';
$lang_upload_php['unknown_code'] = 'Erro PHP de envio desconhecido.';
...
$lang_upload_php['max_fsize'] = 'O tamanho de ficheiro máximo é de %s';
...
$lang_upload_php['no_keywords'] = 'Desculpe, não há senhas disponíveis!';
...
$lang_usermgr_php['latest_upload'] = 'Envio recentes';
...
$lang_versioncheck_php['browse_corresponding_page_subversion'] = 'Abrir, no browser, a página correspondente ao ficheiro no repositório do projecto';
...
$lang_xp_publish_php['no_ie'] = 'Parece estar a utilizar um browser não suportado'; // cpg1.5
$lang_xp_publish_php['no_browser_detect'] = 'Não foi possível detectar qual o seu browser'; // cpg1.5
...
$lang_plugin_php['opensearch_config_description'] = 'Uma implementação de <a href="http://www.opensearch.org/" rel="external" class="external">OpenSearch</a> para o Coppermine.<br />Quando activada, os visitantes podem adicionar a galeria às suas barras de pesquisa de browser.'; // cpg1.5
...
$lang_plugin_php['opensearch_display_name'] = 'Nome tal como mostrado no browser'; // cpg1.5
$lang_plugin_php['opensearch_description'] = 'Descrição'; // cpg1.5
$lang_plugin_php['opensearch_character_limit'] = 'limite de caracters de %s'; // cpg1.5
...
$lang_plugin_php['link_target_extra'] = 'Este plugin tem um impacto, principalmente, no link "Powered by Coppermine" no rodapé da página da galeria.';
