...
$lang_errors['login_needed'] = 'Необхідно %sзареєструватися %s / %sввійти %s, щоб отримати доступ до цієї сторінки'; //cpg1.5
...
$lang_get_remote_file_by_url['no_data_returned'] = 'Дані не повернулися від%s'; // cpg1.5 (?)
...
$lang_banning_php['ban_record_x_updated'] = 'Запис блокування%s була оновлена'; // cpg1.5
$lang_banning_php['ban_record_x_deleted'] = 'Запис блокування%s була видалена'; // cpg1.5
...
$lang_install['old_install'] = 'Це новий майстер установки. Натисніть %sтут %s для класичного екрану усатновки. '; // Cpg1.5 
} 
...
$lang_modifyalb_php['delete_files'] = '%sБезвозвратно %s видалити всі файли в %s'; 
...
$lang_sidebar_php['os_browser_detect_explain'] = 'Скрипт намагається визначити Вашу операційну систему і версію браузера - будь ласка, подождтіе. Якщо авто-визначення зазнало невдачі, Ви можете самостійно %sотобразіть %s всі можливі варіанти установки бічних панелей. '; // Cpg1.5 
...
$lang_sidebar_php['opera_explain'] = 'Якщо Ви використовуєте Opera, Ви можете %sнажать на цю посилання, щоб додати нашу бічну панель для Вашого сайту %s. Потім відзначте &quot;Відображати у бічній панелі&quot;. Ви можете видалити бічну панель шляхом правого-кліка на її закладці і вибором &quot;Видалити&quot; з контекстного меню. '; // Cpg1.5 
$lang_sidebar_php['additional_options'] = 'Додаткові налаштування'; // cpg1.5 
$lang_sidebar_php['additional_options_explain'] = 'Якщо у Вас інша браузер, ніж зазначений вище, тоді натисніть %sздесь %s, щоб відобразити всі можливі настройки бічній панелі.'; // Cpg1.5 
...
$lang_update_php['start_page'] = 'Якщо Ви не оновлювалися (або не хочете проходити перевірку), Ви можете перейти %sна стартову сторінку Вашої галереї %s'; // cpg1.5 // Leave the %s untouched when translating - it wraps the link 
