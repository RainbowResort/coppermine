...
$lang_common['captcha_help_title'] = 'Visuaalinen vahvistus (captcha)'; // cpg1.5
...
$lang_common['keywords'] = 'Tagit'; // cpg1.5
$lang_common['keywords_insert1'] = 'Tagit (erota %s:lla)'; // cpg1.5
$lang_common['keywords_insert2'] = 'Lisää listasta'; // cpg1.5
$lang_common['keyword_separator'] = 'Avainsanojen erotin'; //cpg1.5
$lang_common['keyword_separators'] = array(' '=>'väli', ','=>'pilkku', ';'=>'puolipiste'); // cpg1.5
...
$lang_main_menu['lastup_title'] = 'Näytä viimeksi lisätyt kuvat';
$lang_main_menu['lastup_lnk'] = 'Uusimmat lisäykset';
$lang_main_menu['lastcom_title'] = 'Näytä viimeksi lisätyt kommentit';
$lang_main_menu['lastcom_lnk'] = 'Uusimmat kommentit';
$lang_main_menu['topn_title'] = 'Näytä katsotuimmat kuvat';
$lang_main_menu['topn_lnk'] = 'Katsotuimmat';
$lang_main_menu['toprated_title'] = 'Näytä suosituimmat kuvat';
...
$lang_gallery_admin_menu['keywordmgr_title'] = 'Hallitse hakusanoja (jos tarvittava asetus on päällä)'; // cpg1.5
...
$lang_rate_pic['rating'] = '(äänet: %s/%s %s:llä äänellä)';
...
$lang_bridgemgr_php['title'] = 'Integrointi velho (Bridge Wizard)';
...
$lang_bridgemgr_php['recovery_wait_title'] = 'Odotusaika ei vielä kulunut';
...
$lang_admin_php['clickable_keyword_search'] = 'Klikattavat tagit hakusivulla'; // cpg1.5
...
$lang_admin_php['browse_batch_add'] = 'Selattava tiedostojenlisäyskäyttöliittymä'; // cpg1.5
$lang_admin_php['batch_proc_limit'] = 'Käsittele samanaikaisesti tiedostojenlisäyskäyttöliittymässä'; // cpg1.5
$lang_admin_php['display_thumbs_batch_add'] = 'Näytä esikatselukuva tiedostojenlisäyskäyttöliittymässä'; // cpg1.5
...
$lang_admin_php['allow_user_album_keyword'] = 'Salli käyttäjien valita albimille avainsanoja'; // cpg1.5
...
$lang_picinfo['iptcKeywords'] = 'IPTC-tagit';
...
$lang_picinfo['FlashPixVersion'] = 'Salaman Pix-versio';
$lang_picinfo['ExifImageWidth'] = 'Exif-kuvaleveys';
$lang_picinfo['ExifImageHeight'] = 'Exif-kuvakorkeus';
$lang_picinfo['ExifInteroperabilityOffset'] = 'Exif-yhteensopivuus offset';
...
$lang_report_php['missing'] = 'hukassa';
...
$lang_editpics_php['new_keyword'] = 'Uusi tagi';
$lang_editpics_php['new_keywords'] = 'Uusia hakusanoja löydetty';
$lang_editpics_php['existing_keyword'] = 'Olemassaoleva tagi';
$lang_editpics_php['pic_info_str'] = '%s &times; %s - %s kt - %s katselukertaa - %s ääntä';
...
$lang_install['already_succ_explain'] = 'Jos haluat käyttää asentajaa toisen kerran, joudut poistamaan tiedoston \'include/config.inc.php\', joka luotiin hakemistoon, johon Coppermine asennettiin. Voit poistaa tiedoston FTP -ohjelmalla';
...
$lang_install['email'] = 'Säkköpostiosoite';
$lang_install['email_no_match'] = 'Säkköpostiosoitteet eivät täsmää tai ovat virheellisiä.';
$lang_install['email_verif'] = 'Tarkista säkköpostiosoite';
...
$lang_install['perm_not_ok'] = 'Joidenkin hakemistojen oikeudet eivät olea setettu oikein.<br />Ole hyvä vaihda "Virheellinen" merkkattujen hakemistojen oikeudet.'; // cpg1.5
...
$lang_install['sect_create_adm'] = 'Tämä osa tarvitsee tietoa luodaksesi sinulle Copperminen ylläpitäjän tilin. Käytä vain alplanumeerisia merkkejä. Syötä tiedot huolella!';
...
$lang_install['sect_mysql_sel_db'] = 'Tässä voit valita Copperminen kanssa käytettävän tietokannan. <br />Jos Mysql tililläsi on riittävät oikeudet, voit luoda uuden tietokannan asentajan avulla tai voit käyttää olemassa olevia tietokantoja. Jos et pidä kummastakaan vaihtoehdosto, sinun pitää ensin luoda tietokanta Copperminen asentajan ulkopuolella ja palata sitten tähän takaisin valiten juuri luomasi tietokannan listasta. voit myös vaihtaa taulun etuliitteen (älä kuitenkaan käytä pisteitä), mutta oletus etuliitteen säilyttäminen on suositeltavaa.';
...
$lang_install['read_gif'] = 'Lue/kirjoita .gif tiedosto';
$lang_install['read_png'] = 'Lue/kirjoita .png tiedosto';
$lang_install['read_jpg'] = 'Lue/kirjoita .jpg tiedosto';
...
$lang_install['combine'] = 'Yhdistä kaksi kuvaa';
$lang_install['text'] = 'Lisää tekstiä kuvaan';
$lang_install['scale'] = 'Skaalaaa kuva';
...
$lang_install['writable'] = 'Kirjoitettava';
$lang_install['not_writable'] = 'Ei kirjoitettava';
...
$lang_keywordmgr_php['confirm_delete'] = 'Haluatko varmasti poistaa tagin %s koko galleriasta?'; // js-alert
$lang_keywordmgr_php['change_keyword'] = 'Muuta tagi';
}
...
$lang_modifyalb_php['alb_keyword'] = 'Albumin tagit';
...
$lang_modifyalb_php['delete_files'] = 'Poista %slopullisesti%s kaikki kuvat albumissa %s';
...
$lang_search_new_php['need_one_album'] = 'Tarvitset vähintään yhden albumin voidaksesi käyttää tätä toimintoa';
...
$lang_search_new_php['target_album'] = '<strong>Laita tiedostot hakemistosta &quot;</strong>%s<strong>&quot; &quot; albumiin </strong>%s';
...
$lang_upload_php['up_instr_4'] = 'Klikkaa "Jatka" -nappia kun olet lisännyt kaikki haluamasi button after having all files that you want to upload (The button will appear after you have uploaded at least one file).';
...
$lang_upload_php['pixel_allowance'] = 'Kuvan korkeus tai leveys on liian suuri.';
...
$lang_upload_php['keywords_sel'] = 'Valitse tagi';
...
$lang_upload_php['no_keywords'] = 'Ainuttakaan tagia ei löytynyt!';
$lang_upload_php['regenerate_dictionary'] = 'Luo sanakirja uudelleen';
$lang_upload_php['allowed_types'] = 'Sinulla eo ole oikeutta lähettää tiedostoja seuraavilla päätteillä:'; // cpg1.5
$lang_upload_php['allowed_img_types'] = 'Kuva päätteet: %s'; // cpg1.5
$lang_upload_php['allowed_mov_types'] = 'Video päätteet: %s'; // cpg1.5
$lang_upload_php['allowed_doc_types'] = 'Dokumenttien päätteet: %s'; // cpg1.5
$lang_upload_php['allowed_snd_types'] = 'Audio päätteet: %s'; // cpg1.5
...
$lang_util_php['problem'] = 'Tiedosto';
...
$lang_util_php['update_missing'] = 'Päivitä vain puutuvat tiedostot'; // cpg1.5
...
$lang_util_php['delete_old_explanation'] = 'Tämä poistaa tiedostot, jotka ovat vanhempia kuin antamasi aika päivinä (normaali, keskikokoinen, täysikokoinen ja thumbnail). Käytä tätä toimintoa vapauttaaksesi levytilaa.';  // cpg1.5
...
$lang_util_php['update_result'] = 'Päivityksen tuloksetUpdate results'; // cpg1.5
...
$lang_util_php['keyword_convert'] = 'Muuta hakusanojen erottajaa'; // cpg1.5
$lang_util_php['keyword_from_to'] = 'Muuta hakusanojen erottaja %s:sta %s:ksi'; // cpg1.5
$lang_util_php['keyword_set'] = 'Aseta gallerian hakusanojen erottajalle uusi arvo'; // cpg1.5
...
$lang_plugin_php['onlinestats_reg_member'] = '%s rekisteröityt käyttäjä';
