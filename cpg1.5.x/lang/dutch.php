...
$lang_errors['invalid_image'] = 'De afbeelding die je hebt geupload is corrupt of kan niet behandeld worden door de GD library.';
...
$lang_albmgr_php['submit_reminder'] = 'Het sorteren van de wijzigingen worden niet opgeslagen tot je klikt op &quot;Veranderingen uitvoeren&quot;.'; // cpg1.5
}
...
$lang_admin_php['reg_notify_admin_email'] = 'Verwittig de beheerder van een gebruikersregistratie per e-mail'; // cpg1.5
...
$lang_db_input_php['no_pic_uploaded'] = 'Er is geen bestand geupload !<br/><br/>Indien je echt een bestand geselecteerd hebt om te uploaden, controleer of de server bestands-upload toestaat...';
...
$lang_db_input_php['upload_success'] = 'Je bestand is met succes geupload<br/><br/>Het wordt zichtbaar als de beheerder het goedgekeurd heeft.';
$lang_db_input_php['notify_admin_email_subject'] = '%s - Upload-melding';
$lang_db_input_php['notify_admin_email_body'] = 'Een foto is geupload door %s waarvoor toestemming is vereist. Bezoek %s';
...
$lang_register_php['thank_you'] = 'Bedankt voor de registratie.<br/><br/>Je zult een e-mail zal ontvangen met daarin de instructies hoe je je gebruikersnaam kunt activeren.';
...
$lang_register_php['last_uploads'] = 'Laatst geupload bestand'; // cpg1.5
$lang_register_php['last_uploads_detail'] = 'Klik om alle bestanden te zien die zijn geupload door %s'; // cpg1.5
...
$lang_register_php['pic_count'] = 'Bestanden geupload'; 
$lang_register_php['notify_admin_request_email_subject'] = '%s - Registratie verzoek'; 
$lang_register_php['thank_you_admin_activation'] = 'Bedankt.<br/><br/>Je verzoek tot toegang is verzonden aan de beheerder. Zo snel als je gebruikersnaam is geaccepteerd ontvang je een e-mail.'; 
...
$lang_usermgr_php['note_list'] = '<li>Als je niet je huidige wachtwoord wilt wijzigen, laat dan het "wachtwoord" veld leeg';
...
$lang_plugin_php['onlinestats_record'] = 'Hoogst aantal gebruikers ooit inline: %s op %s';
