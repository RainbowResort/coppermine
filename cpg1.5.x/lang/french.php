...
$lang_translation_info['trans_date'] = '2008-12-26';
...
$lang_errors['gd_file_type_err'] = 'L\'utilisation de &quot;GD Image Library&quot; ne vous permet d\'utiliser que de images de type JPEG et PNG.';
...
$lang_common['captcha_help'] = 'Pour éviter le Spam, vous devez confirmer que vous êtes un réel être humain et pas simplement un robot (script) en entrant le texte affiché.<br />La casse n\'a pas d\'importance, vous pouvez entrer le texte en minuscules.'; // cpg1.5.x
...
$lang_common['close'] = 'Fermer'; // cpg1.5.x
$lang_common['go'] = 'Envoyer'; // cpg1.5.x
...
$lang_main_menu['search_lnk'] = 'Recherchez';
...
$lang_gallery_admin_menu['upl_app_title'] = 'Validez les nouveaux téléchargements'; //cpg1.4
$lang_gallery_admin_menu['upl_app_lnk'] = 'Fichiers à valider';
$lang_gallery_admin_menu['admin_title'] = 'Allez à la page Configuration'; //cpg1.4
$lang_gallery_admin_menu['admin_lnk'] = 'Configuration'; //cpg1.4
$lang_gallery_admin_menu['albums_title'] = 'Allez à la configuration des Albums'; //cpg1.4
$lang_gallery_admin_menu['albums_lnk'] = 'Albums';
$lang_gallery_admin_menu['categories_title'] = 'Allez à la Configuration des Catégories'; //cpg1.4
$lang_gallery_admin_menu['categories_lnk'] = 'Catégories';
$lang_gallery_admin_menu['users_title'] = 'Allez à la Configuration des Utilisateurs'; //cpg1.4
$lang_gallery_admin_menu['users_lnk'] = 'Utilisateurs';
$lang_gallery_admin_menu['groups_title'] = 'Aller à la Configuration des Groupes'; //cpg1.4
$lang_gallery_admin_menu['groups_lnk'] = 'Groupes';
$lang_gallery_admin_menu['comments_title'] = 'Affichez tous les Commentaires'; //cpg1.4
$lang_gallery_admin_menu['comments_lnk'] = 'Commentaires';
$lang_gallery_admin_menu['searchnew_title'] = 'Allez au Téléchargement par Lots (FTP)'; //cpg1.4
$lang_gallery_admin_menu['searchnew_lnk'] = 'FTP] =';
$lang_gallery_admin_menu['util_title'] = 'Allez aux Utilitaires d\'Administration'; //cpg1.4
$lang_gallery_admin_menu['util_lnk'] = 'Utilitaires';
$lang_gallery_admin_menu['key_title'] = 'Allez au Dictionnaire de Mots-Clef'; //cpg1.4
$lang_gallery_admin_menu['key_lnk'] = 'Dictionnaire de Mot-Clef'; //cpg1.4
$lang_gallery_admin_menu['ban_title'] = 'Aller aux Utilisateurs Bannis'; //cpg1.4
$lang_gallery_admin_menu['ban_lnk'] = 'Bannir des utilisateurs ';
$lang_gallery_admin_menu['db_ecard_title'] = 'Voir les eCartes'; //cpg1.4
$lang_gallery_admin_menu['db_ecard_lnk'] = 'eCartes envoyées';
$lang_gallery_admin_menu['pictures_title'] = 'Tri des Images'; //cpg1.4
$lang_gallery_admin_menu['pictures_lnk'] = 'Tri des images'; //cpg1.4
$lang_gallery_admin_menu['documentation_lnk'] = 'Documentation'; //cpg1.4
$lang_gallery_admin_menu['documentation_title'] = 'Manuel de Coppermine'; //cpg1.4
...
$lang_gallery_admin_menu['update_database_lnk'] = 'Gestion BDD'; // cpg1.5.x
...
$lang_gallery_admin_menu['view_log_files_title'] = 'Coppermine peut enregistrer diverses actions effectuées par les Utilisateurs. Vous pouvez consulter ces LOGs si vous avez autoriser ceci dans la Config de Coppermine.'; // cpg1.5.x
$lang_gallery_admin_menu['check_versions_lnk'] = 'Vérifiez la version actuelle'; // cpg1.5.x
$lang_gallery_admin_menu['check_versions_title'] = 'Vérifiez la version de vos fichiers pour voir si vous avez remplacé tous les dossiers après une mise à jour, ou si des fichiers source de Coppermine ont été mis à jour après la mise à disposition de votre version.'; // cpg1.5.x
$lang_gallery_admin_menu['bridgemgr_lnk'] = 'Bridge'; // cpg1.5.x
$lang_gallery_admin_menu['bridgemgr_title'] = 'Activer/Désactivez l\'intégration (Bridge) de Coppermine avec une autre application (par exemple : Votre Forum PhpBB, SMF ou autres).'; // cpg1.5.x
$lang_gallery_admin_menu['pluginmgr_lnk'] = 'Gestion des Plugins'; // cpg1.5.x
...
$lang_gallery_admin_menu['overall_stats_title'] = 'Visualisez les statistiques globales d’accès à votre Galerie par navigateur et logiciel d\'exploitation (si les options correspondantes sont activées dans la configuration).'; // cpg1.5.x
...
$lang_gallery_admin_menu['exifmgr_lnk'] = 'Gestion des EXIF'; // cpg1.5.x
$lang_gallery_admin_menu['exifmgr_title'] = 'Managez l\'affichage des données EXIF (si l\'option correspondante est cochée dans la configuration).'; // cpg1.5.x
$lang_gallery_admin_menu['shownews_lnk'] = 'Montrez les News'; // cpg1.5.x
$lang_gallery_admin_menu['shownews_title'] = 'Affichez le News de coppermine-gallery.net'; // cpg1.5.x
$lang_gallery_admin_menu['export_lnk'] = 'Export'; // cpg1.5
$lang_gallery_admin_menu['export_title'] = 'Exporter des fichiers et des albums vers votre disque dur'; // cpg1.5
...
$lang_user_admin_menu['my_prof_title'] = 'Aller à mon Profil Personnel'; //cpg1.4
...
$lang_thumb_view['zipdownload_copyright'] = 'Merci de réspecter les Copyrights - N\'utilisez les fichiers que vous téléchargez qu\'en accord avec leur propriétaire'; // cpg1.5
...
$lang_img_nav_bar['report_title'] = 'Signalez ce fichier à l\'Administrateur'; //cpg1.4
...
$lang_rate_pic['rating'] = '(note actuelle : %s / 5 pour %s votes)';
...
$lang_cpg_debug_output['copy_and_paste_instructions'] = 'Si vous souhaitez soumettre une demande d\'assistance dans le Forum de support de Coppermine, copier/collez ces informations de débogage dans votre message. Assurez-vous de remplacer tous les mots de passe, même codés, par \'***\' avant de poster votre message.'; //cpg1.3.0
$lang_cpg_debug_output['debug_output_explain'] = 'Note: Ceci n\'est qu\'une information, ce qui ne veut pas dire qu\'il y a une erreur dans la galerie.'; // cpg1.5
$lang_cpg_debug_output['phpinfo'] = 'Afficher le phpinfo'; //cpg1.3.0
...
$lang_cpg_debug_output['notices_help_non_admin'] = 'L\'affichage de ces avis a été délibérément activé par l\'administrateur. Celà ne veut pas dire qu\'il y a un problème de votre côté. Vous pouvez ignorer ces avertissements sans craintes.'; // cpg1.5
...
$lang_social_bookmarks['favorite'] = 'Ajoutez cette page dans les favoris/marques pages de votre navigateur'; // js-alert
$lang_social_bookmarks['send_email'] = 'Recommander cette page par courriel'; // js-alert
...
$lang_version_alert['no_stable_version'] = 'Vous utilisez Coppermine  %s (%s) qui s\'adresse aux utilisateurs très expérimentés - Cette version n\'offre aucun support d\'aide. Vous pouvez l\'utiliser à vos risques et périls ou télécharger la dernière version stable si vous avez besoin d\'aide!'; //cpg1.4
$lang_version_alert['gallery_offline'] = 'La galerie est actuellement hors ligne et n\est visible que par un administrateur. N\'oubliez pas de la remettre en ligne une fois les travaux de maintenance terminés.'; //cpg1.4
...
$lang_albmgr_php['no_change'] = 'vous n\\\'avez effectué Aucun changements&nbsp;!';//js-alert
...
$lang_banning_php['select_date'] = 'selectionnez la date'; //cpg1.4
...
$lang_banning_php['new_ban_record_created'] = 'Un nouvel enregistrementde banissement a été créer'; // cpg1.5
...
$lang_banning_php['form_not_submit'] = 'Le formulaire n\a pas été envoyé - il y a des erreurs que vous devez corriger d\'abbord!'; // cpg1.5
}
...
$lang_bridgemgr_php['title'] = 'Assistant de \&quot;Bridge\&quot;';
...
$lang_bridgemgr_php['no_action_needed'] = 'Pas d\'action à cette étape. Cliquez sur \'suivant\'pour CONTINUEZ.';
...
$lang_bridgemgr_php['use_post_based_groups'] = 'Utiliser les groupes basés sur le nombre de messages ?';
...
$lang_bridgemgr_php['recovery_success_advice_login'] = 'S\'identifier comme Administrateur pour éditer la Configuration de votre Bridge et/ou activer l\'intégration avec votre Forum à nouveau.';
...
if (defined('CATMGR_PHP')) {
  ...
  $lang_catmgr_php['move_into'] = 'Déplacez dans';
...
$lang_admin_php['language_charset_settings'] = 'Paramétres de la Langue &amp; Jeu de caractères'; // cpg1.5
$lang_admin_php['themes_settings'] = 'Paramétres des themes'; // cpg1.5
...
$lang_admin_php['comment_settings'] = 'Paramétres des commentaires'; // cpg1.5
$lang_admin_php['thumbnail_settings'] = 'Paramétres des vignettes'; // cpg1.5
$lang_admin_php['file_settings'] = 'Paramétres des fichiers'; // cpg1.5
$lang_admin_php['image_watermarking'] = 'Filigrane d\'Images'; // cpg1.5
$lang_admin_php['registration'] = 'Enregistrement'; // cpg1.5
$lang_admin_php['user_settings'] = 'Paramétres des utilisateurs'; // cpg1.5
...
$lang_admin_php['cookie_settings']= 'Paramétres des Cookies'; // cpg1.5
$lang_admin_php['email_settings']= 'Paramétres des courriels  (habituellement il n\'est pas necessaire de faire des modifications; laissez tous les champs vide si vous n\'êtes pas sur)'; // cpg1.5
$lang_admin_php['logging_stats'] = 'Logging et statistiques'; // cpg1.5
$lang_admin_php['maintenance_settings'] = 'Paramétres de maintenance'; // cpg1.5
...
$lang_admin_php['restore_cfg_confirm'] = 'Voullez vous réellement restaurer tous les paramétres de la configuration avec les valeurs par defaut? Cette action ne peut pas être annulée!'; // cpg1.5 //js-alert
...
$lang_admin_php['click_expand'] = 'Cliquer sur un nom de Section pour afficher'; //cpg1.4
...
$lang_admin_php['bbs_disabled'] = 'Fonction désactivé si vous utilisez l\'intégration BB'; //cpg1.4
...
$lang_admin_php['highlight_multiple'] = 'Pour sélectionner plusieurs lignes, maintenez la touce [Ctrl] appuyée'; // cpg1.5
...
$lang_admin_php['tabs_dropdown'] = 'Afficher la liste dérulante de toutes le pages après la tabulation'; // cpg1.5
...
$lang_admin_php['rating_stars_amount'] = 'Nombr d\'étoiles à utiliser pour le vote'; // cpg1.5
...
$lang_admin_php['enable_custom_thumbs'] =   'Activer les Vignettes personnalisées'; // cpg1.5
$lang_admin_php['movie_audio_document'] =   'vidéos, audio, documents'; // cpg1.5
$lang_admin_php['thumb_pfx'] =   'Préfixe des Vignettes'; // cpg1.5
$lang_admin_php['enable_unsharp'] =   'Accentuation de la netteté des Vignettes: Activer le masque d\'Accentuation'; // cpg1.5
...
// $lang_admin_php['allowed_file_extensions'] =   'Extensions de fichiers acceptées pour l\'upload de fichiers'; // cpg1.5
...
// $lang_admin_php['allowed_img_types'] =   'Types d\'images autorisés (seulement pour ImageMagick)'; // cpg1.5
...
$lang_admin_php['reduce_watermark'] =   'Réduire le filigrane si la largeur de l\'image est inférieure à la valeur entrée. C\'est la référence à 100%. La réduction du filigrane est linéaire (0 pour désactiver)'; // cpg1.5
...
$lang_admin_php['thumbnail_intermediate_full'] = 'vignette, image intermédiare et images originale'; // cpg1.5
...
$lang_admin_php['warning_dont_submit'] = 'Si vous n\'êtes pas sur de l\'impact de ces changements, n\'envoyez pas ce formulaire et vérifiez d\'abbord dans la documentation.'; // cpg1.5 // js-alert
...
if (defined('DB_ECARD_PHP')) {
  ...
  $lang_db_ecard_php['ecard_display'] = 'Afficher les eCartes'; //cpg1.3.0
  ...
  $lang_db_ecard_php['ecard_goto_page'] = 'Aller à la page'; //cpg1.3.0
  ...
  $lang_db_ecard_php['ecards_delete_selected'] = 'Supprimer les eCartes sélectionnées'; //cpg1.3.0
  $lang_db_ecard_php['ecards_delete_confirm'] = 'Etes-vous certain de vouloir supprimer ces enregistrements ? Merci de cocher la case&nbsp;!'; //cpg1.3.0
...
if (defined('DELETE_PHP')) {
  ...
  $lang_delete_php['activate_user'] = 'Activer l\'Utilisateur'; //cpg1.4
  $lang_delete_php['user_already_active'] = 'Le Compte est déjà activé'; //cpg1.4
  $lang_delete_php['activated'] = 'Activé'; //cpg1.4
  $lang_delete_php['deactivate_user'] = 'Désactiver l\'Utilisateur'; //cpg1.4
  $lang_delete_php['user_already_inactive'] = 'Le Compte est déjà désactivé'; //cpg1.4
  $lang_delete_php['deactivated'] = 'Désactivé'; //cpg1.4
  $lang_delete_php['reset_password'] = 'Changer le Mot de Passe'; //cpg1.4
  $lang_delete_php['password_reset'] = 'Mot de Passe changé pour %s'; //cpg1.4
  $lang_delete_php['change_group'] = 'Changer de Groupe Principal'; //cpg1.4
  $lang_delete_php['change_group_to_group'] = 'Changer de %s à %s'; //cpg1.4
  $lang_delete_php['add_group'] = 'Ajouter un Groupe Secondaire'; //cpg1.4
  $lang_delete_php['add_group_to_group'] = 'Ajouter l\'Utilisateur %s au Groupe %s. Il est maintenant Membre de %s comme Groupe Primaire et de %s comme Groupe Secondaire.'; //cpg1.4
...
if (defined('DISPLAYIMAGE_PHP')){
  ...
  $lang_display_image_php['edit_pic'] = 'Modifier la Description'; //cpg1.3.0
...
if (defined('REPORT_FILE_PHP')) { 
  ...
  $lang_report_php['go_comment'] = 'Aller au Commentaire'; //cpg1.4
...
if (defined('EDITPICS_PHP')) {
  ...
  $lang_editpics_php['del_all'] = 'Supprimer TOUS les fichiers'; //cpg1.4
  ...
  $lang_editpics_php['save'] = 'Sauvegarder la photo'; //cpg1.3.0
...
if (defined('GROUPMGR_PHP')) {
  ...
  $lang_groupmgr_php['personal_gallery'] = 'Galerie Personnelle'; //cpg1.4
  ...
  $lang_groupmgr_php['explain_greyed_out_title'] = 'Pourquoi cette colonne est grisée ?'; //cpg1.4
  $lang_groupmgr_php['explain_guests_greyed_out_text'] = 'Vous ne pouvez pas changer les propriétés de ce Groupe car vous avez choisi &quot;Non&quot; pour l\'option &quot;Autoriser l\'accès aux visiteurs non authentifiés (visiteur ou anonyme)&quot; dans la page Configuration. Les visiteurs ne peuvent donc rien faire d\'autre que se connecter; il n\'y a donc pas de règlages de Groupe pour ceux-ci.'; //cpg1.4
...
if (defined('INSTALL_PHP')) {
  ...
  $lang_install['db_populating'] = 'Essai d\'insertion de données dans la base de donnée.';
  $lang_install['db_alr_populated'] = 'Les données requises sont déjà insérées dans la base de donnée.';
  ...
  $lang_install['mysql_create_btn'] = 'Creéer';
  ...
  $lang_install['subdir_called'] = 'Un sous-répertoire nommé \'%s\' devrait normalement exister dans le répertoire où vous avez téléchargé Coppermine. <br />L\'installeur ne peut pas le trouver. Vérifiez que vous avez téléchargé ous les fichiers Coppermine sur le serveur.';
...
if (defined('KEYWORDMGR_PHP')) {
  ...
  $lang_keywordmgr_php['keyword_del'] = 'Effacer le Mot Clef %s'; //cpg1.4
  $lang_keywordmgr_php['confirm_delete'] = 'Êtes-vous sur de vouloir effacer le Mot Clef %s de toute la Galerie ?'; //cpg1.4  // js-alert
  $lang_keywordmgr_php['change_keyword'] = 'Changer le Mot Clef'; //cpg1.4
}
...
if (defined('MINIBROWSER_PHP')) {
  $lang_minibrowser_php['up'] = 'remonter d\'un niveau'; //cpg1.4
...
// ------------------------------------------------------------------------- //
if (defined('MODE_PHP')) {
  $lang_mode_php[0] = 'Cacher les controls administrateurs...'; // cpg1.5
  $lang_mode_php[1] = 'Afficher les controls administrateurs...'; // cpg1.5
...
if (defined('MODIFYALB_PHP')) {
  ...
  $lang_modifyalb_php['password_protect'] = 'Protéger cet album par Mot de passe (cocher pour oui)'; //cpg1.5
}
...
if (defined('PHPINFO_PHP')) {
 $lang_phpinfo_php['php_info'] = 'PHP info';
  $lang_phpinfo_php['explanation'] = 'Voici la sortie générée par la fonction <a href="http://www.php.net/phpinfo">phpinfo()</a>, affichée à l\'intérieur de Coppermine (en rognant les informations trop longues) (les résultats varis selon les serveurs).';
...
EOT;
  ...
  $lang_register_php['interests'] = 'Vos centre d\'Intérêts :';
  ...
  $lang_register_php['thank_you'] = 'Merci pour votre inscription.<br /><br />Un courriel contenant les informations sur l\'Activation de votre Compte vous a été envoyé à l\'adresse courriel que vous nous avez communiquée.';
  $lang_register_php['acct_created'] = 'Votre compte a bien été créé. Vous pouvez maintenant vous identifier avec votre Identifiant et votre Mot de Passe';
  $lang_register_php['acct_active'] = 'Votre Compte a bien été activé. Vous pouvez maintenant vous identifier avec votre Identifiant et votre Mot de Passe';
  ...
  $lang_register_php['email_address_banned'] = 'Vous êtes banni de cette galerie. Vous n\êtes pas autorisé à vous ré-enregistrer. Allez-vous en!'; // cpg1.5
  ...
  $lang_register_php['form_not_submit'] = 'Le formulaire n\'a pas été envoyé - il y a des erreurs que vois devez corriger d\'abbord!'; // cpg1.5
...
if (defined('REVIEWCOM_PHP')) {
  ...
  $lang_reviewcom_php['ban_and_delete'] = 'Bannir l\'utilisateur et effacer les commentairesBan user and delete comment(s)'; // cpg1.5
...
if (defined('SIDEBAR_PHP')) { 
  ...
  $lang_sidebar_php['install_explain'] = 'Parmis les methodes d\'accès rapide aux informations du site, nous vou sproposons des signets pour la plupart des navigateurs utilisés par les systèmes d\'exploitationpour accéder rapidement à une page. Vous trouverez ici les informations d\'installation et de paramétrage pour les navigateurs supportés.'; // cpg1.5
  $lang_sidebar_php['os_browser_detect'] = 'Detection de votre systèmes d\'exploitation et de votre navigateur'; // cpg1.5
  $lang_sidebar_php['os_browser_detect_explain'] = 'Le script est en train d\'essayer de détecter la version de votre navigateur et de votre système d\'exploitation - Veuillez attendre un instant. Si l\'autodétection échoue, vous devrez %sactiver%s manuellement toutes les options possibles de volets latéraux.'; // cpg1.5
...
if (defined('SEARCH_PHP')){
  $lang_search_php['title'] = 'Chercher dans les fichiers'; //cpg1.4
...
if (defined('SEARCHNEW_PHP')) {
  ...
  $lang_search_new_php['be_patient'] = 'Soyez patient. Coppermine a besoin de temps pour mettre les photos en ligne';
  ...
  $lang_search_new_php['notes'] = <<< EOT
	<ul>
        ...
        <li>%s: Vous devez sélectionner d\'abbord un album</li>
...
// Note pour les Traducteurs: Ne traduisez pas les balises %s placeholders - elle sont remplacées par les icônes 
  ...
  $lang_search_new_php['no_folders'] = 'Il n\'y a actuellement pas de sous-répertoire dans le répertoire &quot;Albums&quot;. Vérifiez que vous avez bien créé un sous-répertoire dans le répertoire &quot;Albums&quot; et uploadez-y vos fichiers avec votre client FTP (fillezilla ou SmartFPT) Vous ne devez pas uploader dans les répertoires &quot;userpics&quot; ou &quot;edit&quot; , ils sont réservés pour les uploads en HTML ou pour des traitements internes.'; //cpg1.4
  ...
  $lang_search_new_php['edit_pics'] = 'Editer les fichiers'; //cpg1.4
...
if (defined('STAT_DETAILS_PHP')) {
  ...
  $lang_stat_details_php['sort_by_xxx'] = 'Classer par %s'; //cpg1.4
  ...
  $lang_stat_details_php['close'] = 'fermer'; //cpg1.4
  $lang_stat_details_php['hide_internal_referers'] = 'cacher les attributs internes'; //cpg1.4
  ...
  $lang_stat_details_php['empty_hits_table_confirm']  = 'Etes-vous vraiement certain de vouloir effacer TOUTES les statistiques de visite pour TOUTE la Galerie ?<br /> Cette action ne peut pas être annulée !'; //cpg1.5 //JS-Alert
  $lang_stat_details_php['empty_votes_table']  = 'Effacez TOUTES les statistiques de vote'; //cpg1.5
  $lang_stat_details_php['empty_votes_table_confirm']  = 'Etes-vous vraiment certain de vouloir effacer TOUTES les statistiques de vote pour TOUTE votre Galerie ?<br /> Cette action ne peut pas être annulée!'; //cpg1.5 //JS-Alert
  ...
  $lang_stat_details_php['reset_votes_individual_confirm'] = 'Etes-vous ceratin de vouloir effacer le(s) Vote(s) sélectionné(s)?<br /> Cette action ne peut pas être annulée!'; //cpg1.5
...
if (defined('UPLOAD_PHP')) {
  $lang_upload_php['title'] = 'Uploader un fichier';
  ...
  //$lang_upload_php['reg_instr_3'] = 'Si vous souhaitez que le fichier soit décompressé, vous devez utiliser la case de téléchargement fournie dans la zone \'Upload de ZIP décompressible.\'';
  ...
  $lang_upload_php['xp_publish_promote'] = 'Si vous utilisez Windows XP/Vista, vous pouvez utiliser l\'assitant de publication Web de Windows XP pour téléchrger des fichiers, apportant ainsi une interface utilisateur plus simple.'; // cpg1.5
...
$lang_upload_swf_php['status_failed'] = 'Le téléchargement à échoué.'; //cpg1.5
$lang_upload_swf_php['status_too_big'] = 'Le Fichier est trop gros.'; //cpg1.5
$lang_upload_swf_php['status_zero_byte'] = 'Impossible de télécharger un fichier vide (Zero Byte).'; //cpg1.5
...
$lang_upload_swf_php['status_validation_failed'] = 'La Validation a échouée.  Transfer sauté.'; //cpg1.5
...
if (defined('USERMGR_PHP')) {
  ...
  $lang_usermgr_php['add_secondary_membergroup'] = 'Ajouter un Groupe Secondaire'; //cpg1.4
  ...
  $lang_usermgr_php['note_list'] = '<li>Si vous ne souhaitez pas modifier le Mot de Passe actuel, laisse le champs &quot;Mot de Passe&quot; vide.';
  ...
  $lang_usermgr_php['no_latest_upload'] = 'N\'a pas fait de téléchargements'; // cpg1.5
  $lang_usermgr_php['last_comments'] = 'Derniers commentaires'; // cpg1.5
  $lang_usermgr_php['no_last_comments'] = 'N\'a pas fait de commentaires'; // cpg1.5
  $lang_usermgr_php['comments'] = 'Commentairess'; // cpg1.5
  ...
  $lang_usermgr_php['edit_profile'] = 'Modifer le profil'; // cpg1.5
...
if (defined('UPDATE_PHP')) {
  ...
  $lang_update_php['provide_admin_account'] = 'Merci de donner vos informations pour votre compte administrateur ou pour la connection à la base de donnée mySQL'; // cpg1.5
  ...
  $lang_update_php['mysql_database_error'] = 'mySQL ne peut pas trouver la base de donnée %s'; // cpg1.5
  ...
  $lang_update_php['delete_file'] = 'Effacer %s'; // cpg1.5
...
if (defined('UTIL_PHP')) {
  ...
  $lang_util_php['problem'] = 'Probleme'; //cpg1.4
  ...
  $lang_util_php['delete_all_orphans'] = 'Supprimer tous les commentaires orphelins ?'; //cpg1.4
  ...
  $lang_util_php['database'] = 'Base de donnée: '; // cpg1.5
...
if (defined('VERSIONCHECK_PHP')) {
  ...
  $lang_versioncheck_php['counter'] = 'Conteur';
...
if (defined('XP_PUBLISH_PHP')) {
  ...
  $lang_xp_publish_php['no_os_detect'] = 'Impossible de définir votr esystème d\'exploitation'; // cpg1.5
  ...
  $lang_xp_publish_php['no_ie'] = 'Vous semblez utiliser une autre navigateur non supporté'; // cpg1.5
  ...
  $lang_xp_publish_php['install_right_click'] = 'Faites un click droit sur  %sce lien%s etsélectionner &quot;enregistre la cible sous...&quot;'; // cpg1.5 // translator note: don't replace the %s - that placeholder token needs to go untranslated
  $lang_xp_publish_php['install_save'] = 'Sauvez ce fichier sur votre client. Lors de la sauvegarde du fichier, assurez vous que le nom proposé est <tt>cpg_###.reg</tt> ( ### représente un horodatage numérique). Modifier de cette manière si nécessaire (laissez le chiffres)'; // cpg1.5
  $lang_xp_publish_php['install_execute'] = 'Une fois le téléchargement terminé, lancez le fichier en double-cliquant dessus afin d\'enregistrer votre serveur avec l\'assistant de publication Web';  // cpg1.5
  ...
  $lang_xp_publish_php['confirm_selection'] = 'Confirmez votr esélection de fichiers'; // cpg1.5
  $lang_xp_publish_php['select_service'] = 'Dans la liste des options qui apparaisent, sélectionez celle pour votre galerie photo (elle a le nom e votre galerie)'; // cpg1.5
  $lang_xp_publish_php['enter_login'] = 'Entrez vos informations d\'identification si demandées'; // cpg1.5
  $lang_xp_publish_php['select_album'] = 'Sélectionnez l\'album cible pour vos images ou créez en un nouveau'; // cpg1.5
  $lang_xp_publish_php['next'] = 'Cliquez sur &quot;suivant&quot;'; // cpg1.5
  $lang_xp_publish_php['upload_starts'] = 'Le téléchargement de vos fichiers devrait démarer'; // cpg1.5
  ...
  $lang_xp_publish_php['need_login'] = 'Vous devez vous identifier en utilisant Internet Explorer avant de pouvoir utiliser cet asisant.<p/><p>Lors de votre identification, n\'oubliez pas de sélectionner l\'option &quot;se souvenir de moi&quot; si elle est présente.';
...
if (defined('CORE_PLUGIN')) {
  $lang_plugin_php['usergal_alphatabs_config_name'] = 'User Gallery Alphabetic Tabbing(Onglet salphabétiques pour les galeries utilisateurs)'; // cpg1.5
  ...
  $lang_plugin_php['usergal_alphatabs_jump_by_username'] = 'Naviger par nom d\'utilisateur'; // cpg1.5
  $lang_plugin_php['sample_config_name'] = 'Sample Plugin'; // cpg1.5
  $lang_plugin_php['sample_config_description'] = 'Ceci est un exemple de plugin. Il ne fait rien de particulièrement utile - il n\'est là que pour mntrer ce que lesplugins peuvent faire et comment les coder. Lorsqu\'il est activé, il affichera un exemple de texte en rouge.'; // cpg1.5
  ...
  $lang_plugin_php['sample_output'] = 'Ceci est un exemple de donnée renvoyée depusi le plugin "sample plugin"'; // cpg1.5
  ...
  $lang_plugin_php['opensearch_extra'] = 'Vous devriez ajouter du texte à votre site pour explique ce que fait ce plugin'; // cpg1.5
  ...
  $lang_plugin_php['onlinestats_config_install'] = 'Ce plugin ajoute des requêtes à chaque fois ou il est exécuté, utilisant des resources supplémentaires. Si votre galerie est lente ou si vous avez beaucoup d\'utilisateursn vous ne devriez pas l\'utiliser.';
