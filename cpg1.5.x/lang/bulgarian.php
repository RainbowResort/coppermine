...
$lang_gallery_admin_menu['export_lnk'] = 'Експорт'; // cpg1.5
$lang_gallery_admin_menu['export_title'] = 'Експортирай файлове и албуми към папка'; // cpg1.5
...
$lang_picinfo['FlashPixVersion'] = 'Flash Pix Версия';
...
$lang_export_php['export'] = 'Експорт'; // cpg 1.5
$lang_export_php['export_type'] = 'Вид експорт:'; // cpg 1.5
$lang_export_php['html'] = 'Форматиран HTML'; // cpg 1.5
$lang_export_php['images'] = 'Само изображения'; // cpg 1.5
$lang_export_php['export_directory'] = 'Директория за експорт:'; // cpg 1.5
$lang_export_php['processing'] = 'Обработване...'; // cpg 1.5
}
