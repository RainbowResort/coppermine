...
$lang_meta_album_names['random'] = 'Zufalls-Bilder';
...
$lang_meta_album_names['mostcom'] = 'Am meisten kommentierte Dateien';
...
$lang_errors['perm_denied'] = 'Du hast nicht das Recht, diese Operation auszuführen.';
...
$lang_common['close'] = 'Schliessen'; // cpg1.5
...
$lang_common['username_if_blank'] = 'Anonymus'; // cpg1.5
...
$lang_main_menu['alb_list_title'] = 'Gehe zur Alben-Liste';
$lang_main_menu['alb_list_lnk'] = 'Alben-Liste';
...
$lang_main_menu['mostcom_title'] = 'Zeige Datein, die am meisten kommentiert wurden'; // cpg1.5
...
$lang_main_menu['sidebar_lnk'] = 'Side-Bar'; // cpg1.5
...
$lang_gallery_admin_menu['export_lnk'] = 'Exportieren'; // cpg1.5
$lang_gallery_admin_menu['export_title'] = 'Exportiere Dateien und Alben auf Festplatte'; // cpg1.5
...
$lang_rate_pic['rollover_to_rate'] = 'Halte die Maus über die die Bewertung, um Deine Stimme abzugeben'; // cpg1.5
...
$lang_banning_php['current'] = 'dereitiger'; // cpg1.5
...
$lang_bridgemgr_php['no_action_needed'] = 'Kein Aktion notwenig in diesem Schritt. Klicke auf &quot;weiter&quot;, um fortzufahren.';
...
$lang_bridgemgr_php['use_post_based_groups'] = 'Benutzerdefiniert Gruppen der Bridge-Anwendung verwenden?';
...
$lang_bridgemgr_php['recovery_explanation'] = 'Du musst Dich erst anmelden, falls Du hierher gekommen bist, um die Forums-Integration Deiner Coppermine-Galerie zu administrieren. Falls Du Dich nicht anmelden kannst, weil die Integration nicht wie erwartet funktioniert, dann kannst Du mit Hilfe dieser Seite die Integration (Bridging) deaktivieren. Die Eingabe von Benutzername und Passwort hier auf der Seite wird Dich nicht anmelden, sondern die Integration deaktivieren. Details dazu gibt es in der Doku.';
...
$lang_bridgemgr_php['recovery_failure_content'] = 'Du hast fehlerhafte Zugangsdaten eingegeben. Du musst die Zugangdaten des Admin-Kontos der &quot;Standalone-Version&quot; benutzen (normalerweise des Admin-Konto, das Du bei der Installation von Coppermine angelegt hast).';
$lang_bridgemgr_php['try_again'] = 'versuche es nochmal';
$lang_bridgemgr_php['recovery_wait_title'] = 'Wartezeit noch nicht um';
$lang_bridgemgr_php['recovery_wait_content'] = 'Aus Sicherheitsgründen erlaubt das Skript keine fehlgeschlagenen Anmeldeversuche in kurzer Reihenfolge - deshalb musst Du ein bißchen warten, bevor Du wieder einen Anmelde-Versuch unternehmen darfst.';
...
$lang_contact_php['your_message'] = 'Dein Nachricht'; // cpg1.5
...
$lang_admin_php['restore_cfg_confirm'] = 'Do you really want to restore the entire configuration to factory defaults? This can not be undone!'; // cpg1.5 //js-alert
...
$lang_admin_php['label'] = 'Beschriftung';
$lang_admin_php['item'] = 'Eintrag';
...
$lang_admin_php['language_fallback'] = 'Auf Englisch zurückgreifen, wenn Deutsche Übersetzung nicht verfügbar?'; // cpg1.5
$lang_admin_php['charset'] = 'Zeichensatz'; // cpg1.5
$lang_admin_php['language_list'] = 'Sprachauswahl-Liste anzeigen'; // cpg1.5
$lang_admin_php['language_flags'] = 'Sprachauswahl-Flaggen anzeigen'; // cpg1.5
$lang_admin_php['language_reset'] = '&quot;Standard&quot; in Sprachauswahl anzeigen'; // cpg1.5
  // 'previous_next_tab'] = 'Display previous/next on tabbed pages'; // cpg1.5
$lang_admin_php['theme'] = 'Design (Theme)'; // cpg1.5
$lang_admin_php['theme_list'] = 'Designauswahl-Liste anzeigen'; // cpg1.5
$lang_admin_php['theme_reset'] = '&quot;Standard&quot; in Designauswahl-Liste anzeigen'; // cpg1.5
...
$lang_admin_php['display_film_strip_filename'] = 'Dateinamen unter Filmstreifen-Thumbnails anzeigen'; // cpg1.5
...
$lang_admin_php['comment_akismet_enable_disapproved'] = 'Kommentare, die durch Akismet abgewiesen wurden trotzdem annehmen, Status aber auf "nicht bestätigt" setzen'; // cpg1.5
...
$lang_admin_php['enable_custom_thumbs'] = 'Benutzerdefinierte Thumbnails aktivieren'; // cpg1.5
...
$lang_admin_php['config_setting_invalid'] = 'Der Wert, den Du für &laquo;%s&raquo; eingegeben hast ist ungültig, bitte überrpüfen.'; // cpg1.5
...
$lang_db_input_php['no_pic_uploaded'] = 'Es wurde keine Datei hochgeladen!<br /><br />Wenn Du tatsächlich eine Datei zum Hochladen selektiert hast, überprüfe, ob Dein Server das Hochladen von Dateien zulässt...';
...
$lang_db_input_php['upload_success'] = 'Deine Datei wurde erfolgreich hochgeladen.<br /><br />Sie wird nach der Bestätigung durch den Admin sichtbar sein.';
...
$lang_db_input_php['err_invalid_fext'] = 'Nur Dateien mit den folgenden Erweiterungen sind zulässig: <br /><br />%s.';
$lang_db_input_php['no_flood'] = 'Leider bist Du schon der Autor des letzten Kommentars zu dieser Datei<br /><br />Bearbeite Deinen bestehenden Kommentar, wenn Du ihn verändern willst';
$lang_db_input_php['redirect_msg'] = 'Du wirst weitergeleitet.<br /><br /><br />Klicke \'weiter\', falls sich die Seite nicht automatisch aktualisiert';
...
$lang_ecard_php['ecards_footer'] = 'Gesendet durch %s von der IP-Adresse %s um %s (Zeitzone der Galerie)';
...
$lang_export_php['export_type'] = 'Export-Typ:'; // cpg 1.5
$lang_export_php['html'] = 'Formatiertes HTML'; // cpg 1.5
$lang_export_php['images'] = 'Nur Bilder'; // cpg 1.5
$lang_export_php['export_directory'] = 'Export Verzeichnis:'; // cpg 1.5
$lang_export_php['processing'] = 'Verarbeite...'; // cpg 1.5
}
...
$lang_phpinfo_php['no_link'] = 'Anderen Personen die phpinfo-Daten anzuzeigen, kann ein Sicherheitsrisiko sein - daher wird diese Seite nur angezeigt, wenn Du als Admin angemeldet bist. Du kannst daher anderen keinen Link auf diese Seite zukommen lassen, da ihnen der Zugriff verwährt werden wird!';
}
...
$lang_register_php['thank_you'] = 'Danke für Deine Registrierung.<br /><br />Eine eMail mit Informationen, wie Du Dein Benutzerkonto aktivieren kannst, wurde an die angegebene eMail-Adresse gesendet.';
...
$lang_register_php['thank_you_admin_activation'] = 'Danke.<br /><br />Deine Registrierung wurde an den Administrator weitergeleitet zur Aktivierung. Nach erfolgter Aktiverung wirst Du eine eMail erhalten.';
...
$lang_reviewcom_php['n_comm_disappr'] = 'Bestätigung für %s Kommentar(e) deaktiviert'; // cpg1.5
...
$lang_reviewcom_php['comment_disapproved'] = 'Bestätigung für Kommentar aufgehoben'; // cpg1.5
...
$lang_sidebar_php['os_browser_detect_explain'] = 'Das Skript versucht, Dein Betriebssystem und Deinen Browser zu bestimmen - bitte warte einen Augenblick. Falls diese automatische Bestimmung fehlschlägt kannst Du alle möglichen Sidebar-Installationen manuell %seinbelnden%s.'; // cpg1.5
...
$lang_search_new_php['select_dir_msg'] = 'Diese Funktion ermöglicht, mehrere Dateien der Galerie hinzuzufügen, die mit einem FTP-Programm schon auf Deine Webseite hochgeladen wurden.<br /><br />Wähle das Verzeichnis, in das Du die Dateien hochgeladen hast.';
...
$lang_util_php['reset_succes'] = 'Zurücksetzen war erfolgreich'; // cpg1.5
...
$lang_util_php['delete_old_explanation'] = 'Löscht alle Dateien (normale, Bilder in Zwischengröße, Thumbnails), die älter sind als die Anzahl von Tagen, die Du angibst. Benutze dieses Feature, um Plattenplatz auf dem Server frei zu bekommen.';  // cpg1.5
...
$lang_plugin_php['sample_config_description'] = 'Dies ist ein Beispiel-Plugin. Es macht nichts wikrlich nützliches - es soll nur demonstrieren, wozu Plugins genutzt werden können und wie sie programmiert werden. Wenn das Plugin aktiviert ist wird ein Besipieltext in rot angezeigt.'; // cpg1.5
...
$lang_plugin_php['opensearch_extra'] = 'Möglicherweise solltest Du eine Erklärung auf Deiner Seite veröffnetlichen, in der erklärt wird, was dieses Plugin tut'; // cpg1.5
...
$lang_plugin_php['onlinestats_are'] = 'Insesamt sind %s Besucher online';
$lang_plugin_php['onlinestats_and'] = 'und';
$lang_plugin_php['onlinestats_reg_member'] = '%s registrierter Benutzer online';
$lang_plugin_php['onlinestats_reg_members'] = '%s registrierte Benutzer online';
