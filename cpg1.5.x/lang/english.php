...
if (defined('BRIDGEMGR_PHP')) $lang_bridgemgr_php = array(
  ...
  'use_post_based_groups_explanation' => 'Should the groups from the bridge app be taken into account (allows a granular permissions management) or just the default groups (makes administration easier). You can change this setting later as well.',
