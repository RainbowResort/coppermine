...
$lang_admin_php['time_offset_detail'] = '(current time: ' . localised_date(-1, $comment_date_fmt) . ')'; // cpg1.5
...
$lang_admin_php['language_fallback'] = 'Fallback to English if translated phrase not found?'; // cpg1.5
...
$lang_admin_php['enable_custom_thumbs'] = 'Enable Custom Thumbs'; // cpg1.5
