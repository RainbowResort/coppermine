...
if (defined('INSTALLER')) $lang_install = array(
  ...
  'nok' => '<font color="red">Not OK</font>',
  'not_here_yet' => 'Nothing here yet, please click <b><a href="install.php?step=%s">here</a></b> to go back.',
  ...
  'please_go_back' => 'Please <a href="install.php?step=%s">click here</a> to go back and fix this problem before proceeding.',
