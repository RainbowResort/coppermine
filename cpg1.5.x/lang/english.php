...
if (defined('BANNING_PHP')) $lang_banning_php = array(
  ...
  'expires' => 'Expires', // cpg1.5
  'expiry_date' => 'Expiry date', // cpg1.5
  'expired' => 'Expired', // cpg1.5
  ...
  'no_banning_when_bridged' => 'You are currently running your gallery bridged to another application. Use that bridge application\'s banning mechanism instead of the one built into Coppermine. Coppermine\'s built-in bridging mechanisms hardly apply when bridged.', // cpg1.5
  'records_on_page' => '%d records on %d page(s)', // cpg1.5
  'ascending' => 'ascending', // cpg1.5
  'descending' => 'descending', // cpg1.5
  'sort_by' => 'Sort by', // cpg1.5
  'sorted_by' => 'sorted by', // cpg1.5
  'ban_record_x_updated' => 'Ban record %s has been updated', // cpg1.5
  'ban_record_x_deleted' => 'Ban record %s has been deleted', // cpg1.5
  'new_ban_record_created' => 'New ban record has been created', // cpg1.5
  'ban_record_x_already_exists' => 'Ban record for %s already exists', // cpg1.5
  'comment_deleted' => '%s comment made by %s has been deleted', // cpg1.5
  'comments_deleted' => '%s comments made by %s have been deleted', // cpg1.5
  'email_field_invalid' => 'Enter a valid email address', // cpg1.5
  'ip_address_field_invalid' => 'Enter a valid IP address (x.x.x.x)', // cpg1.5
  'expiry_field_invalid' => 'Enter a valid expiration date (YYYY-MM-DD)', // cpg1.5
...
if (defined('ADMIN_PHP')) $lang_admin_php = array(
  ...
  'enable_help_description' => 'help partially available in English only', // cpg1.5
  ...
  'purge_expired_bans' => 'Automatically purge expired bans', // cpg1.5
...
$lang_register_php = array(
  ...
  'none' => 'none', // cpg1.5
  'user_name_banned' => 'The username you have chosen is not allowed/banned. Choose another user name', // cpg1.5
  'email_address_banned' => 'You are banned from this gallery. You are not allowed to re-register. Go away!', // cpg1.5
  'email_warning1' => 'The email address field mustn\'t be empty!', // cpg1.5
  'email_warning2' => 'The email address you entered is not valid. Review!', // cpg1.5
  'username_warning1' => 'The username field mustn\'t be empty!', // cpg1.5
  'username_warning2' => 'Username must be at least two characters long', // cpg1.5
  'password_warning1' => 'The password must be at least two characters long!', // cpg1.5
...
$lang_util_php = array(
  ...
  'continue' => 'Process more files', // cpg1.5
  ...
  'delete_intermediate_explanation1' => 'This will delete intermediate (normal) pictures.', // cpg1.5
  'delete_intermediate_explanation2' => 'Use this to free up disk space if you have disabled \'Create intermediate pictures\' in config after adding pictures.', // cpg1.5
  'delete_intermediate_check' => 'The config option \'Create intermediate pictures\' is currently %s.', // cpg1.5
  'no_image' => '%s has been skipped because it is not an image.', // cpg1.5
  'enabled' => 'enabled', // cpg1.5
  'disabled' => 'disabled', // cpg1.5
  ...
  'autorefresh' => ' Auto refresh (no need to click continue button anymore)', // cpg1.5
