...
$lang_contact_php['email_headline'] = 'On %s, this email has been sent using the contact form at %s from the IP address %s'; // cpg1.5
...
$lang_admin_php['label'] = 'label';
$lang_admin_php['item'] = 'item';
...
$lang_admin_php['wm_topleft'] = 'Up left'; // cpg1.5
$lang_admin_php['wm_topright'] = 'Up Right'; // cpg1.5
...
$lang_admin_php['time_offset_detail'] = '(current time: ' . localised_date(-1, $lang_date['comment']) . ')'; // cpg1.5
...
$lang_admin_php['language_list'] = 'Display language list'; // cpg1.5
$lang_admin_php['language_flags'] = 'Display language flags'; // cpg1.5
$lang_admin_php['language_reset'] = 'Display &quot;reset&quot; in language selection'; // cpg1.5
  // 'previous_next_tab'] = 'Display previous/next on tabbed pages'; // cpg1.5
$lang_admin_php['theme'] = 'Theme'; // cpg1.5
$lang_admin_php['theme_list'] = 'Display theme list'; // cpg1.5
$lang_admin_php['theme_reset'] = 'Display &quot;reset&quot; in theme selection'; // cpg1.5
...
$lang_admin_php['comment_akismet_enable_disapproved'] = 'Allow comments that fail to pass Akismet, but set to disapproved'; // cpg1.5
$lang_admin_php['comment_akismet_drop_tell'] = 'Drop comment that fails to validate and tell author that it was rejected'; // cpg1.5
$lang_admin_php['comment_akismet_drop_lie'] = 'Drop comment that fails to validate, but tell end user (spammer) it has been added'; // cpg1.5
...
$lang_admin_php['thumb_width'] = 'Max dimension (width) of a thumbnail'; // cpg1.5
...
$lang_admin_php['allow_private_albums_note'] = '(Note: if you switch from \'yes\' to \'no\' any current private albums will become public)'; // cpg1.5
...
$lang_admin_php['impath_example'] = '(example /usr/bin/X11/)'; // cpg1.5
$lang_admin_php['im_options'] = 'Command line options for ImageMagick'; // cpg1.5
$lang_admin_php['read_exif_data'] = 'Read EXIF data in JPEG files'; // cpg1.5
$lang_admin_php['read_iptc_data'] = 'Read IPTC data in JPEG files'; // cpg1.5
...
$lang_admin_php['enable_watermark'] = 'Watermark Image'; // cpg1.5
...
$lang_admin_php['allow_email_change'] = 'Allow users to change their email address in profile'; // cpg1.5
...
$lang_admin_php['allow_user_edit_after_cat_close'] = 'Allow users to edit their albums when it is in a locked category'; // cpg1.5
...
$lang_delete_php['user_already_active'] = 'Account has already been active';
$lang_delete_php['activated'] = 'Activated';
$lang_delete_php['deactivate_user'] = 'Deactivate user';
$lang_delete_php['user_already_inactive'] = 'Account has already been inactive';
...
$lang_display_comments['disapprove'] = 'Disapprove comment'; // cpg1.5
...
$lang_ecard_php['preview_view_ecard'] = 'This will be the alternate link to the ecard once it gets generated. It won\'t work for previews.';
}
...
$lang_editpics_php['disapproved'] = 'Disapproved'; // cpg 1.5
...
$lang_editpics_php['note_approve_public'] = 'Files in a public album must be approved by an admin.'; // cpg1.5
$lang_editpics_php['note_approve_private'] = 'Files in a private gallery album must be approved by an admin.' ; // cpg1.5
$lang_editpics_php['note_edit_control'] = 'You are not allowed to edit files in a public album.'; // cpg1.5
...
$lang_modifyalb_php['groupp_only'] = 'Members of the \'%s\' group';
...
$lang_reviewcom_php['n_comm_appr'] = '%s comment(s) approved'; // cpg1.5
$lang_reviewcom_php['n_comm_disappr'] = '%s comment(s) disapproved'; // cpg1.5
...
$lang_reviewcom_php['disapprove'] = 'disapprove'; // cpg1.5
$lang_reviewcom_php['do_nothing'] = 'do nothing'; // cpg1.5
$lang_reviewcom_php['comment_approved'] = 'Comment approved'; // cpg1.5
$lang_reviewcom_php['comment_disapproved'] = 'Comment disapproved'; // cpg1.5
...
$lang_reviewcom_php['akismet_count'] = 'Akismet has found %s spam messages for you untill now'; // cpg1.5
...
$lang_search_new_php['select_dir_msg'] = 'This function allows you to add a batch of files that you have uploaded to your server by FTP.<br /><br />Select the directory where you have uploaded your files.';
...
$lang_usermgr_php['no_latest_upload'] = 'Has not made uploads'; // cpg1.5
$lang_usermgr_php['last_comments'] = 'Last comments'; // cpg1.5
$lang_usermgr_php['no_last_comments'] = 'Has not made comments'; // cpg1.5
...
$lang_usermgr_php['send_login_data'] = 'Send login data to this user (Password will be sent in email)'; // cpg1.5
...
$lang_update_php['check_config_file'] = 'Please check the SQL values in %s'; // cpg1.5
