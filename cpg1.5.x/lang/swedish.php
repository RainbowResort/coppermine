...
$lang_errors['gd_file_type_err'] = 'När du använder ett GD bildbibliotek är dom enda tillåtna bildtyperna JPEG och PNG.';
$lang_errors['invalid_image'] = 'Den uppladdade bilden är skadad och kan inte hanteras av GD biblioteket';
$lang_errors['resize_failed'] = 'Kan inte skapa minityrbild eller minska filens storlek.';
...
$lang_errors['access_thumbnail_only'] = 'Du är bara behörig att se minityrbilder.'; // cpg1.5
...
$lang_gallery_admin_menu['admin_title'] = 'Gå till konfiguering';
...
$lang_gallery_admin_menu['view_log_files_title'] = 'Coppermine kan logga det som användarna gör. Du kan läsa i dessa loggar om du har aktiverat loggning i Coppermine konfigueringen.'; // cpg1.5
...
$lang_gallery_admin_menu['overall_stats_title'] = 'Visa övergripande träffstatistik för webläsare och operativsystem (om motsvarande funktioner är aktiverade i konfigurationen).'; // cpg1.5
...
$lang_display_thumbnails['date_added'] = 'Uppladdad datum=';
...
$lang_cpg_debug_output['notices_help_admin'] = 'Notiser visas på den här sidan därför att du (som galleriets administratör) avsiktligt aktiverat den funktionen i Coppermines konfiguration. Dom betyder inte nödvändigtvis att något är fel med galleriet. Det är en funktion som bara skickliga utvecklare bör aktivera för att kunna felsöka. Om notiserna stör dig och/eller om du inte har en aning om vad dom betyder, inaktivera motsvarande funktion i konfigurationen.'; // cpg1.5
$lang_cpg_debug_output['notices_help_non_admin'] = 'Notiser visas på den här sidan därför att du galleriets administratör avsiktligt aktiverat den funktionen. Det betyder inte att någontin är fel. Du kan lugnt strunta i notiser som visas här.'; // cpg1.5
...
$lang_version_alert['gallery_offline'] = 'Galleriet är nu stängt och kommer bara att vara synligt för dig som adminstratör. Glöm inte att öppna det igen efter det att du är färdig.';
...
$lang_get_remote_file_by_url['curl_not_available'] = 'Curl är inte tillgänligt på din server'; // cpg1.5
...
$lang_mailer['authenticate'] = 'SMTP Fel: Kunde inte autentiera.';
...
$lang_albmgr_php['confirm_modifs'] = 'Är du säker på att du vill göra dom här ändringarna?'; // js-alert
...
$lang_bridgemgr_php['finalize_explanation'] = 'Så här långt så har dina inställningar skrivits till databasen, men integrationen har inte aktiverats. Du kan aktivera på/av vid ett senare tillfälle. Kom ihåg adminstratörens användarnamn och lösenord från Coppermineinstallationen, du kan komma att behöva det senare för att göra förändringar. Om något skulle gå fel, gå till %s och inaktivera integrering där, med användning av ditt fristående (olänkade) administratörskonto (vanligtvis det du angav under Coppermine installationen).';
...
$lang_admin_php['thumbnail_view'] = 'Miniaturbildsvy'; // cpg1.5
...
$lang_admin_php['keyword_separator'] = 'Nyckeordsavgränsare'; // cpg1.5
...
$lang_admin_php['batch_proc_limit'] = 'Processsamtidighet för batch-uppladdningsgränssnitt'; // cpg1.5
...
$lang_admin_php['comment_akismet_enable_approval'] = 'Tillåt kommentarer som inte klarar Akismet, men markera dom som icke godkända'; // cpg1.5
...
$lang_admin_php['upload_swf'] = 'avancerat - flera files, Flash-driven (rekommenderas)'; // cpg1.5
...
$lang_admin_php['log_ecards_detail'] = 'Notera: loggning kan ha legala efterverkningar. Användaren bör informerar vid registrering att e-kort loggas. Det rekommenderas också att informera om integritetspolicy på en separat sida.'; // cpg1.5
...
$lang_admin_php['config_setting_invalid'] = 'De värde du angav för &laquo;%s&raquo; är ogilitgt, var vänlig kontrollera.'; // cpg1.5
...
$lang_picinfo['remFav'] = 'Ta bort från Favorites';
...
$lang_picinfo['Orientation'] = 'Orientatering';
$lang_picinfo['xResolution'] = 'X Upplösning';
$lang_picinfo['yResolution'] = 'Y Uppkösning';
...
$lang_picinfo['hide_details'] = 'Göm detaijer'; // cpg1.5
...
$lang_ecard_php['view_ecard_plaintext'] = 'För att se e-kortet, kopiera och klista in länken i din webbläsare:';
...
$lang_report_php['view_report_plaintext'] = 'För att se rapporten, kopiera och klista in länken i din webbläsare:';
...
$lang_groupmgr_php['explain_guests_greyed_out_text'] = 'Du kan inte ändra egenskaper för den här gruppen eftersom behörighetsnivån för gruppen är INGEN. Alla ej inloggade användare (medlemmar av gruppen %s) kan inte göra mer än logga in; därför påverkas dom inte av inställningar för gruppen. Ändra behörighetsnivå här eller på gallerikonfigurationens sida under "Användarinställningar", "Tillåt ej inloggade användare tillträde".';
...
$lang_install['cant_write_tmp_conf'] = 'Installationsprogrammetn kan inte skriva den temporära konfigurationsfilen %s.';
...
$lang_install['no_dir'] = 'Katalogen är inte tillgänlig';
...
$lang_install['ready_to_roll'] = '<a href="index.php">Coppermine</a> är nu riktigt konfigurerad och redo att användas.<br /><a href="login.php">Logga in</a> genom att använda dom uppgifter du angav för ditt administratörskonto.';
...
$lang_install['sect_mysql_info'] = 'Det här avsnittet behöver information om tillträde till MySQL databasen.<br />Om du inte vet hur du ska fylla i dom, fråga supporten för ditt webbhotell.';
...
$lang_install['tmp_conf_ser_err'] = 'Ett allvarlig fel inträffade under installationen, försök att ladda om sidan eller börja om genom att ta bort \'include/config.tmp\' filen.';
$lang_install['try_again'] = 'Försök igen!';
$lang_install['unable_write_config'] = 'Kan inte skriva konfigurationsfil';
$lang_install['user_err'] = 'Administatörens användarnamn får bara innehålla alfanumeriska tecken och kan inte vara tomt.';
...
$lang_install['generated_image'] = 'Generarad bild';
...
$lang_langmgr_php['version_does_not_match'] = 'Versionen av den här filen överensttämmer inte med din Coppermine version. Använd med försiktighet och testa noggrant!';
...
$lang_modifyalb_php['alb_cat'] = 'Album kategory';
...
$lang_phpinfo_php['no_link'] = 'Att låta andra se din PHP-info kan innebära en säkerhetsrisk, därför är denna sida endast synlig när du är inloggad som administratör. Du kan inte skicka en länk till den här sidan till andra, dom kommer att nekas tillträde.';
}
...
$lang_picmgr_php['submit_reminder'] = 'Sortingsändringar sparas inte förrän du klickar på &quot;Tillämpa ändringar&quot;.'; // cpg1.5
}
...
$lang_pluginmgr_php['confirm_remove'] = 'NOTERA: Insticksmodulens API är inatkiverad. Vill du MANUELLT RADERA denna insticksmodul, och strunta i alla rensningåtgärder?'; // cpg1.5
$lang_pluginmgr_php['confirm_delete'] = 'Är du säker på att du vill RADERA denna insticksmodul?';
$lang_pluginmgr_php['pmgr'] = 'Hantera Insticksmodulerr';
...
$lang_pluginmgr_php['confirm_version'] = 'Kunde inte avgör versionens krav för denna insticksmodul. Det är vanligtvis ett tecken på att den inte är designad för att köras på din version av Coppermine, och kan dörfär skada ditt galleri. Fortsätt ändå? (rekommenderas inte)?'; // cpg1.5 // js-alert
}
...
$lang_register_php['username_warning1'] = 'Användarnman får inte utelämnas!'; // cpg1.5
...
$lang_register_php['password_verification_warning1'] = 'Dom två lösenorden är inte lika, vänligen skriv in dom på nytt!'; // cpg1.5
$lang_register_php['form_not_submit'] = 'Forumuläret har inte skickats - det finns fel som du måste rätt först!'; // cpg1.5
...
$lang_reviewcom_php['see_next'] = 'See nästa';
...
$lang_sidebar_php['install_explain'] = 'Bland många smarta metoder för att komma åt sidor och information snabbt, erbjuder vi sidopaneler för dom mest populära webbläsarna som används på olika operativsystem. Här kan du hitta inställningar och information om avinstallering för stödda webbläsare.'; // cpg1.5
$lang_sidebar_php['os_browser_detect'] = 'Identifierar ditt operativsystem och din webbläsare'; // cpg1.5
$lang_sidebar_php['os_browser_detect_explain'] = 'Scriptet föröker identifiera ditt operativsystems- och din webbläsares version - vänligen vänta en sekund. Om automatidentifieringen misslyckas, vill du kanske %svisa%s de möjliga installationsvalen för sidopanelen manuellt.'; // cpg1.5
...
$lang_sidebar_php['opera_explain'] = 'Om du använder Opera, kan du %sklicka på denna länk för att lägga till vår sidopanel till ditt set%s. Bocka för "Show in panel". Du kan avinstallera sidopanelen genom att högerklicka på dess flik och välja "Delete" från from the snabbmenyn.'; // cpg1.5
...
$lang_upload_php['upload_swf'] = 'Flera filer - Flash-driven (rekommenderas)'; // cpg1.5
...
$lang_upload_php['up_instr_5'] = 'Du kommer att skickas till en sida där du kan ange information om filerna du laddade upp. När du är färdig, skicka formuläret genom att använda "Tillämpa ändringar" knappen i slutet av formuläret.';
$lang_upload_php['restriction_zip'] = 'Uppladdade ZIP filer kom att fortsätta att vara komprimerade, dom blir inte uppackade på servern.';
...
$lang_util_php['replace_wait'] = 'Raderar original och ersätter dom med skalade bilder, vänligen vänta..';
...
$lang_util_php['delete_replace'] = 'Radera originalbilderna och ersätt dom med stora versioner';
...
$lang_util_php['delete_orphans_explanation'] = 'Detta hittar kommentarer som hör till filer som  inte längre finns i galleriet, och gör det möjligt för dig att radera dom. <br />Kontrollera alla album.';
