...
/*************************
  ...
  ********************************************
  ...
  $Date: 2006-08-19 12:57:00 +0530 (Sat, 19 Aug 2006) $
**********************************************/
...
if (USER_ID) cpg_die(ERROR, $lang_send_activation_php['err_already_logged_in'], __FILE__, __LINE__);
            ...
            $lookup_failed
                 <tr>
                  ...
                  <tr>
                        ...
                        <input name="submitted" type="submit" class="button" value="{$lang_send_activation_php['submit']}" /></td>
                  </tr>
