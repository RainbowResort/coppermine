...
if (defined('FAQ_PHP')) $lang_faq_data = array(
  ...
  array('어떻게 이 프로그램을 얻을 수 있나요?', '코퍼마인은 GNU GPL 아래 제공되는 무료 멀티미디어 갤러리입니다. 다양한 기능을 갖고 있으며 여러 플래트폼에 장착을 할 수있습니다.  <a href="http://coppermine-gallery.net/">코퍼마인 홈페이지</a>를 방문하여 자세한 사항과 다운로드를 받으세요.', 'offline', 0),
