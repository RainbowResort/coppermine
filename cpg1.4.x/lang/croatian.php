...
$lang_translation_info = array(
  ...
  'trans_name'=> 'Andrija',
  'trans_email' => 'andrija_ng@inet.hr',
  'trans_website' => 'http://www.tkdvukovi.hr/',
  'trans_date' => '2008-09-05',
);
...
$lang_error = 'Greška';
$lang_check_uncheck_all = 'označi sve/odznači sve'; //cpg1.4
...
$lang_errors = array(
  ...
  'invalid_image' => 'Poslana slika je oštećena ili nije u pravilnom formatu za GD biblioteku',
...
$lang_main_menu = array(
  ...
  'my_prof_title' => 'Idi u moj osobni profil', //cpg1.4
...
$lang_gallery_admin_menu = array(
  ...
  'ban_lnk' => 'Korisnici pod zabranom',
...
$lang_version_alert = array(
  ...
  'gallery_offline' => 'Galerija trenutno nije u funkciji i bit će vidljiva samo za Vas kao Administratora. Ne zaboravite ju vratiti u funkciju nakon što završite prepravke.', //cpg1.4
);
...
if (defined('BRIDGEMGR_PHP')) $lang_bridgemgr_php = array(
  ...
  'no_action_needed' => 'U ovom koraku ne trebate ništa raditi. Samo kliknite \'naprijed\' za nastavak.',
  'reset_to_default' => 'Resetirajte na osnovne vrijednosti',
  'choose_bbs_app' => 'izaberite aplikaciju s kojom želite integrirati Vašu galeriju',
  ...
  'database_tables' => 'tablice baze podataka',
  ...
  'relative_path_of_forum_from_webroot_explanation' => 'Relativna putanja do Vašeg BBS (Primjer: ako je Vaš BBS na http://www.vasdomen.tld/forum/, unesite &quot;/forum/&quot; u to polje)',
  ...
  'cookie_prefix_explanation' => 'to će biti ime cookiesa Vašeg BBS',
  ...
  'use_post_based_groups_explanation' => 'Da li da i grupe sa BBS koje su definirane brojem postova dobiju nalog (dopušta veći nadzor dozvola) ili samo osnovne grupe (lakša administracija, preporučeno). Ovo podešavanje možete kasnije mijenjati.',
  ...
  'error_no_special_chars' => 'Ime bridge datoteke ne može sadržavati specijalne znakove izuzev (_) i (-)!',
  ...
  'error_cookie_not_readible' => 'Galerija ne može čitati cookies %s. Ispravite unešenu vrijednost za %s, ili idite u  BBS administratorski panel i provjerite da li je putanja cookiesa čitljiva za galeriju.',
...
if (defined('ADMIN_PHP')) $lang_admin_php = array(
  ...
  'notice1' => '(*) Te postavke ne smijete sačuvati ako već imate slika u galeriji.', //cpg1.4 - (relocated)
  'notice2' => '(**) Kad sačuvate te postavke, one će se odnositi samo na slike koje dodate ubuduće. Savjet je da te postavke ne mijenjate ako već imate slika u galeriji. Možete, ipak, izvršiti izmjene na postojećim slikama upotrebom &quot;<a href="util.php">Alati</a> (promjena veličine)&quot; u administracijskom meniju.', //cpg1.4 - (relocated)
...
if (defined('ADMIN_PHP')) $lang_admin_data = array(
  ...
  array('Pregledni interface pri paketnom dodavanju slika', 'browse_batch_add', 1, 'f=index.htm&amp;as=admin_general_browsable_batch_add&amp;ae=admin_general_browsable_batch_add_end'), //cpg1.4

  'Jezik i kodiranje znakova',
  array('Jezik', 'lang', 5, 'f=index.htm&amp;as=admin_language_language&amp;ae=admin_language_language_end'), //cpg1.4
  array('Da upotrebim engleski izraz ako nema prijevoda?', 'language_fallback', 1, 'f=index.htm&amp;as=admin_language_fallback&amp;ae=admin_language_fallback_end'), //cpg1.4
  array('Kodna tablica', 'charset', 4, 'f=index.htm&amp;as=admin_language_charset&amp;ae=admin_language_charset_end'), //cpg1.4
  ...
  array('Označi teme koje su definirane XHTML-om i CSS-om','vanity_block',1, 'f=index.htm&amp;as=vanity_block&amp;ae=vanity_block_end'), //cpg1.4
  array('Putanja do korisnikovog zaglavlja na vrhu', 'custom_header_path', 0, 'f=index.htm&amp;as=admin_theme_include_path_start&amp;ae=admin_theme_include_path_end'), //cpg1.4
  array('Putanja do korisnikovog zaglavlja na dnu', 'custom_footer_path', 0, 'f=index.htm&amp;as=admin_theme_include_path_start&amp;ae=admin_theme_include_path_end'), //cpg1.4

  'Postavke za prikaz albuma',
  array('Širina glavne tablice (pikseli ili %)', 'main_table_width', 0, 'f=index.htm&amp;as=admin_album_table-width&amp;ae=admin_album_table-width_end'), //cpg1.4
  ...
  array('Broj albuma na stranici', 'albums_per_page', 0, 'f=index.htm&amp;as=admin_album_number&amp;ae=admin_album_number_end'), //cpg1.4
  ...
  array('Prikaži ime pošiljatelja ispod ikone', 'display_uploader', 1, 'f=index.htm&amp;as=admin_thumbnail_display_uploader&amp;ae=admin_thumbnail_display_uploader_end'), //cpg1.4
  ...
  'Prikaz slika', //cpg1.4
  array('Širina tablice za prikaz slika (pikseli ili %)', 'picture_table_width', 0, 'f=index.htm&amp;as=admin_image_comment_table-width&amp;ae=admin_image_comment_table-width_end'), //cpg1.4
  ...
  array('Slide show pauza u milisekundama (1 sekunda = 1000 milisekundi)', 'slideshow_interval', 0, 'f=index.htm&amp;as=admin_image_comment_slideshow_interval&amp;ae=admin_image_comment_slideshow_interval_end'), //cpg1.4
  ...
  array('Maksimalna širina ili visina za poslane slike/video (pikseli)', 'max_upl_width_height', 0, 'f=index.htm&amp;as=admin_picture_thumbnail_max_upload_dimension&amp;ae=admin_picture_thumbnail_max_upload_dimension_end'), //cpg1.4
...
// custom profile fields,  //cpg1.4
  ...
  'Postavke cookie-ja',
  array('Ime za cookie', 'cookie_name', 0, 'f=index.htm&amp;as=admin_cookie_name&amp;ae=admin_cookie_name_end'), //cpg1.4
  array('Putanja do cookie-ja', 'cookie_path', 0, 'f=index.htm&amp;as=admin_cookie_path&amp;ae=admin_cookie_path_end'), //cpg1.4
...
if (defined('DB_ECARD_PHP')) $lang_db_ecard_php = array(
  ...
  'ecard_by_sender_email' => 'po email-u pošiljatelja',
  'ecard_by_sender_ip' => 'po IP adresi pošiljatelja',
...
if (defined('DB_INPUT_PHP')) $lang_db_input_php = array(
  ...
  'upload_success' => 'Vaša slika je uspješno prebačena.<br /><br />Bit će vidljiva nakon odobrenja administratora.',
  'notify_admin_email_subject' => '%s - Obavijest o poslanoj slici',
  ...
  'email_comment_body' => 'Netko je napisao novi komentar. Pogledajte ga na',
  'album_not_selected' => 'Album nije izabran', //cpg1.4
  'com_author_error' => 'Registrirani korisnik koristi taj nick, prijavi se ili izaberi drugi', //cpg1.4
);
...
if (defined('DELETE_PHP')) $lang_delete_php = array(
  ...
  'anonymized_uploads' => '%s anonimno poslanih slika', //cpg1.4
  'deleted_comments' => '%s izbrisanih komentara', //cpg1.4
  'deleted_uploads' => '%s izbrisanih poslanih slika', //cpg1.4
...
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php =array(
  ...
  'send_success' => 'Razglednica je poslana',
  ...
  'ecards_footer' => 'Poslano od %s sa IP %s u %s', //cpg1.4
...
if (defined('REPORT_FILE_PHP') || defined('DISPLAYREPORT_PHP')) $lang_report_php =array(
  ...
  'send_success' => 'Vaša prijava je poslana', //cpg1.4
...
if (defined('EDITPICS_PHP')) $lang_editpics_php = array(
  ...
  'reset_view_count' => 'Resetiraj brojač gledanja',
  'reset_all_view_count' => 'Resetiraj SVE brojače gledanja', //cpg1.4
  'reset_votes' => 'Resetiraj ocjene',
  'reset_all_votes' => 'Resetiraj SVE ocjene', //cpg1.4
  'del_comm' => 'Obriši komentare',
  'del_all_comm' => 'Obriši SVE komentare', //cpg1.4
  'upl_approval' => 'Odobrenje poslanog materijala', //cpg1.4
  ...
  'crop_title' => 'Copperminov uređivač slika',
  ...
  'select_unselect' =>'označi/deoznači sve', //cpg1.4
...
if (defined('FAQ_PHP')) $lang_faq_data = array(
  'Opšta ČPP',
  array('Zašto se trebam registrirati?', 'Administrator može, ali ne mora zahtijevati registraciju. Registracija korisniku omogućava dodatne mogućnosti, kao dodavanje slika, posjedovanje liste omiljenih slika, mogućnost ocjenjivanja slika, pisanja komentara, itd.', 'allow_user_registration', '1'),
  array('Kako se registrirati?', 'Kliknite na &quot;Registracija&quot; i ispunite potrebna polja (i opcionalna ako to želite).<br />Ako administrator ima e-mail aktivaciju , tada ćete nakon slanja Vaših podataka primiti e-mail na adresu koju ste naveli prilikom registracije, u kojem su uputstva o tome kako aktivirati Vaše članstvo. Morate aktivirati članstvo kako biste se mogli prijaviti.', 'allow_user_registration', '1'), //cpg1.4
  array('Kako da se prijavim?', 'Kliknite na &quot;Prijava&quot;, unesite Vaše korisničko ime i lozinku i kliknite na &quot;Upamti me&quot; tako ćete biti prijavljeni i ako napustite stranicu.<br /><b>VAŽNO:Cookies moraju biti uključeni i cookies s ovih stranica se ne smije izbrisati kako bi se mogla koristiti opcija &quot;Upamti me&quot;.</b>', 'offline', 0),
  array('Zašto se ne mogu prijaviti?', 'Jeste li se registrirali i odgovorili na link koji Vam je poslan u e-mail poruci?. Ovaj link aktivira Vaše članstvo. Za druge probleme u vezi prijave kontaktirajte administratora.', 'offline', 0),
  ...
  array('Kako ću sačuvati sliku u &quot;Omiljene slike&quot;?', 'Kliknite na sliku i kliknite na &quot;info o slici&quot; link (<img src="images/info.gif" width="16" height="16" border="0" alt="Informacije o slici" />); odite na informacije o slici i kliknite &quot;Dodaj u omiljena&quot;.<br />Administrator može omogućiti &quot;informacije o slici&quot; u osnovnoj postavci.<br />VAŽNO:Cookies moraju biti uključeni i cookies s ovih stranica se ne smije izbrisati.', 'offline', 0),
  ...
  array('Šta je &quot;Zadnje dodate slike&quot;?', 'Ova rubrika pokazuje posljednje slike poslane u galeriju.', 'offline', 0),
  ...
  array('Šta je &quot;Omiljene slike&quot;?', 'Ova rubrika omogućava korisnicima da sačuvaju omiljene slike u cookiesu koji je poslan na kompjuter.', 'offline', 0),
);
...
%s', //cpg1.4
  ...
  'passwd_reset_body' => 'Dolje je nova lozinka koju ste zahtijevali:
Korisničko ime: %s
Lozinka: %s
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array(
  ...
  'personal_gallery' => 'Osobne galerije', //cpg1.4
  ...
  'reset_to_default' => 'Resetiraj u osnovno ime (%s) - preporučeno!', //cpg1.4
  'error_group_empty' => 'Tablica grupe je prazna !<br /><br />Osnovne grupe su kreirane, molim osvježite ovu stranicu', //cpg1.4
  'explain_greyed_out_title' => 'Zašto je redak posivljen?', //cpg1.4
  'explain_guests_greyed_out_text' => 'Ne možete promijeniti atribute ove grupe jer ste postavili opciju &quot; Dozvoli neprijavljenim korisnicima (gost ili anonimus) pristup; na &quot;NE&quot; na strani sa postavkama. Svi članovi grupe %s) se mogu samo prijaviti; Zbog toga postavke grupe na njih ne utječu.', //cpg1.4
...
$lang_list_categories = array(
  'home' => 'Početna',
  'stat1' => 'Br. slika:<b>[pictures]</b> - br. albuma:<b>[albums]</b> - br. kategorija:<b>[cat]</b>  - br. komentara:<b>[comments]</b> - br. gledanja:<b>[views]</b>',
        'stat2' => 'Br. slika:<b>[pictures]</b> - br. albuma:<b>[albums]</b> - br. gledanja<b>[views]</b>',
        'xx_s_gallery' => 'Galerija - %s',
        'stat3' => 'Br. slika:<b>[pictures]</b> - br. albuma:<b>[albums]</b> - br. komentara:<b>[comments]</b>  - br. gledanja:<b>[views]</b>'
);
...
if (defined('LOGIN_PHP')) $lang_login_php = array(
  ...
  'err_login' => '*** Neuspješna prijava. Pokušajte ponovno ***',
  'err_already_logged_in' => 'Već ste prijavljeni !',
  'forgot_password_link' => 'Zaboravio sam lozinku',
  'cookie_warning' => 'Upozorenje: Vaš preglednik ne omogućava upotrebu cookiesa', //cpg1.4
);
...
if (defined('MINIBROWSER_PHP')) $lang_minibrowser_php = array(
  ...
  'current_path' => 'trenutna putanja', //cpg1.4
...
if (defined('MODIFYALB_PHP')) $lang_modifyalb_php = array(
  ...
  'can_upload' => 'Posjetitelji mogu slati slike',
  ...
  'reset_album' => 'Resetiraj album', //cpg1.4
  'reset_views' => 'Resetiraj brojač gledanja na &quot;0&quot; u %s', //cpg1.4
  'reset_rating' => 'Resetiraj ocjene svih slika u %s', //cpg1.4
  'delete_comments' => 'Briši sve komentare u %s', //cpg1.4
  'delete_files' => '%sNepovratno briše sve slike u %s', //cpg1.4
  'views' => 'gledanja', //cpg1.4
...
if (defined('PHPINFO_PHP')) $lang_phpinfo_php = array(
  ...
  'no_link' => 'Nije naročito pametno da drugi vide te podatke, te se zato ta stranica može vidjeti samo ako ste prijavljeni kao admin. Možete drugima poslati link (npr. greškom) na tu stranicu, bit će im zabranjen pristup.',
);
...
$lang_pluginmgr_php = array(
  ...
  'not_plugin_package' => 'Datoteka koju ste poslali NIJE valjani dodatak za galeriju.', //cpg1.4
...
<br />
Prihvaćate stavku da nećete objavljivati nikakav materijal koji je uvredljiv, opscen, vulgaran, prepun mržnje, prijetnji, ili bilo kakav drugi koji bi mogao povrijediti postojeće zakone. Slažete se da webmaster, administrator i moderatori {SITE_NAME} imaju pravo ukloniti ili izmijeniti bilo koji sadržaj u bilo koje vrijeme ako budu smatrali to potrebnim. Kao korisnik slažete se da sve informacije koje upišete bude spremljene u bazu podataka. Iako ove informacije neće biti proslijeđene trećim stranama bez Vašeg dopuštenja, webmaster i administrator ne mogu biti odgovorni za bilo kakvo hackiranje, koje bi dovelo do kompromitiranja podataka.<br />
<br />
Ove stranice koriste cookije za pohranu informacija na Vaš kompjuter. Oni služe samo za Vaše jednostavnije gledanje ovih stranica. E-mail adresa koju ste naveli koristi se samo za potvrdu detalja Vaše registracije i lozinke.<br />
<br />
...
$lang_register_php = array(
  ...
  'last_uploads' => 'Zadnje dodane datoteke.<br />Kliknite da biste vidjeli sve dodate datoteke', //cpg1.4
  'last_comments' => 'Zadnji komentari.<br />Kliknite da biste vidjeli sve komentare', //cpg1.4
  'notify_admin_email_body' => 'Novi korisnik s korisničkim imenom "%s" se upravo registrirao u Vašoj galeriji',
  'pic_count' => 'Dodanih datoteka', //cpg1.4
  'notify_admin_request_email_subject' => '%s - Zahtjev za registraciju', //cpg1.4
  'thank_you_admin_activation' => 'Hvala za registraciju.<br /><br />Vaš zahtjev za aktiviranje naloga je poslan administratoru. Kad Vaš zahtjev za registracijom bude odobren bit će Vam poslan email sa obavještenjem o aktiviranju.', //cpg1.4
  'acct_active_admin_activation' => 'Nalog je aktiviran, korisniku je poslan email sa obavještenjem o aktiviranju.', //cpg1.4
...
Da biste aktivirali Vaš nalog sa korisničkim imenom "{USER_NAME}", trebate kliknuti na link ispod, ili ga kopirati u Vaš internet preglednik.
...
Da biste aktivirali Vaš nalog, trebate kliknuti na link ispod, ili ga kopirati u Vaš internet preglednik.
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array(
  ...
  'no_folders' => 'U direktorijumu "albums" nema direktorija. Kreirajte najmanje jedan novi direktorij i prebacite Vaše slike u njega putem FTP-a. Putem FTP-a ne smijete slati slike u "userpics" niti "edit" direktorije, oni su rezervirani za http slanje i interne namjene.', //cpg1.4
   'albums_no_category' => 'Albumi bez kategorije', //cpg1.4 // album pulldown mod, added by frogfoot
  'personal_albums' => '* Osobni albumi', //cpg1.4 // album pulldown mod, added by frogfoot
  'browse_batch_add' => 'Interface preglednika (preporučeno)', //cpg1.4
...
if (defined('STAT_DETAILS_PHP')) $lang_stat_details_php = array(
  ...
  'vote' => 'Pojedinosti glasanja', //cpg1.4
...
if (defined('UPLOAD_PHP')) $lang_upload_php = array(
  ...
  'reg_instr_2' => 'Sada možete dodati Vaše slike koristeći kućice za dodavanje ispod. Veličina dodatih slika na server ne smije prijeći %s KB svaka. Kompresirane (ZIP) datoteke, koje budete dodali, ostat će neraspakovane.',
  ...
  'succ' => 'Uspješno dodano',
  'success' => 'Br. uspješno dodanih datoteka:%s.',
  ...
  'place_instr_1' => 'Molimo Vas, stavite slike u albume.  Možete također unijeti informacije o svakoj slici.',
...
if (defined('USERMGR_PHP')) $lang_usermgr_php = array(
  ...
  'err_no_users' => 'Tablica s podacima je prazna !',
  ...
  'latest_upload' => 'Posljednja dodavanja',
  'never' => 'nikad',
...
$lang_util_php = array(
  ...
  'thumbs_wait' => 'Osvježava ikone i/ili slike promijenjene veličine, molimo Vas, pričekajte...',
  ...
  'delete_title' => 'Brisanje naslova fotografija',
  ...
  'delete_intermediate_explanation' => 'Bit će obrisane sve slike normalnih vrijednosti.<br />koristite za oslobađanje prostora na disku ako je onemogućeno \'Kreirajte normalne slike\' u podešavanjima nakon dodavanja slika.', //cpg1.4
  ...
  'deleting_intermediates' => 'Brisanje normalnih slika, molim pričekajte...', //cpg1.4
  'searching_orphans' => 'Traženje otpadaka, molim sačekajte...', //cpg1.4
  'select_album' => 'Izaberite album',
  'delete_orphans' => 'Brisanje komentara koji nemaju pripadajuću sliku', //cpg1.4
  'delete_orphans_explanation' => 'Bit će pronađeni svi komentari bez pripadajućih slika koje ćete lako obrisati.<br />Označite sve albume.', //cpg1.4
  ...
  'reset_views' => 'Resetiranje brojača gledanja', //cpg1.4
  'reset_views_explanation' => 'Postavite sve brojače gledanja slika na nulu u navedenom albumu.', //cpg1.4
  ...
  'update_db_explanation' => 'Ako ste mijenjali datoteke aplikacije, dodavali, modificirali ili nadograđivali iz prethodne verzije, obavezno pokrenite osvježavanje baze podataka. Time ćete kreirati potrebne tablice i/ili konfig vrijednosti u Vašoj bazi podataka.',
  'view_log' => 'Prikaz log datotaka', //cpg1.4
  'view_log_explanation' => 'Galerija bilježi različite aktivnosti korisnika. Logove možete praviti ako omogućite logiranje u <a href="admin.php">postavke galerije</a>.', //cpg1.4
  'versioncheck' => 'Provjeravanje verzije galerije', //cpg1.4
  'versioncheck_explanation' => 'Provjerava verziju svih datoteka. Na taj način je osigurano da su zamijenjene sve datoteke prilikom nadgradnje.', //cpg1.4
...
if (defined('VERSIONCHECK_PHP')) $lang_versioncheck_php = array(
  ...
  'online_repository_noconnect' => 'Galerija se nije uspjela povezati sa online spremištem. Za to mogu postojati dva razloga:', //cpg1.4
  'online_repository_reason1' => 'Online spremište je trenutno van funkcije - provjerite možete li pristupiti toj strani: %s - ako ne možete, pokušajte kasnije ponovo.', //cpg1.4
  ...
  'reset_to_defaults' => 'resetiraj na osnovne vrijednosti', //cpg1.4
);
...
<h1>XP Web čarobnjak za objavljivnje</h1><p>Ovaj modul omogućava upotrebu čarobnjaka <b>Windows XP</b> za prijenos datoteka na server Vaše galerije.</p><p>Code is based on article posted by
EOT;

$lang_xp_publish_required = <<<EOT
<h2>Šta je potrebno</h2><ul><li>Windows XP da biste uopće imali čarobnjaka.</li><li>Ispravna instalacija galerije na kojoj <b>radi funkcija za objavljivanje preko servera.</b></li></ul><h2>Kako to podesiti</h2><ul><li>Desni klik na
EOT;

$lang_xp_publish_select = <<<EOT
Izaberite &quot;save target as..&quot;. Sačuvajte datoteku na svom hardu. Prilikom pamćenja datoteke, provjerite da je predloženo ime datoteke <b>cpg_###.reg</b> (the ### predstavlja oznaku vremena). Promijenite u takvo ime, ako je potrebno (ostavite brojeve). Po preuzimanju, 2x kliknite na datoteku da biste registrirali svoj server sa čarobnjakom za objavljivanje.</li></ul>
EOT;

$lang_xp_publish_testing = <<<EOT
<h2>Testing</h2><ul><li>U Windows Explorer-u, odaberite neku datoteku i kliknite na <b>Publish xxx on the web</b> u lijevom oknu.</li><li>Potvrdite izbor datoteke. Kliknite <b>Next</b>.</li><li>Na popisu servisa, odaberite jedan za Vašu galeriju (ima ime Vaše galerije). Ako servis nije na popisu, provjerite da li imate instaliran <b>cpg_pub_wizard.reg</b> kako je opisano gore.</li><li>Upišite podatke za prijavu ako je potrebno.</li><li>Izaberite ciljni album za Vaše fotografije ili napravite novi.</li><li>Kliknite <b>next</b>. Započinje prijenos fotografija.</li><li>Kada je prijenos završen, provjerite u galeriji da li su fotografije pravilno dodane.</li></ul>
EOT;

$lang_xp_publish_notes = <<<EOT
<h2>Bilješka :</h2><ul><li>Kada prijenos počne, čarobnjak ne može prikazati greške od strane galerije. Do okončanja procesa ne možete provjeriti da li su fotografije pravilno dodane, to možete samo u samoj galeriji.</li><li>Ako prijenos ne uspije, omogućite &quot;Debug mode&quot; u postavkama galerije, pokušajte dodati samo jednu fotografiju i provjerite poruku o grešci u
EOT;

$lang_xp_publish_flood = <<<EOT
datoteci koja se nalazi u direktoriju galerije na Vašem serveru.</li><li>Da biste spriječili <i>poplavu fotografija</i> dodanih čarobnjakom, samo <b>administrator</b> i <b>korisnici koji imaju svoje vlastite albume</b> mogu koristiti ovu mogućnost.</li>
EOT;
